...
from harpiya.addons.account.models.chart_template import SYSCOHADA_LIST

from harpiya.tests import tagged, new_test_user
...
class TestBalanceSheetBalanced(TestAccountReportsCommon):
    ...
    def test_balance_sheet_balanced(self):
        ...
        installed_coas = [
            ...
            if template['visible'] and name not in ('syscohada', 'syscebnl')  # Syscohada template is visible but deprecated since harpiya#163350
        ]
