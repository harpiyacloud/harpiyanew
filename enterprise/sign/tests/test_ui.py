...
class TestUi(harpiya.tests.HttpCase, SignRequestCommon):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_sign_flow(self):
        ...
        self.start_tour("/harpiya", 'test_sign_flow_tour', login='admin')
    ...
    def test_template_edition(self):
        ...
        self.start_tour("/harpiya", "sign_template_creation_tour", login="admin")
    ...
    def test_report_modal(self):
        self.start_tour("/harpiya", "sign_report_modal_tour", login="admin")
