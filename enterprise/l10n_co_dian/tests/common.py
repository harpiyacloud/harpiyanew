...
class TestCoDianCommon(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.document_path = 'harpiya.addons.l10n_co_dian.models.l10n_co_dian_document.L10n_Co_DianDocument'
        cls.utils_path = 'harpiya.addons.l10n_co_dian.xml_utils'
