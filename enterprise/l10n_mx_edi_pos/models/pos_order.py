# -*- coding: utf-8 -*-
from harpiya import _, api, models, fields, Command
from harpiya.addons.l10n_mx_edi.models.l10n_mx_edi_document import CANCELLATION_REASON_SELECTION, CFDI_DATE_FORMAT, USAGE_SELECTION
