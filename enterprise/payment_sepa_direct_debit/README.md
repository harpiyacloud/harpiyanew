...
- `16.4`
  - An initial wire transfer is required to confirm the SEPA mandate; subsequent payments are
    immediately confirmed. harpiya/enterprise#43418
- `16.1`
  - SEPA Direct Debit is restricted to the EUR currency. harpiya/enterprise#34158
- `16.0`
  - The payment form is revamped. harpiya/enterprise#30652
  - Transactions are immediately confirmed. harpiya/enterprise#27251
