...
from harpiya.addons.social_linkedin.models.social_account import SocialAccount
from harpiya.addons.social_linkedin.utils import urn_to_id, id_to_urn
...
class SocialLinkedinCase(SocialCase):
    ...
    @mute_logger("harpiya.addons.social.models.social_account")
