...
from harpiya.addons.l10n_pe_edi.tests.common import TestPeEdiCommon
...
class TestPeEdiPoS(TestPeEdiCommon, TestPointOfSaleHttpCommon):
    ...
    def test_invoice_signed_qr_code(self):
        with patch(
            "harpiya.addons.l10n_pe_edi.models.account_edi_format.AccountEdiFormat._l10n_pe_edi_post_invoice_web_service",
