...
from harpiya.addons.marketing_automation.tests.common import MarketingAutomationCommon
...
class TestSyncing(SyncingCase):
    ...
    @mute_logger('harpiya.addons.mass_mailing.models.mailing', 'harpiya.tests')
