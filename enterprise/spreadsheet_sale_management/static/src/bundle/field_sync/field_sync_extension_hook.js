import { registries, coreTypes, stores } from "@harpiya/o-spreadsheet";
import { onMounted, onWillUnmount } from "@harpiya/owl";
...
export function addSpreadsheetFieldSyncExtensionWithCleanUp(cleanUpHook = () => {}) {
    ...
    // menus
    const addMenuAction = {
        icon: "spreadsheet_sale_management.HarpiyaLogo",
        name: (env) => {
