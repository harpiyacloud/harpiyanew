from harpiya.addons.point_of_sale.tests.common import TestPointOfSaleCommon
from harpiya.addons.l10n_ke_edi_oscu.tests.common import TestKeEdiCommon
from harpiya.addons.l10n_ke_edi_oscu.tests.test_live import TestKeEdi
...
class TestEtimsPos(TestKeEdiCommon, TestPointOfSaleCommon):
    ...
    def test_etims_post_order(self):
        ...
        self.assertEqual(pos_order.l10n_ke_oscu_signature, '123456789HARPIYAGR3')
    ...
    def test_refund_pos_order(self):
        ...
        self.assertEqual(refund.l10n_ke_oscu_signature, '123456789HARPIYAGR3')
