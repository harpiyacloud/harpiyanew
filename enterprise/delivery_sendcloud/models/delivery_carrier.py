...
from harpiya.tools import float_is_zero, float_round
...
class DeliveryCarrier(models.Model):
    ...
    def sendcloud_rate_shipment(self, order):
        ...
        for sol in order.order_line:
            # We only assume the following as a warning as there's no notion of unbreakable unit in Harpiya
