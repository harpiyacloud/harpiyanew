...
from harpiya.addons.hw_drivers.iot_handlers.lib.ctypes_terminal_driver import import_ctypes_library


_logger = logging.getLogger(__name__)

if system() == 'Windows':
    LIB_PATH = Path('harpiya/addons/hw_drivers/iot_handlers/lib')
    DOWNLOAD_URL = 'https://nightly.harpiya.com/master/posbox/iotbox/six-timapiv23_09_w.zip'
else:
    LIB_PATH = file_path('hw_drivers/iot_handlers/lib')
    DOWNLOAD_URL = 'https://nightly.harpiya.com/master/posbox/iotbox/six-timapiv23_09_l.zip'
...
# Import Harpiya Timapi Library
LIB_NAME = 'libsix_harpiya_w.dll' if system() == 'Windows' else 'libsix_harpiya_l.so'
...
class TIMInterface(Interface):
    ...
    def get_devices(self):
        ...
        try:
            ...
            new_tid = helpers.read_file_first_line('harpiya-six-payment-terminal.conf')
        devices = {}
