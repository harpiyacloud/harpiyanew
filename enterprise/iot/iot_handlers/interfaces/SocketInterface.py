...
# load_iot_handlers called by Manager.run, the log levels that get applied to the harpiya
...
# be ERROR at the harpiya-bin level. In order to work around this, it's possible to
...
class SocketInterface(Interface):
    ...
    def replace_socket_device(self, dev, addr):
        ...
        # problems since the key is also reported to the Harpiya database, which means a
