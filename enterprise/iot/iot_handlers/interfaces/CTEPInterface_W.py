...
from harpiya.addons.hw_drivers.tools.helpers import download_from_url, unzip_file
from harpiya.addons.hw_drivers.iot_handlers.lib.ctypes_terminal_driver import import_ctypes_library, create_ctypes_string_buffer

_logger = logging.getLogger(__name__)

libPath = Path('harpiya/addons/hw_drivers/iot_handlers/lib')
easyCTEPPath = libPath / 'ctep_w/libeasyctep.dll'
zipPath = str(libPath / 'ctep_w.zip')

if not easyCTEPPath.exists():
    download_from_url('http://nightly.harpiya.com/master/posbox/iotbox/worldline-ctepv23_02_w.zip', zipPath)
