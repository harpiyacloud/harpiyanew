...
from harpiya.tools.misc import format_datetime
...
class SocialPostToLead(models.TransientModel):
    ...
    def _compute_partner_action_data(self):
        ...
        customer with the same name in your Harpiya database -> do the matching.
    ...
    def _compute_utm_data(self):
        ...
        - If we find a matching social.post, we use its source and campaign
          ...
          social.post record related to that published content in your Harpiya database, but it will
