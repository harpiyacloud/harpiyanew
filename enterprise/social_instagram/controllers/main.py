...
from harpiya.addons.auth_oauth.controllers.main import fragment_to_query_string
from harpiya.addons.social.controllers.main import SocialController
from harpiya.addons.social.controllers.main import SocialValidationException
...
class SocialInstagramController(SocialController):
    ...
    def social_instagram_callback(self, access_token=None, extended_access_token=None, **kw):
        ...
        return request.redirect('/harpiya/action-social.action_social_stream_post')
    ...
    def _instagram_create_accounts(self, access_token, extended_access_token):
        ...
        if accounts_to_create:
            ...
            message = _('You need to link your Instagram page to your Facebook account to post with Harpiya Social.\n Please create one and make sure it is linked to your account.')
