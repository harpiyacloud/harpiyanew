...
from harpiya.tools import zeep
from harpiya.tools.zeep.exceptions import TransportError
...
class L10n_ClEdiUtil(models.AbstractModel):
    ...
    def _send_xml_to_sii_rest(self, mode, company_vat, file_name, xml_message, digital_signature):
        ...
        # 'Harpiya (http://www.harpiya.com/contactus)' or 'Mozilla/4.0 ( compatible; Harpiya %s )' % release.series
