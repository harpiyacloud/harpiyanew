...
class TestL10nClDte(TestL10nClEdiCommon):
    @patch('harpiya.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10n_ClEdiUtil._get_seed_ws')
    ...
    @patch('harpiya.addons.l10n_cl_edi.models.l10n_cl_edi_util.Client')
    @patch('harpiya.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10n_ClEdiUtil._get_signed_token')
    @patch('harpiya.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10n_ClEdiUtil._get_seed_ws')
    ...
    @patch('harpiya.addons.l10n_cl_edi.models.l10n_cl_edi_util.Client')
    @patch('harpiya.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10n_ClEdiUtil._get_signed_token')
    @patch('harpiya.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10n_ClEdiUtil._get_seed')
