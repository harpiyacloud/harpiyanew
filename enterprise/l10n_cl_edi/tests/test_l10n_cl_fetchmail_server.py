...
from harpiya.tools import misc
from .common import TestL10nClEdiCommon, _check_with_xsd_patch, _is_valid_certificate


@tagged('post_install_l10n', 'post_install', '-at_install')
@patch('harpiya.tools.xml_utils._check_with_xsd', _check_with_xsd_patch)
@patch('harpiya.addons.certificate.models.certificate.CertificateCertificate._compute_is_valid', _is_valid_certificate)
class TestFetchmailServer(TestL10nClEdiCommon):
    ...
    @patch('harpiya.fields.Date.context_today', return_value=fields.Date.from_string('2019-11-23'))
    ...
    @patch('harpiya.addons.base_vat.models.res_partner.ResPartner.check_vat', MagicMock())
    def test_create_invoice_33_from_attachment_with_sending_partner_defined_on_other_company(self):
        ...
        # Sudo to run like when HarpiyaBot does the fetching. If we use a normal user,
    ...
    @patch('harpiya.addons.l10n_cl_edi.models.fetchmail_server.FetchmailServer._get_dte_lines')
    ...
    @patch('harpiya.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10n_ClEdiUtil._get_cl_current_strftime')
