...
class AccountJournal(models.Model):
    ...
    l10n_uy_edi_type = fields.Selection(
        ...
        "* Electronic: To generate electronic documents via web service to DGI directly from Harpiya\n"
        "* Manual: To add electronic documents that were created previously outside Harpiya (example: backups,"
