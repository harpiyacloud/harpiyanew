...
TEST_ENDPOINT = "https://l10n-uy-uruware.test.harpiya.com/"
PROD_ENDPOINT = "https://l10n-uy-uruware.api.harpiya.com/"
    ...
    def l10n_uy_edi_action_create_uruware_account(self):
        ...
        try:
            ...
            if res.get("success") is not True:
                error = _("Error connection to Harpiya IAP to create Uruware account")
