...
class TestManual(common.TestUyEdi):
    ...
    def test_10_post_invoice(self):
        ...
        * name after post (should have * ID name)
        ...
        invoice.action_post()
        self.assertEqual(invoice.state, "posted", "invoice has not been validate in Harpiya")
    ...
    def test_150_global_donwpayment(self):
        ...
        with patch("harpiya.addons.account.models.account_move.AccountMove._is_downpayment", return_value=True), \
             patch("harpiya.addons.sale.models.account_move.AccountMove._is_downpayment", return_value=True):
            self._send_and_print(invoice)
    ...
    def test_160_deduct_global_donwpayment(self):
        ...
        url = "harpiya.addons.%s.models.account_move_line.AccountMoveLine._get_downpayment_lines"
