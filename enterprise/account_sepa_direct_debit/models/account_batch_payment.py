...
from harpiya.exceptions import RedirectWarning, ValidationError, UserError
from harpiya.tools import format_date

from harpiya.addons.account_sepa_direct_debit.models.sdd_mandate import SDD_MIN_PRENOT_PERIOD, SDD_FIRST_MIN_PRENOT_PERIOD
...
class AccountBatchPayment(models.Model):
    ...
    def _get_all_used_mandates(self):
        ...
        :rtype: dict[:class:`harpiya.addons.account_sepa_direct_debit.models.SDDMandate`, int]
        """
        self.ensure_one()
    ...
    def _send_after_validation(self):
        ...
        specified otherwise (We changed that default in Harpiya by always specifying the period and defaulting it to 2).
