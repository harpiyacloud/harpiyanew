...
from harpiya import _, models, fields, api
...
class SocialAccount(models.Model):
    ...
    social_account_handle = fields.Char("Handle / Short Name",
        help="Contains the social media handle of the person that created this account. E.g: '@harpiya.official' for the 'Harpiya' X account")
    ...
    def _compute_stats_link(self):
        ...
        Ex: https://www.facebook.com/Harpiya-Social-557894618055440/insights """
        for account in self:
            account.stats_link = False

    @api.depends('media_id')
    def _compute_display_name(self):
        """ ex: [Facebook] Harpiya Social, [Twitter] Mitchell Admin, ... """
        for account in self:
