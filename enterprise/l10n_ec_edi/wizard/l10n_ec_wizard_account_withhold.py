...
from harpiya import _, api, Command, fields, models
from harpiya.exceptions import ValidationError, UserError
from harpiya.tools import float_compare

from harpiya.addons.l10n_ec_edi.models.account_tax import L10N_EC_TAXSUPPORTS
from harpiya.addons.l10n_ec_edi.models.account_move import L10N_EC_WTH_FOREIGN_GENERAL_REGIME_CODES
from harpiya.addons.l10n_ec_edi.models.account_move import L10N_EC_WTH_FOREIGN_TAX_HAVEN_OR_LOWER_TAX_CODES
from harpiya.addons.l10n_ec_edi.models.account_move import L10N_EC_WTH_FOREIGN_SUBJECT_WITHHOLD_CODES
from harpiya.addons.l10n_ec_edi.models.account_move import L10N_EC_WTH_FOREIGN_DOUBLE_TAXATION_CODES
from harpiya.addons.l10n_ec_edi.models.account_move import L10N_EC_WITHHOLD_FOREIGN_REGIME
from harpiya.addons.l10n_ec_edi.models.account_move import _L10N_EC_DIVIDEND_YEAR_MIN, _L10N_EC_DIVIDEND_YEAR_MAX
