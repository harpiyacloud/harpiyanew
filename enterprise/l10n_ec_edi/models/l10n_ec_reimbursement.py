...
from harpiya.addons.l10n_ec.models.res_partner import PartnerIdTypeEc
from harpiya.addons.l10n_ec_edi.models.account_move import L10N_EC_VAT_SUBTAXES, L10N_EC_VAT_RATES
from harpiya.exceptions import UserError
from harpiya.tools import float_repr
from harpiya.addons.l10n_ec.models.res_partner import verify_final_consumer
import re
...
class L10n_EcReimbursement(models.Model):
    ...
    def _get_identification_type(self):
        """Maps Harpiya identification types to Ecuadorian ones. In reimbursements can be only ruc or vat"""
        id_type_xmlid = False
