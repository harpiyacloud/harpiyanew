...
from harpiya import fields, Command, tools
...
from harpiya.addons.l10n_au_hr_payroll.tests.test_unused_leaves import TestPayrollUnusedLeaves
...
class TestSingleTouchPayroll(L10nPayrollAccountCommon):
    ...
    def setUpClass(cls):
        ...
        cls.company.l10n_au_bms_id = "HARPIYA_TEST_BMS_ID"
        cls.company.write({
                "vat": "83914571673",
                "email": "au_company@harpiya.com",
                "phone": "123456789",
                "zip": "2000",
    ...
    def test_transfer_opening_balances_wizard(self):
        ...
        # on the same wizard
        with tools.mute_logger('harpiya.sql_db'), self.assertRaises(UniqueViolation):
