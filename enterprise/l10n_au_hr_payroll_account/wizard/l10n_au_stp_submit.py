...
class L10n_AuStpSubmit(models.TransientModel):
    ...
    stp_terms = fields.Boolean(
        ...
        "I authorise Harpiya to send compliant payroll data to the ATO on my behalf.",
        default=False)
...
<ul>
    ...
    <li class="p-2">
        I understand that while Harpiya is a tool that can be used for Australian companies to be compliant with
        STP Phase 2 and SuperStream obligations, Harpiya AU Pty Ltd does not provide agent services nor business advice.
