...
from harpiya.tools.pdf import HarpiyaPdfFileWriter
from harpiya.addons.sign.tests.sign_request_common import SignRequestCommon
...
class TestCaseDocumentsBridgeSign(SignRequestCommon):
    ...
    @mute_logger('harpiya.addons.documents.models.documents_document')
    ...
    @mute_logger("harpiya.addons.documents.models.documents_document")  # avoid warning about counting page of PDFs
