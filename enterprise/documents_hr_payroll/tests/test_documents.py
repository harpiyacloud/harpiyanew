...
from harpiya.addons.documents.tests.test_documents_multipage import single_page_pdf
from harpiya.addons.documents_hr.tests.test_documents_hr_common import TransactionCaseDocumentsHr
from harpiya.addons.hr_payroll.tests.common import TestPayslipBase
