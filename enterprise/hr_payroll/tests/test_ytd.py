...
from harpiya.addons.hr_payroll.tests.common import TestPayslipContractBase
...
class TestYTD(TestPayslipContractBase):
    ...
    def setUpClass(cls):
        ...
        cls.company_2 = cls.env['res.company'].create({'name': 'Harpiyao'})
        ...
        # A new company (and a new employee)
        cls.company_3 = cls.env['res.company'].create({'name': 'Harpiyaooooo'})
