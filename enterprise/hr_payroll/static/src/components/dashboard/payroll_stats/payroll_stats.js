...
import { Component, onWillUnmount, useEffect, useRef, useState, onWillStart } from "@harpiya/owl";
...
export class PayrollDashboardStats extends Component {
    ...
    getStackedBarChartConfig() {
        ...
        if (this.props.is_sample) {
            ...
            colors = [getColor(14, cookie.get("color_scheme"), "harpiya"), '#a5d8d7', '#ebebeb', '#ebebeb'];
        }
