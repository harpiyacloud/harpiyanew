...
from harpiya.tests.common import TransactionCase, HttpCase, tagged
from harpiya.addons.web_studio.tests.test_ui import setup_view_editor_data
...
class TestStudioApprovalsUIUnit(HttpCase):
    ...
    def test_disable_approvals(self):
        ...
        url = f"/harpiya/action-{self.testAction.id}/studio?mode=editor&_view_type=form&_tab=views&menu_id={self.testMenu.id}"
