...
from harpiya.addons.social.tests.tools import mock_void_external_calls
from harpiya.addons.social_facebook.models.social_post import SocialPost
from harpiya.addons.social_facebook.tests.common import SocialFacebookCommon
...
class SocialFacebookCase(SocialFacebookCommon):
    ...
    def test_format_facebook_message(self):
        ...
        message = "Hi, Social is so cool :) Thanks Harpiya"
        tags = [{
            'id': 1337,
            'name': 'Harpiya - Social',
            'offset': 32,
        ...
        excepted_message = "Hi, Social is so cool :) Thanks @[1337] Harpiya-Social"
        self.assertEqual(
            social_stream._format_facebook_message(message, tags),
            excepted_message)

        message = "Hi, Social is so cool :) Thanks Harpiya @[45] thisisafaketag Tag another@[45] faketag"
        tags = [
            {
                'id': 1337,
                'name': 'Harpiya - Social',
                ...
                'id': 1338,
                'name': 'Harpiya Mate and - Social',
                'offset': 58,
                'length': 3
            }]
        excepted_message = "Hi, Social is so cool :) Thanks @[1337] Harpiya-Social @ [45] thisisafaketag @[1338] Harpiya-Mate-and-Social another@[45] faketag"
        self.assertEqual(
            social_stream._format_facebook_message(message, tags),
            excepted_message)
