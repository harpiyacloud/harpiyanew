...
class TestShopFloor(HttpCase):
    ...
    def test_shop_floor(self):
        ...
        url = f"/harpiya/action-{action['id']}"
    ...
    def test_shop_floor_auto_select_workcenter(self):
        ...
        self.start_tour("/harpiya/shop-floor", "test_shop_floor_auto_select_workcenter", login='admin')
    ...
    def test_shop_floor_my_wo_filter_with_pin_user(self):
        ...
        self.start_tour('/harpiya/shop-floor', 'test_shop_floor_my_wo_filter_with_pin_user', login='admin')
    ...
    def test_change_qty_produced(self):
        ...
        wo.button_start()
        wo.button_finish()
        self.start_tour("/harpiya/shop-floor", "test_change_qty_produced", login='admin')
