...
This turns the Harpiya Point of Sale into a [certified Belgian Point of Sale system](http://www.systemedecaisseenregistreuse.be/systemes-certifies) which must be used in conjuction with a Fiscal Data Module. **The certificate is only valid for Harpiya instances hosted by Harpiya Software Technologies, LLC on Harpiya Online**.
