...
Legal
-----
**The use of pos_blackbox_be sources is only certified on harpiya.com SaaS platform
for version 17.0** Contact Harpiya Software Technologies, LLC before installing pos_blackbox_be module.

An obfuscated and certified version of the pos_blackbox_be may be provided on
requests for on-premise installations.
No modified version is certified and supported by Harpiya Software Technologies, LLC.
    """,
