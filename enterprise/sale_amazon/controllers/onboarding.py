...
from harpiya.tools import hmac as hmac_tool
...
def compute_oauth_signature(account_id):
    ...
    :param harpiya.api.Environment env: The current environment.
...
class AmazonController(http.Controller):
    ...
    def amazon_return_from_authorization(self, **data):
        ...
        # Retrieve the Amazon data and Harpiya metadata from the redirect data.
        ...
        account_url = f'/harpiya/action-sale_amazon.list_amazon_account_action/{account_id}'
