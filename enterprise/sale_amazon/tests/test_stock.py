...
from harpiya.addons.sale_amazon.tests import common
from harpiya.addons.stock.tests.common import TestStockCommon
...
class TestStock(common.TestAmazonCommon, TestStockCommon):
    ...
    def test_confirm_picking_trigger_SOL_check(self):
        ...
        with patch(
            'harpiya.addons.sale_amazon.models.stock_picking.StockPicking'
    ...
    @mute_logger('harpiya.addons.sale_amazon.models.stock_picking')
    @mute_logger('harpiya.addons.sale_amazon.models.amazon_account')
    def test_check_carrier_details_compliance_no_carrier(self):
        ...
        with patch(
            'harpiya.addons.sale_amazon.utils.make_sp_api_request',
            new=lambda _account, operation, **kwargs: common.OPERATIONS_RESPONSES_MAP[operation],
        ), patch(
            'harpiya.addons.sale_amazon.models.amazon_account.AmazonAccount._recompute_subtotal',
            new=lambda self_, subtotal_, *args_, **kwargs_: subtotal_,
        ), patch(
            'harpiya.addons.sale_amazon.models.amazon_account.AmazonAccount._find_matching_product',
    ...
    def test_sync_orders_confirms_pickings_with_a_pending_status(self):
        """ Test pickings with a status of pending in harpiya are updated when receiving the
        ...
        with patch(
            'harpiya.addons.sale_amazon.utils.make_sp_api_request', new=get_sp_api_response_mock
        ):
    ...
    def test_sync_orders_confirms_pickings_with_an_errored_status(self):
        """ Test pickings with a status of errored in harpiya are updated when receiving the
        information that the order is delivered from Amazon. """
    ...
    def test_action_retry_amazon_sync_dont_resync_when_picking_is_confirmed_from_amazon(self):
        ...
        with patch(
            'harpiya.addons.sale_amazon.models.amazon_account.AmazonAccount._sync_order_by_reference',
    ...
    def test_action_retry_amazon_sync_set_waiting_state_after_resync(self):
        ...
        with patch(
            'harpiya.addons.sale_amazon.models.amazon_account.AmazonAccount._sync_order_by_reference',
        ), patch('harpiya.addons.sale_amazon.utils.submit_feed', return_value='Mock feed ID'):
            self.picking.action_retry_amazon_sync()
