...

{
    ...
    'description': """
Import your Amazon orders in Harpiya and synchronize deliveries
============================================================

Key Features
------------
* Import orders from multiple accounts and marketplaces.
* Orders are matched with Harpiya products based on their internal reference (SKU in Amazon).
* Deliveries confirmed in Harpiya are synchronized in Amazon.
