...
from harpiya import _, api, exceptions, fields, models, modules
from harpiya.exceptions import UserError, ValidationError
from harpiya.service.model import PG_CONCURRENCY_EXCEPTIONS_TO_RETRY as CONCURRENCY_ERRORS

from harpiya.addons.sale_amazon import const
from harpiya.addons.sale_amazon import utils as amazon_utils
from harpiya.addons.sale_amazon.controllers.onboarding import compute_oauth_signature
...
class AmazonAccount(models.Model):
    ...
    last_orders_sync = fields.Datetime(
        help="The last synchronization date for orders placed on this account. Orders whose status"
             " has not changed since this date will not be created nor updated in Harpiya.",
