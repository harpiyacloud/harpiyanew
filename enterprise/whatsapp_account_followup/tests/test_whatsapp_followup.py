...
from harpiya.tests import Command, tagged, users
from harpiya.addons.whatsapp.tests.common import WhatsAppCommon
from harpiya.addons.account_followup.tests.test_account_followup import TestAccountFollowupReports
    ...
    def test_whatsapp_followup_cron(self):
        ...
        with (
            ...
            self.assertWAMessageFromRecord(
                self.partner_a,
                fields_values={
                    'body': '<p>WhatsApp Followup HarpiyaBot</p>',
                },
            )
