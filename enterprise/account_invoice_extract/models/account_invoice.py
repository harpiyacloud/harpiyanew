...
from harpiya.tools import _, float_compare
from harpiya.tools.misc import clean_context, formatLang

_logger = logging.getLogger(__name__)

PARTNER_AUTOCOMPLETE_ENDPOINT = 'https://partner-autocomplete.harpiya.com'
OCR_VERSION = 123
...
class AccountMove(models.Model):
    ...
    def _contact_iap_extract(self, pathinfo, params):
        ...
        endpoint = self.env['ir.config_parameter'].sudo().get_param('iap_extract_endpoint', 'https://extract.api.harpiya.com')
