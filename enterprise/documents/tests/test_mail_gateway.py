...
from harpiya import Command, fields, tools
from harpiya.addons.mail.tests.common import MailCommon
from harpiya.addons.test_mail.data.test_mail_data import MAIL_EML_ATTACHMENT, MAIL_NO_BODY
from harpiya.exceptions import AccessError, ValidationError
from harpiya.tests import new_test_user
from harpiya.tests.common import RecordCapturer
    ...
    def send_test_mail_with_attachment(self, email_from, msg_id=None, references=None):
        with self.mock_mail_gateway():
            self.format_and_process(
                ...
                references=references or '<f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@harpiya.com>',
                msg_id=msg_id or '<cb7eaf62-58dc-2017-148c-305d0c78892f@harpiya.com>',
            )
    ...
    def test_reply_with_attachment(self):
        ...
        with self.mock_mail_gateway(), RecordCapturer(self.env['documents.document'], []) as capture:
            self.format_and_process(
                ...
                'non-alias@test.com',
                msg_id='<dc8eaf62-58dc-2017-148c-305d0c78892f@harpiya.com>',
