...
from harpiya.addons.documents.tests.test_documents_common import TransactionCaseDocuments
from harpiya.exceptions import AccessError, UserError, ValidationError
from harpiya.tests import freeze_time, users
...
class TestDocumentsAccess(TransactionCaseDocuments):
    ...
    def test_access_via_link_from_parent_folder(self):
        ...
        with mute_logger('harpiya.addons.documents.models.documents_document'):  # Creating document(s) as superuser
    ...
    def test_copy_document_access(self):
        ...
        url_document_in_my_folder = self.env['documents.document'].create(
            {'name': 'url', 'type': 'url', 'url': 'https://www.harpiya.com/', 'owner_id': self.internal_user.id})
