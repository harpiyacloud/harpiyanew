...
from harpiya.tools.pdf import HarpiyaPdfFileWriter, HarpiyaPdfFileReader
...
class TestAttachmentSplit(TransactionCase):
    ...
    def test_attachment_retention_no_split(self):
        ...
        pdf_reader = HarpiyaPdfFileReader(io.BytesIO(base64.b64decode(new_attachment.datas)))
    ...
    def test_merge_pdfs_with_mixed_attachments(self):
        ...
        self.assertEqual(len(new_attachments), 1)
        pdf_reader = HarpiyaPdfFileReader(io.BytesIO(base64.b64decode(new_attachments[0].datas)))
        attachments = list(pdf_reader.getAttachments())
    ...
    def test_split_pdf_retains_attachments_for_complete_files(self):
        ...
        pdf_reader = HarpiyaPdfFileReader(io.BytesIO(base64.b64decode(complete_file_attachment.datas)))
        attachments = list(pdf_reader.getAttachments())
        ...
        pdf_reader = HarpiyaPdfFileReader(io.BytesIO(base64.b64decode(empty_file_attachment.datas)))
        attachments = list(pdf_reader.getAttachments())
