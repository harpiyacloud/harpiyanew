...
import harpiya
from harpiya import _, api, Command, fields, models, SUPERUSER_ID
from harpiya.exceptions import AccessError, UserError, ValidationError
from harpiya.osv import expression
from harpiya.tools import groupby, image_process, SQL
...
class DocumentsDocument(models.Model):
    ...
    def _compute_access_url(self):
        for document in self:
            document.access_url = f'{document.sudo().get_base_url()}/harpiya/documents/{quote(document.access_token, safe="")}'
    ...
    def get_document_max_upload_limit(self):
        ...
        return harpiya.http.DEFAULT_MAX_CONTENT_LENGTH
    ...
    def _get_access_action(self, access_uid=None, force_website=False):
        ...
        if access_uid and not force_website and self.active and self.env.user.has_group("documents.group_documents_user"):
            ...
            return {
                "type": "ir.actions.act_url",
                "url": f"/harpiya/action-documents.document_action?{url_params}"
            }
