...
from harpiya.tools.date_utils import add, subtract
from harpiya.tools.float_utils import float_round, float_compare
from harpiya.osv.expression import OR, AND, FALSE_DOMAIN
...
class MrpProductionSchedule(models.Model):
    ...
    min_to_replenish_qty = fields.Float(
        ...
        help="Unless the demand is 0, Harpiya will always at least replenish this quantity.")
