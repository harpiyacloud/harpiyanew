...
class KeyedXmlDiffer:
    ...
    The `diff_xpath` method computes the Harpiya's xpath notation to be used as an inherited view
    ...
    # Methods that concern the building of the Harpiya's xpath semantic tree
