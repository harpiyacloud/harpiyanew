...
registry.category("web_tour.tours").add("web_studio_new_app_tour", {
    url: "/harpiya/action-studio?mode=home_menu",
    steps: () => [
        {
        ...
        },
        {
            ...
            content: markup(
                _t(
                    "Let's check the result. Close Harpiya Studio to get an <b>overview of your app</b>."
                )
            ),
        ...
        },
        {
            ...
            content: markup(
                _t(
                    "Wow, nice! And I'm sure you can make it even better! Use this icon to open <b>Harpiya Studio</b> and customize any screen."
                )
            ),
            tooltipPosition: "bottom",
            run: "click",
