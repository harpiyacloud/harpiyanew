...
registry.category("web_tour.tours").add("web_studio_hide_fields_tour", {
    url: "/harpiya/action-studio?mode=home_menu&debug=1",
    steps: () => [
        {
            trigger: ".o_web_studio_new_app",
            run: "click",
...
registry.category("web_tour.tours").add("web_studio_model_option_value_tour", {
    url: "/harpiya/action-studio?mode=home_menu&debug=tests",
    steps: () => [
        {
            trigger: ".o_web_studio_new_app",
            run: "click",
...
registry.category("web_tour.tours").add("web_studio_new_report_tour", {
    ...
    steps: () => [
        ...
        {
            trigger:
                ".o-web-studio-report-editor-wysiwyg :iframe .harpiya-editor-editable div.page div",
            run() {
