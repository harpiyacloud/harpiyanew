...
import { click, press, waitFor } from "@harpiya/hoot-dom";
import { animationFrame, Deferred } from "@harpiya/hoot-mock";
...
test("load with active_id active_ids", async () => {
    ...
    browser.location.href = "/harpiya/action-1/studio";
...
test("can edit ir.actions.act_window without id", async () => {
    ...
    expect(browser.location.pathname).toBe("/harpiya/action-1/1/m-pony/1/studio");
    ...
    expect(browser.location.pathname).toBe("/harpiya/action-1/1/m-pony/1");
