...
from harpiya.tests.common import BaseCase, HttpCase
from harpiya.addons.web_studio.controllers.export import StudioExporter
from harpiya.addons.web_studio.wizard.studio_export_wizard import _find_circular_dependencies
...
class TestExportTours(HttpCase):
    def test_can_export_new_module(self):
        self.start_tour("/harpiya?debug=tests", 'can_export_new_module', login="admin")
