...
from harpiya.addons.base.models.ir_actions_report import IrActionsReport
from harpiya.addons.web_studio.controllers.main import WebStudioController
from harpiya.addons.web_studio.controllers.report import WebStudioReportController, get_report_view_copy, _get_and_write_studio_view
from harpiya.addons.web.controllers.report import ReportController
from harpiya.http import _request_stack, route
from harpiya.tests.common import HttpCase, TransactionCase
from harpiya.tests import tagged
from harpiya.tools import DotDict, mute_logger
...
class TestReportEditorUIUnit(HttpCase):
    ...
    @property
    def tour_url(self):
        return f"/harpiya/action-{self.testAction.id}/studio?mode=editor&_tab=reports&_report_id={self.report.id}&menu_id={self.testMenu.id}"
    ...
    def test_basic_report_edition(self):
        ...
        self.assertXMLEqual(main_arch, """
            <t t-name="web_studio.test_report">
               <t t-call="web.html_container">
                 <div>
                   <p>edited with harpiya editor</p>
                 </div>
                 <t t-foreach="docs" t-as="doc">
                   <t t-call="web_studio.test_report_document"/>
                 </t>
        ...
        self.assertXMLEqual(doc_arch, """
            <t t-name="web_studio.test_report_document">
               ...
               <p>edited with harpiya editor 2</p>
             </t>
        """)
        self.assertXMLEqual(studio_arch, """
        <data>
    ...
    def test_table_rendering(self):
        ...
        self.assertXMLEqual(arch, """
            <t t-name="web_studio.test_report_document">
               <p>p edited with harpiyaEditor</p>
               <table class="valid_table">
                 <tbody>
                   <tr>
                     <td>I am valid</td>
               ...
               <table class="invalid_table">
                 <t t-foreach="doc.child_ids" t-as="child">
                   <tr>
                     <td>edited with harpiyaEditor</td>
                   </tr>
                 </t>
               </table>
             </t>
    ...
    def test_record_model_differs_from_action(self):
        ...
        self.start_tour(f"/harpiya/action-{self.testAction.id}/studio?mode=editor&_tab=reports&menu_id={self.testMenu.id}", "web_studio.test_record_model_differs_from_action", login="admin")
