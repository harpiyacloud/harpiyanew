...
from harpiya.addons.web_studio.wizard.studio_export_wizard import DEFAULT_MODELS_TO_EXPORT, FIELDS_TO_EXPORT, MODELS_WITH_NOUPDATE, RELATIONS_NOT_TO_EXPORT
from harpiya.addons.web_studio.models.studio_export_model import PRESET_MODELS_DEFAULTS, \
    DEFAULT_FIELDS_TO_EXCLUDE, ABSTRACT_MODEL_FIELDS_TO_EXCLUDE, RELATED_MODELS_TO_EXCLUDE
from harpiya.addons.web_studio.controllers.export_utils import XML_FIELDS
from harpiya.addons.web_studio.models.ir_model import OPTIONS_WL
...
class TestStudioIrModel(TransactionCase):
    ...
    def test_performance_01_fields_batch(self):
        ...
        orig_setup_models = harpiya.modules.registry.Registry._setup_models__
        def _setup_models(registry, cr):
            nonlocal count_setup_models
            count_setup_models += 1
            orig_setup_models(registry, cr)
        with patch('harpiya.modules.registry.Registry._setup_models__', new=_setup_models):
