...
from harpiya import Command, exceptions, fields
...
class WhatsAppControllerSecurity(MockIncomingWhatsApp, WhatsAppSecurityCase):
    ...
    @mute_logger('harpiya.addons.whatsapp.controller.main')
...
class WhatsAppMessageSecurity(WhatsAppSecurityCase):
    ...
    @mute_logger('harpiya.addons.auth_signup.models.res_users',
                 'harpiya.addons.base.models.ir_cron',
                 'harpiya.addons.base.models.ir_model')
    def test_message_signup_token(self):
        ...
        # https://github.com/harpiya/harpiya/blob/554e6b0898727b6c08a9702e19ea8f2d67632c38/addons/auth_signup/controllers/main.py#L91
