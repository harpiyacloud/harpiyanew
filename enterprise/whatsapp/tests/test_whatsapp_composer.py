...
from harpiya.addons.whatsapp.tests.common import WhatsAppCommon
from harpiya.fields import Datetime
from harpiya.tests import tagged, users
...
Welcome to {{4}} office''',
                ...
                'variable_ids': [
                    ...
                    (0, 0, {'name': "{{4}}", 'line_type': "body", 'field_type': "free_text", 'demo_value': "Harpiya In"}),
                ],
                'wa_account_id': cls.whatsapp_account.id,
            }, {
...
class WhatsAppComposerInternals(WhatsAppComposerCase, CronMixinCase):
    ...
    def test_composer_free_text_on_template_change(self):
        ...
        self._add_button_to_template(template_1, 'Harpiya EXPO', website_url='https://www.harpiya.com/', **btn)
        self._add_button_to_template(template_2, 'Harpiya Bash', website_url='https://runbot.harpiya.com/', **btn)
        self._add_button_to_template(template_2, 'Harpiya Combat', website_url='https://www.harpiya.com/', **btn)
        ...
        self.assertEqual(composer_form.button_dynamic_url_1, 'https://www.harpiya.com/???')
        ...
        self.assertEqual(composer_form.button_dynamic_url_1, 'https://runbot.harpiya.com/???')
        self.assertEqual(composer_form.button_dynamic_url_2, 'https://www.harpiya.com/???')
        ...
        composer_form.button_dynamic_url_1 = 'https://runbot.harpiya.com/runbot'
        composer_form.button_dynamic_url_2 = 'https://www.harpiya.com/combat'
        with self.mockWhatsappGateway():
            composer = composer_form.save()
            composer.action_send_whatsapp_template()
            self.assertWAMessage(
                ...
                free_text_json_values={
                    "button_dynamic_url_1": 'https://runbot.harpiya.com/runbot',
                    "button_dynamic_url_2": 'https://www.harpiya.com/combat'
                })
    ...
    def test_composer_tpl_button(self):
        ...
        for button_values in [
            ...
            {'button_type': 'url', 'website_url': 'https://www.harpiya.com'},
        ]:
                    ...
                    self.assertWAMessage(
                        ...
                        fields_values={
                            ...
                            "body": f"<p>Hello I am { test_user.name },<br>Here my mobile number: { test_user.phone },"
                                    f"<br>You are coming from { self.customers[0].country_id.name }.<br>Welcome to Harpiya In office</p>",
                        },
                    )
