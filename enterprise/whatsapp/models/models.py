...
from harpiya import exceptions, models, _
from harpiya.tools import format_datetime
...
class Base(models.AbstractModel):
    ...
    def _whatsapp_get_responsible(self, related_message=False, related_record=False, whatsapp_account=False):
        ...
        superuser, to avoid having the responsible set to 'Harpiyabot' for automated processes.
