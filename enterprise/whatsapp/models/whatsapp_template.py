...
from harpiya import api, models, fields, _, Command
from harpiya.addons.whatsapp.tools.lang_list import Languages
...
from harpiya.tools import plaintext2html
...
class WhatsappTemplate(models.Model):
    ...
    def _compute_warning_message(self):
        for template in self:
            ...
            if template.button_ids.filtered(lambda button: button.button_type == 'url' and button.website_url.startswith('/')):
                template.warning_message += _('- Button URL will be modified to include the domain. (e.g., "/my_path" will be "https://mydomain.harpiya.com/my_path")\n')
    ...
    def _update_template_from_response(self, remote_template_vals):
        ...
        # variables should be preserved instead of overwritten to keep harpiya-specific data like fields
        variable_ids = []
