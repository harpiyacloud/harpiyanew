...
from harpiya.addons.whatsapp.tools import phone_validation as wa_phone_validation
from harpiya.addons.whatsapp.tools.retryable_codes import WHATSAPP_RETRYABLE_ERROR_CODES
from harpiya.addons.whatsapp.tools.bounced_codes import BOUNCED_ERROR_CODES
from harpiya.addons.whatsapp.tools.whatsapp_api import WhatsAppApi
from harpiya.addons.whatsapp.tools.whatsapp_exception import WhatsAppError
from harpiya.exceptions import ValidationError, UserError
from harpiya.tools import frozendict, groupby, html2plaintext
    ...
    def _post_message_in_active_channel(self):
        ...
        # diffrent user from any model: warn chat is about to be moved into a new conversation
            ...
            if self.mail_message_id.model and self.mail_message_id.res_id:
                ...
                url = f"{self.get_base_url()}/harpiya/{self.mail_message_id.model}/{self.mail_message_id.res_id}"
