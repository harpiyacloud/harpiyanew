...
from harpiya.exceptions import UserError, AccessError, RedirectWarning, ValidationError
from harpiya.tools.safe_eval import json
            ...
            if 'message' in result:
                try:
                    ...
                    if 'unhandled error occurred' in result['message']:
                        raise UserError(_('The Avatax platform failed to create your account. Please ensure the address on your company is correct. If it is please contact support at harpiya.com/help.'))
                    else:
