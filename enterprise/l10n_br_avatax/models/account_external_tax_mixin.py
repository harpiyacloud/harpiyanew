...
from harpiya import models, fields, _, api
from harpiya.addons.iap.tools.iap_tools import iap_jsonrpc
from harpiya.addons.l10n_br_avatax.models.product_template import USE_TYPE_SELECTION
from harpiya.exceptions import UserError, ValidationError, RedirectWarning
from harpiya.tools import partition
from harpiya.tools.float_utils import float_round, json_float_round

logger = logging.getLogger(__name__)

IAP_SERVICE_NAME = 'l10n_br_avatax_proxy'
DEFAULT_IAP_ENDPOINT = 'https://l10n-br-avatax.api.harpiya.com'
DEFAULT_IAP_TEST_ENDPOINT = 'https://l10n-br-avatax.test.harpiya.com'
    ...
    def _get_external_taxes(self):
        ...
        for document, query_result in query_results.items():
            error = self._l10n_br_avatax_handle_response(query_result, _(
                'Harpiya could not fetch the taxes related to %(document)s.',
