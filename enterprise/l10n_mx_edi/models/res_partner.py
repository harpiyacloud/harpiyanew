...
from harpiya.addons.l10n_mx_edi.models.res_company import FISCAL_REGIMES_SELECTION
from harpiya.addons.l10n_mx_edi.models.l10n_mx_edi_document import USAGE_SELECTION
