...
from harpiya.addons.account.tools import LegacyHTTPAdapter
from harpiya.addons.iap.tools.iap_tools import iap_jsonrpc
from harpiya.tools.zeep import Client
from harpiya.tools.zeep.helpers import serialize_object
...
PROXY_URL = 'https://iap-services.harpiya.com'
...
class ResCompany(models.Model):
    ...
    def _generate_currency_rates(self, parsed_data):
        ...
        exchange rate of their main currency equal to one in Harpiya.
        """
    ...
    def _parse_nbp_data(self, available_currencies):
        """ This method is used to update the currencies by using NBP (National Polish Bank) service API.
            ...
            Source: https://apps.harpiya.com/apps/modules/14.0/trilab_live_currency_nbp/
