...
from harpiya.tools import DEFAULT_SERVER_DATE_FORMAT, html2plaintext, plaintext2html
    ...
    def _send_email(self, options):
        ...
        for to_send_partner in followup_recipients:
            ...
            if email and email.strip():
                ...
                # Otherwise, if the follow-up is automatic, the author_id will be the followup responsible or HarpiyaBot.
