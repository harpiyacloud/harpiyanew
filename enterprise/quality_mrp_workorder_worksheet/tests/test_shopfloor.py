...
from harpiya.addons.quality_control_worksheet.tests.test_quality_worksheet import TestQualityWorksheet
from harpiya.addons.mrp_workorder.tests.test_shopfloor import TestShopFloor
...
class TestShopFloorWorksheet(TestShopFloor, TestQualityWorksheet):
    def test_worksheet_quality_check(self):
        ...
        mo.button_plan()
        self.start_tour('/harpiya/shop-floor', "test_worksheet_quality_check", login='admin')
