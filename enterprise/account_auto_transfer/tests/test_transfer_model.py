...
from harpiya.addons.account_auto_transfer.tests.account_auto_transfer_test_classes import AccountAutoTransferTestCase
...
class TransferModelTestCase(AccountAutoTransferTestCase):
    @patch('harpiya.addons.account_auto_transfer.models.transfer_model.AccountTransferModel.action_perform_auto_transfer')
    ...
    @patch('harpiya.addons.account_auto_transfer.models.transfer_model.AccountTransferModel._create_or_update_move_for_period')
    ...
    @patch('harpiya.addons.account_auto_transfer.models.transfer_model.AccountTransferModel._get_auto_transfer_move_line_values')
    ...
    @patch('harpiya.addons.account_auto_transfer.models.transfer_model.AccountTransferModel._get_non_analytic_transfer_values')
    ...
    @patch(
        'harpiya.addons.account_auto_transfer.models.transfer_model.AccountTransferModelLine._get_destination_account_transfer_move_line_values')
