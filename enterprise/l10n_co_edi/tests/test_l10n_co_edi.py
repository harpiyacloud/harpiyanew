...
from harpiya.tools import mute_logger, misc
...
class TestColombianInvoice(TestCoEdiCommon):
    ...
    def test_invoice(self):
        ...
        with self.mock_carvajal():
            ...
            with mute_logger('harpiya.addons.account.models.account_invoice'):
    ...
    def test_invoice_multicurrency(self):
        '''Tests if we generate an accepted XML for an invoice in non-company currency
           ...
           For example:
              ...
              * tax rate: 15 %
                tag: IMP_6
              * harpiya base amount in document currency: 226.98
              * harpiya tax  amount in document currency: 34.05 = round(0.15 * 226.98, 2)
              * "effective tax rate": 15.00132170235263 %
              * harpiya base amount in company  currency: 889559.49
                tag: IMP_2
              * harpiya tax  amount in company  currency: 133445.68 = round(34.05 * 3919.109578, 2)
                tag: IMP_4
