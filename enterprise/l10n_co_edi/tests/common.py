# coding: utf-8
from harpiya.addons.account_edi.tests.common import AccountEdiTestCommon
...
class TestCoEdiCommon(AccountEdiTestCommon):
    ...
    def mock_carvajal(self):
        ...
        with freeze_time(self.frozen_today), \
             patch('harpiya.addons.l10n_co_edi.models.carvajal_request.CarvajalRequest.upload',
                   new=Mock(return_value=return_value_upload)), \
             patch('harpiya.addons.l10n_co_edi.models.carvajal_request.CarvajalRequest.check_status',
                   new=Mock(return_value=return_value_check)), \
             patch('harpiya.addons.l10n_co_edi.models.carvajal_request.CarvajalRequest.client',
