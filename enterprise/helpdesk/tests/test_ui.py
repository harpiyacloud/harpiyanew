...
class TestUi(harpiya.tests.HttpCase, HelpdeskCommon):
    def test_ui(self):
        self.start_tour("/harpiya", 'helpdesk_tour', login="admin")
    ...
    def test_helpdesk_ticket_on_portal_ui(self):
        ...
        self.start_tour('/harpiya', 'helpdesk_search_ticket_on_portal_tour', login=self.helpdesk_portal.login)
