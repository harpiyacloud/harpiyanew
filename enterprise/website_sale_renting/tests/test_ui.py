...
from harpiya.addons.website_sale_renting.tests.common import TestWebsiteSaleRentingCommon
...
class TestUi(HttpCase, TestWebsiteSaleRentingCommon):
    ...
    def test_website_sale_renting_ui(self):
        ...
        self.start_tour("/harpiya", 'shop_buy_rental_product', login='admin')
    ...
    def test_add_accessory_rental_product(self):
        ...
        self.start_tour("/harpiya", 'shop_buy_accessory_rental_product', login='admin')
