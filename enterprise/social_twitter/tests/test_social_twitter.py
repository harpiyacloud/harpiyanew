...
from harpiya.addons.social_twitter.models.social_account import SocialAccount
from harpiya.addons.social_twitter.models.social_stream import SocialStream
from harpiya.addons.social.tests.common import SocialCase
...
class SocialTwitterCase(SocialCase):
    ...
    def test_tweet_post_message_counter(self):
        message_to_post = '''
            Harpiya is a suite of business management software tools including,
            ...
            the framework and core ERP modules is curated by the Belgium-based Harpiya Software Technologies, LLC
            Harpiya is available for both on-premise and ready to use SaaS environment.
        '''
