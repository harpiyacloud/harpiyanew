...
from harpiya.addons.appointment_hr.tests.common import AppointmentHrCommon
from harpiya.addons.appointment.tests.test_performance import AppointmentPerformanceCase, AppointmentUIPerformanceCase
from harpiya.tests import tagged, users
from harpiya.tests.common import warmup
