...
# -*- coding: utf-8 -*-
# Part of Harpiya. See LICENSE file for full copyright and licens

import logging
from harpiya import http, _
from harpiya.http import request
from harpiya.tools import format_duration
...
class ShiftController(http.Controller):
    ...
    def planning_self_assign_with_user(self, token_employee, shift_id, **kwargs):
        ...
        return request.redirect('/harpiya/action-planning.planning_action_open_shift')
    ...
    def _format_planning_shifts(color_code):
        """Take a color code from Harpiya's Kanban view and returns an hex code compatible with the fullcalendar library"""
