...
from harpiya.addons.hr_payroll_account.tests.common import TestPayslipValidationCommon
...
class TestPayslipValidation(TestPayslipValidationCommon):
    ...
    def setUpClass(cls):
        ...
        cls.resource_calendar_38_hours_per_week_harpiya = cls.env['resource.calendar'].create([{
            'name': "Test Calendar : 38 Hours/Week",
            'company_id': cls.env.company.id,
            'hours_per_day': 7.6,
            'tz': "Europe/Brussels",
