...
from harpiya.addons.knowledge.tests.common import KnowledgeCommon, KnowledgeCommonWData
...
class TestKnowledgeArticleBusiness(KnowledgeCommonBusinessCase):
    ...
    @mute_logger('harpiya.addons.base.models.ir_rule')
    @users('employee')
    ...
    @mute_logger('harpiya.addons.base.models.ir_rule', 'harpiya.addons.mail.models.mail_mail', 'harpiya.models.unlink', 'harpiya.tests')
    @users('employee')
    ...
    @mute_logger('harpiya.addons.base.models.ir_rule', 'harpiya.addons.mail.models.mail_mail')
    @users('employee')
    ...
    @mute_logger('harpiya.addons.base.models.ir_rule', 'harpiya.models.unlink')
    @users('employee')
...
class TestKnowledgeArticleCopy(KnowledgeCommonBusinessCase):
    ...
    @mute_logger('harpiya.addons.base.models.ir_model', 'harpiya.addons.base.models.ir_rule')
    @users('employee')
...
class TestKnowledgeArticleRemoval(KnowledgeCommonBusinessCase):
    ...
    @mute_logger('harpiya.addons.base.models.ir_model', 'harpiya.addons.base.models.ir_rule', 'harpiya.models.unlink')
    @users('admin')
...
class TestKnowledgeArticleVisibility(KnowledgeCommon):
    ...
    def setUpClass(cls):
        ...
        with mute_logger('harpiya.models.unlink'):
