        ...
        return [
            ...
            },
            {
                ...
                trigger: () => {
                    ...
                    if (dialog) {
                        return this.getFirstVisibleElement(
                            dialog.querySelector('.o_field_html[name="body"] .harpiya-editor-editable')
                        );
                    }
                    return null;
                },
        ...
        return [
            ...
            },
            {
                ...
                trigger: () => {
                    ...
                    const el = this.getFirstVisibleElement(
                        ...
                        (element) => element.querySelector(".harpiya-editor-editable")
                    );
                    if (el) {
                        return el;
                    }
            ...
            },
            {
                ...
                trigger: () => {
                    this.validatePage();
                    return this.getFirstVisibleElement(
                        `.o_field_html[name="${this.data.fieldName}"] .harpiya-editor-editable`
                    );
                },
                action: (el) => {
                    el.addEventListener(
