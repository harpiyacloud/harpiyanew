...
registry.category("web_tour.tours").add("knowledge_cover_selector_tour", {
    ...
    steps: () => [
        ...
        {
            content: "Change the search query to find harpiya_logo file",
            trigger: ".modal-body input.o_we_search",
            run: "edit harpiya_logo",
        },
        {
            content: "Choose the harpiya_logo cover",
            trigger: '.o_existing_attachment_cell img[title*="harpiya_logo"]',
            run: "click",
        },
        {
            content:
        ...
        },
        {
            ...
            trigger: ".o_hierarchy_article_name > input",
            run: "edit harpiya && click body",
        },
        {
            trigger: ".o_article_active:contains(harpiya)",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o_knowledge_sidebar .o_article_name:contains(harpiya)",
            run: "click",
        },
        {
            trigger: ".o_article_active:contains(harpiya)",
        ...
        {
            // Check that harpiya logo previously uploaded is shown in the selector as the
            // search query, which is the article name, is "harpiya" which is also in the
            // cover attachment's name, and that clicking on it sets it as cover of the
            // current article
            trigger: '.modal-body .o_existing_attachment_cell img[title="harpiya_logo.png"]',
            run: "click",
        },
        {
            content: "check the cover is in harpiya article",
            trigger: ".o_knowledge_cover",
        },
        {
        ...
        {
            content:
                "Check harpiya logo is not shown as the search query does not match its name and remove search query",
            trigger: ".modal-body input.o_we_search",
            run: "clear",
        },
        {
            content:
                "Check that Harpiya logo is now shown in the cover selector, make the trash button visible and click on delete cover button",
            trigger: '.modal-body .o_existing_attachment_cell img[title="harpiya_logo.png"]',
            run: `hover && click .modal-body .o_existing_attachment_cell:has(img[title="harpiya_logo.png"]) .o_existing_attachment_remove`,
        },
        {
