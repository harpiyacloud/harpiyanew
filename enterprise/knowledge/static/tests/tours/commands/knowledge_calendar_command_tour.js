...
},
{
    ...
    trigger: '.o_knowledge_editor .harpiya-editor-editable h1',
    ...
    trigger: '.harpiya-editor-editable',
    run: "editor ",
},
{
    trigger: ".harpiya-editor-editable:not(:has( [data-embedded='view']))",
},
{
...
},
{
    ...
    trigger: '.o_knowledge_editor .harpiya-editor-editable',
    run: 'click',
