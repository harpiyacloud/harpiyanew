...
import { queryOne, queryFirst } from "@harpiya/hoot-dom";
...
export function appendArticleLink(htmlFieldContainerSelector, articleName, previousSiblingSelector = "") {
    return [{ // open the command bar
        trigger: `${htmlFieldContainerSelector} .harpiya-editor-editable > p:last ${previousSiblingSelector}, ${htmlFieldContainerSelector} .harpiya-editor-editable > div.o-paragraph:last ${previousSiblingSelector}`,
        run: function () {
