import { onMounted, onPatched, onWillStart, status } from "@harpiya/owl";
...
import { parseHTML } from "@web_editor/js/editor/harpiya-editor/src/utils/utils";
...
QUnit.module("Knowledge - Articles Structure Command", (hooks) => {
    ...
    QUnit.skip('Check Articles Structure is correctly built', async function (assert) {
        ...
        const editable = fixture.querySelector('.harpiya-editor-editable');
