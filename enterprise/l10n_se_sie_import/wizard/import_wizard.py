...
from harpiya.addons.l10n_se_sie_import.xml_utils import validate_xmldsig_signature
from harpiya.exceptions import RedirectWarning, UserError
from harpiya.tools import date_utils, file_open, mimetypes, float_is_zero, Query, SQL
from harpiya.tools.safe_eval import datetime
    ...
    def _get_journals_data(self, sie_tree, accounts_map, is_entry):
        ...
        def _extract_move_data(entry, journal_name, is_reversed=False):
            ...
            for line in entry.findall('sie:LedgerEntry', namespaces=nsmap):
                ...
                # An Overstrike element specifies that this line has been canceled/deleted later, in Harpiya we'll have
