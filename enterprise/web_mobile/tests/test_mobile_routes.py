...
from harpiya.tests.common import tagged, get_db_name
...
class MobileRoutesTest(HttpCaseWithUserDemo):
    ...
    def test_version_info(self):
        """
        This request is used to check for a compatible Harpiya server
        """
    ...
    def test_database_list(self):
        ...
        if config['list_db']:
            ...
            error = data["error"]
            self.assertEqual(error["data"]["name"], "harpiya.exceptions.AccessDenied")
    ...
    def test_authenticate_wrong_database(self):
        ...
        self._is_error_json_response(data)
        error = data["error"]
        self.assertEqual(error["data"]["name"], "harpiya.exceptions.AccessError")
