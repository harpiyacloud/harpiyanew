/* global HarpiyaDeviceUtility */

import { uniqueId } from "@web/core/utils/functions";
import { browser } from "@web/core/browser/browser";
import { parseSearchQuery } from "@web/core/browser/router";

var available = typeof HarpiyaDeviceUtility !== 'undefined';
var DeviceUtility;
var deferreds = {};
export var methods = {};

if (available){
    DeviceUtility = HarpiyaDeviceUtility;
    delete window.HarpiyaDeviceUtility;
}
 ...
 * @param {Object} result
 */
window.harpiya.native_notify = function (id, result) {
