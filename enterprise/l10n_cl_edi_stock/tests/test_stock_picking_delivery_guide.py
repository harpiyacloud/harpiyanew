...
from harpiya.tests import tagged, Form
from harpiya.tools import misc
from harpiya.addons.l10n_cl_edi_stock.tests.common import TestL10nClEdiStockCommon
from harpiya.addons.l10n_cl_edi.tests.common import _check_with_xsd_patch, _is_valid_certificate
