...
from harpiya.addons.website_sale.controllers.delivery import Delivery
...
class TestWebsiteDeliverySendcloudLocationsController(WebsiteSaleCommon):
    ...
    def setUpClass(cls):
        ...
        cls.company.write({
            'name': 'Harpiya Software Technologies, LLC',
    ...
    def test_sendcloud_delivery_partner(self):
        ...
        sendcloud_class = 'harpiya.addons.delivery_sendcloud.models.sendcloud_service.SendCloud'
