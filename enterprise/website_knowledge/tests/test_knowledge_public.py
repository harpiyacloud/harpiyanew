...
class TestKnowledgePublic(HttpCase):
    ...
    def test_knowledge_meta_tags(self):
        ...
        article = self.env['knowledge.article'].create({
            'icon': '💬',
            'name': 'Harpiya Experience',
            'body': '''
                <h1>What is Harpiya Experience?</h1>
                <div data-embedded="tableOfContent">Hello</div>
                <p>Harpiya Experience is our largest event, taking place once a year.</p>
                <p>It brings together all members of the Harpiya sphere, including partners, customers and open source software fans.</p>
            ''',
        ...
        self.assertEqual(
            article.summary,
            'What is Harpiya Experience? Harpiya Experience is our largest event, taking place once a year. It brings t...')
