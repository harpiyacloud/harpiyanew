...
from harpiya.tools import LazyTranslate, _

_lt = LazyTranslate(__name__)
ENDPOINT = "https://l10n-fr-aspone.api.harpiya.com"
...
ERROR_CODE_TO_MSG = {
    ...
    'unknown_deposit': _lt("This deposit is unknown from Harpiya."),
    'unknown_declaration': _lt("This declaration is unknown from Harpiya."),
    ...
    'not_enterprise': _lt("You do not have an Harpiya enterprise subscription."),
