...
export class OnlineSyncPortal extends Interaction {
    ...
    async HarpiyaFinConnector(action) {
        ...
        await loadJS(`https://${action.params.proxyMode}.harpiyafin.com/proxy/v1/harpiyafin_link`);
        ...
        const params = {
            ...
            onEvent: function (event, data) {
                if (event === "success") {
                    ...
                    post(processUrl, { csrf_token: harpiya.csrf_token });
                }
            },
        };
    ...
    onRenewConsentClick(ev, currentTargetEl) {
        ...
        this.HarpiyaFinConnector(action);
    }
}
