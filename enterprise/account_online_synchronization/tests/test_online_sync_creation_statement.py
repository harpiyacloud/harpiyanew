...
from harpiya.addons.base.models.res_bank import sanitize_account_number
from harpiya.addons.account_online_synchronization.tests.common import AccountOnlineSynchronizationCommon
from harpiya.exceptions import RedirectWarning
...
class TestSynchStatementCreation(AccountOnlineSynchronizationCommon):
    ...
    @patch('harpiya.addons.account_online_synchronization.models.account_online.AccountOnlineLink._fetch_transactions')
    @patch('harpiya.addons.account_online_synchronization.models.account_online.AccountOnlineLink._update_connection_status')
        ...
        mock_response.json.return_value = {
            'error': {
                ...
                'data': {
                    ...
                    'redirect_warning_url': 'harpiya_support',
                },
            },
        }
        patched_request.post.return_value = mock_response

        generated_url = 'https://www.harpiya.com/help?stage=bank_sync&summary=Bank+sync+error+ref%3A+abc123+-+Provider%3A+theonlyone+-+Client+ID%3A+client_id_1&description=ClientID%3A+client_id_1%0AInstitution%3A+Test+Bank%0AError+Reference%3A+abc123%0AError+Message%3A+This+kind+of+things+can+happen.%0A'
        return_act_url = {
...
If you've already opened a ticket for this issue, don't report it again: a support agent will contact you shortly.<br>You can contact Harpiya support <a href=\"{body_generated_url}\">Here</a></p>"""
        ...
        with self.enter_registry_test_mode(), self.env.registry.cursor() as test_cr:
            ...
            try:
                test_link_account._fetch_harpiya_fin('/testthisurl')
