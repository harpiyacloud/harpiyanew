...
from harpiya.addons.sale_shopee import utils as shopee_utils
from harpiya.addons.sale_shopee import const
from harpiya.addons.sale_shopee.tests import common
...
class TestShopee(common.TestShopeeCommon):
    ...
    def test_shop_status_banned(self):
        ...
        with patch(
            'harpiya.addons.sale_shopee.utils.make_shopee_api_request',
    ...
    # --- Sync Orders --- #
    @mute_logger('harpiya.addons.sale_shopee.models.shopee_shop')
    ...
    def test_sync_inventory_error(self):
        ...
        with patch('harpiya.addons.sale_shopee.utils.make_shopee_api_request',
                new=get_shopee_api_response_mock),\
             patch('harpiya.addons.sale_shopee.models.shopee_shop.ShopeeShop._handle_sync_failure',
