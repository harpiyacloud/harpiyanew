...
class TestShopeeMultiCompany(common.TestShopeeCommon):
    ...
    def test_tax_application_on_sync_order_for_branch_company(self):
        ...
        with patch(
            ...
            'harpiya.addons.sale_shopee.models.shopee_shop.ShopeeShop._recompute_subtotal',
            new=lambda _shop, subtotal_, *_args, **_kwargs: subtotal_,
        ), patch(
            'harpiya.addons.sale_shopee.models.shopee_shop.ShopeeShop._find_matching_product',
