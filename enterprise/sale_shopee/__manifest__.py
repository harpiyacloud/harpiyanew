...

{
    ...
    'description': """
Import your Shopee orders in Harpiya and synchronize deliveries
============================================================

Key Features
------------
* Import orders from multiple accounts and shops
* Orders are matched with Harpiya products based on their internal reference (item_id or model_id in Shopee)
