...
from harpiya.tools import html2plaintext, is_html_empty
...
class StockPicking(models.Model):
    ...
    def _create_new_picking(self, picking_type):
        ...
        :param picking_type:
        :type picking_type: :class:`~harpiya.addons.stock.models.stock_picking.StockPickingType`
        :return: a new picking
        :rtype: :class:`~harpiya.addons.stock.models.stock_picking.StockPicking`
        """
