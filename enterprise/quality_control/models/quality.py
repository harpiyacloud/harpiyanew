...
from harpiya import api, Command, models, fields, _
from harpiya.tools import DEFAULT_SERVER_DATETIME_FORMAT, float_round, SQL
from harpiya.osv.expression import OR
...
class QualityPoint(models.Model):
    ...
    def _get_domain(self, product_ids, picking_type_id, measure_on=False, on_demand=False):
        ...
        :type product: :class:`~harpiya.addons.product.models.product.ProductProduct`
        :param picking_type_id: the products that could require a quality check
        :type product: :class:`~harpiya.addons.stock.models.stock_picking.StockPickingType`
