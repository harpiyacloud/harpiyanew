...
import { animationFrame, queryFirst, queryText } from "@harpiya/hoot-dom";
...
async function createSpreadsheetAction(actionTag, params) {
    ...
    await getService("action").doAction(
        ...
        { clearBreadcrumbs: true } // Sometimes in test defining custom action, Harpiya opens on the action instead of opening on root
    );
