...
import { click, dblclick, press } from "@harpiya/hoot-dom";
import { advanceTime, animationFrame } from "@harpiya/hoot-mock";
 ...
 *
 * @returns {Promise<{target: HTMLElement, env: import("@web/env").HarpiyaEnv}>}
 */
