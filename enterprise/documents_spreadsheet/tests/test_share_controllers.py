...
class TestShareController(SpreadsheetTestCommon, HttpCase):
    ...
    def test_documents_share_portal_wrong_token(self):
        ...
        response = self.url_open("/harpiya/documents/a-random-token")
    ...
    def test_contains_live_data_with_harpiya_chart(self):
        spreadsheet_data = {
            "sheets": [
                {
                    "figures": [
    ...
    def share_spreadsheet(self, spreadsheet):
        with mute_logger('harpiya.addons.documents.models.documents_document'):
