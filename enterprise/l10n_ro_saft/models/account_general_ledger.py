...
from harpiya.tools import float_repr, SQL, Query

from harpiya.addons.account_edi_ubl_cii.models.account_edi_common import UOM_TO_UNECE_CODE
        ...
        if not values['company'].l10n_ro_saft_tax_accounting_basis:
            errors['settings_accounting_basis_missing'] = {
                ...
                'action': {
                    ...
                    'target': 'self',
                    'url': '/harpiya/settings#l10n_ro_saft_tax_accounting_basis',
                }
            }
