...
from harpiya.addons.l10n_in_reports.tests.common import L10nInTestAccountReportsCommon
...
class TestReports(L10nInTestAccountReportsCommon):
    ...
    def test_gstr2b(self):
        ...
        bill_not_in_harpiya = self.env['account.move'].search([('ref', '=', '533515'), ('company_id', '=', self.default_company.id)])
        self.assertEqual(len(bill_not_in_harpiya), 1)
        self.assertEqual(bill_not_in_harpiya.l10n_in_gstr2b_reconciliation_status, 'gstr2_bills_not_in_harpiya')
        self.assertEqual(bill_not_in_harpiya.l10n_in_gst_treatment, 'regular')
        sez_bill = self.env['account.move'].search([('ref', '=', 'SEZ/123'), ('company_id', '=', self.default_company.id)])
        self.assertEqual(len(sez_bill), 1)
        self.assertEqual(sez_bill.l10n_in_gstr2b_reconciliation_status, "gstr2_bills_not_in_harpiya")
    ...
    def test_gstr2b_reconciliation_different_partner(self):
        ...
        - A new bill is created and labeled as 'gstr2_bills_not_in_harpiya' for
        invoices found in the GSTR-2B data but not present in Harpiya.
        """
        ...
        self.assertEqual(new_bill.l10n_in_gstr2b_reconciliation_status, "gstr2_bills_not_in_harpiya")
