...
from harpiya import Command, SUPERUSER_ID, _, api, fields, models, modules, tools

from harpiya.exceptions import UserError, AccessError, ValidationError, RedirectWarning
from harpiya.tools import date_utils, get_lang, html_escape, SQL
from harpiya.tools.misc import format_date
from harpiya.addons.l10n_in_reports.tools.gstr1_spreadsheet_generator import GSTR1SpreadsheetGenerator
    ...
    def check_gstr1_status(self):
        ...
        if response.get('data'):
            ...
            if data.get("status_cd") == "P":
                ...
                self.sudo().message_post(body=_("GSTR-1 Successfully Sent"), author_id=harpiyabot.id)
            ...
            for gstr2b_bill in gstr2b_streamline_bills:
                ...
                if matched_bills:
                    created_from_reconciliation = matched_bills.filtered(lambda b:
                        b.l10n_in_gstr2b_reconciliation_status == 'gstr2_bills_not_in_harpiya' and b.state == 'draft')
                    ...
                    create_vals.append({
                        ...
                        "l10n_in_gstr2b_reconciliation_status": "gstr2_bills_not_in_harpiya",
                        "checked": False,
                        "l10n_in_gst_return_period_id": self.id,
