...
from harpiya import  Command, _, api, fields, models, modules
...
class AccountMove(models.Model):
    ...
    l10n_in_gstr2b_reconciliation_status = fields.Selection(selection=[
        ...
        ("gstr2_bills_not_in_harpiya", "GSTR-2 Bills not in Harpiya")],
    ...
    def _post(self, soft=True):
        for invoice in self:
            if invoice.l10n_in_gstr2b_reconciliation_status == "gstr2_bills_not_in_harpiya":
