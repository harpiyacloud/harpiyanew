...
from harpiya import fields, Command
from harpiya.addons.mail.tests.common import MockEmail
from harpiya.addons.payment.tests.common import PaymentCommon
from harpiya.addons.sale_subscription.tests.common_sale_subscription import TestSubscriptionCommon
...
class TestSubscriptionPayments(PaymentCommon, TestSubscriptionCommon, MockEmail):
    ...
    def test_auto_payment_with_token(self):
        ...
        with patch('harpiya.addons.sale_subscription.models.sale_order.SaleOrder._do_payment', wraps=self._mock_subscription_do_payment):
    ...
    def test_do_payment_calls_send_payment_request_only_once(self):
        ...
        with patch(
            'harpiya.addons.payment.models.payment_transaction.PaymentTransaction'
    ...
    @mute_logger('harpiya.addons.sale_subscription.models.sale_order')
    def test_exception_mail(self):
        ...
        self.subscription.action_confirm()
        with patch('harpiya.addons.sale_subscription.models.sale_order.SaleOrder._do_payment', side_effect=Exception("Bad Token")), self.mock_mail_gateway():
    ...
    def test_bad_payment_exception(self):
        ...
        with patch('harpiya.addons.sale_subscription.models.sale_order.SaleOrder._do_payment', side_effect=Exception("Oops, network error")),\
    ...
    def test_bad_payment_exception_post_success(self):
        ...
        with patch('harpiya.addons.sale_subscription.models.sale_order.SaleOrder._do_payment', wraps=_mock_subscription_do_payment_and_commit),\
             patch('harpiya.addons.sale_subscription.models.sale_order.SaleOrder._subscription_post_success_payment', side_effect=Exception("Kaput")),\
             self.mock_mail_gateway():
    ...
    def test_bad_payment_rejected(self):
        ...
        with patch('harpiya.addons.sale_subscription.models.sale_order.SaleOrder._do_payment', wraps=self._mock_subscription_do_payment_rejected),\
             self.mock_mail_gateway():
            self.subscription._create_recurring_invoice()
    ...
    def test_subscription_invoice_after_payment(self):
        ...
        with mute_logger('harpiya.addons.sale.models.payment_transaction'):
            tx._post_process()
    ...
    def test_subscription_invoice_after_payment_sale_automatic_invoice(self):
        ...
        ap_reconcile_after_done_post = patch(
            'harpiya.addons.account_payment.models.payment_transaction.PaymentTransaction._post_process',
    ...
    def test_payment_pending(self):
        ...
        self.subscription.action_confirm()
        with patch('harpiya.addons.sale_subscription.models.sale_order.SaleOrder._do_payment', wraps=self._mock_subscription_do_payment_pending),\
             self.mock_mail_gateway():
            self.subscription._create_recurring_invoice()
