...
from harpiya.tests.common import new_test_user, tagged
from harpiya.tools import mute_logger

from harpiya.addons.sale.models.sale_order import SaleOrder
...
class TestSubscriptionController(PaymentHttpCommon, PaymentCommon, TestSubscriptionCommon):
    ...
    def test_portal_partial_payment(self):
        with patch('harpiya.addons.sale_subscription.models.sale_order.SaleOrder._do_payment',
