...
from harpiya.addons.sale_subscription.tests.test_sale_subscription import TestSubscription
...
class TestSubscriptionInvoiceSignature(TestInvoiceSignature, TestSubscription):
    ...
    def test_subscription_automated_invoice_should_have_signing_user_set_to_salesman(self):
        ...
        self.assertEqual(
            inv.signing_user,
            self.another_user,
            "When the invoice is posted by harpiyabot, the signer should be the one that confirmed the subscription"
        )
