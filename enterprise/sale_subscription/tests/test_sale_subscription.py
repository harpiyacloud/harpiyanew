...
from harpiya.addons.account_accountant.tests.test_signature import TestInvoiceSignature
...
from harpiya.addons.sale_subscription.models.sale_order import SaleOrder
from harpiya.tests import Form, tagged, freeze_time
...
class TestSubscription(TestSubscriptionCommon, MockEmail):
    ...
    def test_subscription_change_partner(self):
        ...
        with patch('harpiya.addons.sale_subscription.models.sale_order.SaleOrder.action_confirm', _action_confirm_mock):
