...
from harpiya.tests import tagged, JsonRpcException, freeze_time
...
from harpiya.addons.sale.controllers.portal import CustomerPortal as SaleCustomerPortal
from harpiya.addons.sale_subscription.tests.test_sale_subscription import TestSubscriptionCommon
from harpiya.addons.website.tools import MockRequest
...
class TestSubscriptionPaymentFlows(TestSubscriptionCommon, PaymentHttpCommon, MockEmail):
    ...
    def _my_sub_assign_token(self, **values):
        ...
        with mute_logger('harpiya.addons.base.models.ir_rule', 'harpiya.http'):
    ...
    def test_assign_token_maximum_amount(self):
        ...
        with self.assertRaisesRegex(JsonRpcException, "harpiya.exceptions.UserError"):
    ...
    def test_transaction_route_rejects_unexpected_kwarg(self):
        ...
        with mute_logger("harpiya.http"), self.assertRaises(
            JsonRpcException, msg='harpiya.exceptions.ValidationError'
        ):
