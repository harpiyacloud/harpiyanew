...
from harpiya import Command, fields, http, _
from harpiya.exceptions import AccessError, MissingError, UserError, ValidationError
from harpiya.http import request
from harpiya.tools import format_date, str2bool

from harpiya.addons.sale.controllers import portal as payment_portal
...
from harpiya.addons.sale.controllers import portal as sale_portal
from harpiya.addons.sale_subscription.models.sale_order import SUBSCRIPTION_PROGRESS_STATE, SUBSCRIPTION_CLOSED_STATE
...
class CustomerPortal(payment_portal.PaymentPortal):
    ...
    def subscription(self, order_id, access_token=None, message='', report_type=None, download=False, **kw):
        ...
        display_close = closable and not order_sudo.end_date and order_sudo.end_date > order_sudo.next_invoice_date
        ...
        backend_url = f'/harpiya/action-{order_sudo._get_portal_return_action().id}/{order_sudo.id}'
