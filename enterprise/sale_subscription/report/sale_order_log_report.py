...
from harpiya.addons.sale.models.sale_order import SALE_ORDER_STATE
from harpiya.addons.sale_subscription.models.sale_order import SUBSCRIPTION_PROGRESS_STATE, SUBSCRIPTION_STATES
