...
class ResCompany(models.Model):
    ...
    l10n_ar_afip_verification_type = fields.Selection([('not_available', 'Not Available'), ('available', 'Available'), ('required', 'Required')], required=True,
        ...
        ' bills\n'
        '* Required: The vendor bills will be automatically verified on AFIP before been posted in Harpiya. This is to'
    ...
    def _l10n_ar_get_connection(self, afip_ws):
        ...
        and save token information in a new connection record in Harpiya)
