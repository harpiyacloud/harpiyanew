...
import { Component, onWillStart } from "@harpiya/owl";
import { getListHighlights } from "../list_highlight_helpers";

import { hooks, components } from "@harpiya/o-spreadsheet";
...
export class ListDetailsSidePanel extends Component {
    ...
    onNameChanged(name) {
        this.env.model.dispatch("RENAME_HARPIYA_LIST", {
    ...
    onDomainUpdate(domain) {
        ...
        this.env.model.dispatch("UPDATE_HARPIYA_LIST", {
            listId: this.props.listId,
            list: {
                ...listDefinition,
                searchParams: {
    ...
    duplicateList() {
        ...
        const result = this.env.model.dispatch("DUPLICATE_HARPIYA_LIST", {
            listId: this.props.listId,
            newListId,
    ...
    deleteList() {
        this.env.askConfirmation(_t("Are you sure you want to delete this list?"), () => {
            this.env.model.dispatch("REMOVE_HARPIYA_LIST", { listId: this.props.listId });
