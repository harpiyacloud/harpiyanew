 ...
 * @param {import("@spreadsheet/ir_ui_menu/harpiya_menu_link_cell").ViewLinkDescription} actionToLink
...
linkMenuRegistry.add("harpiyaMenu", {
    name: _t("Link an Harpiya menu"),
    sequence: 20,
    execute: async (env) => {
