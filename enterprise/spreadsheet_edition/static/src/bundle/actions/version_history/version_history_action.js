import { onMounted, onWillStart, useState, Component, onPatched } from "@harpiya/owl";
...
export class VersionHistoryAction extends Component {
     ...
     */
    setDataProvider() {
        if (this.harpiyaDataProvider) {
            this.harpiyaDataProvider.removeEventListener(
                "data-source-updated",
                this._dataSourceBind.bind(this)
            );
        }
        this.harpiyaDataProvider = new HarpiyaDataProvider(this.env);
        this.harpiyaDataProvider.addEventListener("data-source-updated", this._dataSourceBind.bind(this));
    }
        ...
        this.model = new Model(
            data,
            {
                custom: {
                    env: this.env,
                    orm: this.orm,
                    harpiyaDataProvider: this.harpiyaDataProvider,
                },
                external: {
