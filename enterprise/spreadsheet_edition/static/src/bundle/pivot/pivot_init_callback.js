 ...
 *
 * @param {import("@harpiya/o-spreadsheet").DispatchResult} result
 */
...
export function insertPivot(pivotData) {
    ...
    const sortedColumn = activeMeasures.includes(sortedMeasure)
        ...
        : undefined;
    /** @type {import("@spreadsheet").HarpiyaPivotCoreDefinition} */
    ...
    /**
     * @param {import("@spreadsheet").HarpiyaSpreadsheetModel} model
     */
