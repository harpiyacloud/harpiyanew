...
import { UIPlugin, tokenize, helpers } from "@harpiya/o-spreadsheet";
...
/**
 * @typedef {import("@harpiya/o-spreadsheet").SpreadsheetPivotTable} SpreadsheetPivotTable
 * @typedef {import("@spreadsheet").HarpiyaPivotDefinition} HarpiyaPivotDefinition
 * @typedef {import("@spreadsheet/pivot/harpiya_pivot").HarpiyaPivot} HarpiyaPivot
 * @typedef {import("@spreadsheet/pivot/harpiya_pivot").PivotDomain} PivotDomain
 */
...
export class PivotAutofillPlugin extends UIPlugin {
     ...
     * @param {HarpiyaPivot} dataSource
     * @param {HarpiyaPivotDefinition} definition
     *
     * @private
     *
     * @returns {string}
