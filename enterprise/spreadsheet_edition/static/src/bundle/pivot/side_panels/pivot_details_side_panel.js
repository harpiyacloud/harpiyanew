...
import { components, stores } from "@harpiya/o-spreadsheet";
import { Component, onWillStart, onWillUpdateProps, useRef } from "@harpiya/owl";
import { HarpiyaPivotLayoutConfigurator } from "./harpiya_pivot_layout_configurator/harpiya_pivot_layout_configurator";
...
export class PivotDetailsSidePanel extends Component {
    ...
    static components = {
        ...
        Checkbox,
        Section,
        HarpiyaPivotLayoutConfigurator,
        PivotDeferUpdate,
        PivotTitleSection,
        SidePanelDomain,
    };
    ...
    /** @returns {import("@spreadsheet/pivot/harpiya_pivot").default} */
    get pivot() {
