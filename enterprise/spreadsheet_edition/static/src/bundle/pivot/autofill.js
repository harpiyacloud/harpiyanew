...
function isHarpiyaPivotFormula(formula, getters) {
    ...
    return getters.getPivotCoreDefinition(pivotId).type === "HARPIYA";
}
...
autofillModifiersRegistry
    .add("PIVOT_UPDATER", {
        apply: (rule, data, getters, direction) => {
            if (!isHarpiyaPivotFormula(data.cell.content, getters)) {
