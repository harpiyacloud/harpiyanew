...
import { coreTypes, registries, stores, addRenderingLayer } from "@harpiya/o-spreadsheet";
...
corePluginRegistry.add("harpiyaCellThreadsPlugin", CellThreadsPlugin);
...
cellPopoverRegistry.add("HarpiyaCellComment", {
...
const INSERT_COMMENT_ACTION = {
    ...
    execute: async (env) => {
        ...
        env.getStore(CellPopoverStore).open({ col, row }, "HarpiyaCellComment");
    },
