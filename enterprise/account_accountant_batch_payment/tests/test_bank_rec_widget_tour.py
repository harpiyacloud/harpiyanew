...
from harpiya.addons.account_accountant.tests.common import TestBankRecWidgetCommon
...
class TestBankRecWidgetTour(TestBankRecWidgetCommon, HttpCase):
    ...
    def test_tour_bank_rec_widget(self):
        ...
        self.start_tour('/harpiya', 'account_accountant_batch_payment_bank_rec_widget', login=self.env.user.login)
