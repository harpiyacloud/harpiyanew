...
from harpiya.tools import html2plaintext
...
class TestBankRecWidget(TestBankRecWidgetCommon):
    ...
    def test_validation_new_aml_same_foreign_currency(self):
        ...
        # 6000.0 curr2 == 1200.0 comp_curr (bank rate 5:1 instead of the harpiya rate 4:1)
        st_line = self._create_st_line(
            1200.0,
            date='2017-01-01',
    ...
    def test_validation_exchange_diff_multiple(self):
        ...
        # 6000.0 curr2 == 1200.0 comp_curr (bank rate 5:1 instead of the harpiya rate 6:1)
        st_line = self._create_st_line(
            1200.0,
            date='2016-01-01',
    ...
    def test_validation_new_aml_multi_currencies(self):
        # 6300.0 curr2 == 1800.0 comp_curr (bank rate 3.5:1 instead of the harpiya rate 4:1)
        st_line = self._create_st_line(
            1800.0,
            date='2017-01-01',
            foreign_currency_id=self.other_currency_2.id,
    ...
    def test_auto_reconcile_cron_with_time_limit(self):
        ...
        with freeze_time('2017-01-01 00:00:00') as frozen_time:
            def datetime_now_override():
                frozen_time.tick()
                return frozen_time()
            with patch('harpiya.fields.Datetime.now', side_effect=datetime_now_override):
