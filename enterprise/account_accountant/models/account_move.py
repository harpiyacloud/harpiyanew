...
from harpiya.tools import SQL, float_compare
...
class AccountMove(models.Model):
    ...
    def _compute_signing_user(self):
        ...
        is_harpiyabot_user = self.env.user == self.env.ref('base.user_root')
        ...
        for invoice in (self - other_moves).filtered(lambda inv: inv.state == 'posted'):
            ...
            #   - if harpiyabot: the person that initiated the invoice ie: The salesman
