import json
from harpiya import fields, models, Command, tools
...
class AccountReconcileModel(models.Model):
    ...
    def run_auto_reconciliation(self):
        ...
        # we want the invoice to be marked as paid in the chatter by Harpiyabot and not by the user clicking on the button
        harpiyabot_user = self.env.ref('base.user_root')
        self.env['account.bank.statement.line'].with_user(harpiyabot_user)._cron_try_auto_reconcile_statement_lines(limit_time=limit_time)
