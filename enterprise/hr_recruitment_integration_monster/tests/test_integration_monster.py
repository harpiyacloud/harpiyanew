...
from harpiya.fields import Date
from harpiya.tests.common import TransactionCase, tagged
from harpiya.tools.zeep.exceptions import Fault
...
class TestMonsterIntegration(TransactionCase):
    ...
    def patch_post_api_call(self):
        ...
        with patch('harpiya.addons.hr_recruitment_integration_monster.models.hr_recruitment_platform.HrRecruitmentPlatform._post_api_call') as patched_function:
...
class TestMockupMonsterIntegration(TestMonsterIntegration):
    ...
    def patch_monster_requests(self):
        ...
        with patch('harpiya.addons.hr_recruitment_integration_monster.models.hr_recruitment_platform.Client') as mocked_client:
