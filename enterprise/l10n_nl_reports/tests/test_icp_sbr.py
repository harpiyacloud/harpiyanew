...
from harpiya.addons.account_reports.tests.account_sales_report_common import AccountSalesReportCommon
    ...
    def test_icp_xbrl_export(self):
        ...
        expected_xbrl = self.get_xml_tree_from_string('''
            <xbrli:xbrl xmlns:link="http://www.xbrl.org/2003/linkbase"
                ...
                <bd-i:SoftwarePackageName contextRef="CD_Opgaaf">Harpiya</bd-i:SoftwarePackageName>
