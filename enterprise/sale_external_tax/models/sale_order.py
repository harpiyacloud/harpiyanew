...
class SaleOrder(models.Model):
    ...
    def _compute_tax_totals(self):
        ...
        returns, not the values Harpiya computes. This will create a
    ...
    def _compute_amounts(self):
        ...
        service returns, not the values Harpiya computes.
        """
    ...
    def _create_account_invoices(self, invoice_vals_list, final):
        ...
        invoice lines in _prepare_invoice_line() to avoid confusing users when the tax amount Harpiya calculates is
...
class SaleOrderLine(models.Model):
    ...
    def _prepare_invoice_line(self, **optional_values):
        """ Override to clear tax_ids on lines. Brazilian taxes are variable and don't have the right amount set in Harpiya (always 1%),
