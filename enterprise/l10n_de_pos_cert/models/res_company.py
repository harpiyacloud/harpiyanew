...
from harpiya.addons.iap import jsonrpc
from harpiya.exceptions import ValidationError, UserError
import requests
from requests.exceptions import ConnectTimeout
from urllib.parse import urljoin

DEFAULT_ENDPOINT = 'https://l10n-de-pos.api.harpiya.com/api/l10n_de_pos'
...
class ResCompany(models.Model):
    ...
    def _l10n_de_fiskaly_kassensichv_rpc(self, method, path, json=None, version=2, recursive=False):
        try:
            ...
            raise UserError(_("Connection lost between Harpiya and Fiskaly."))
