...
from harpiya.addons.test_marketing_automation.tests.common import TestMACommon
...
for record in records:
    ...
    @mute_logger('harpiya.addons.base.models.ir_model',
                 'harpiya.addons.mail.models.mail_mail',
                 'harpiya.addons.mass_mailing.models.mailing',
                 'harpiya.addons.mass_mailing_sms.models.mailing_mailing')
    ...
    def test_marketing_automation_flow(self):
        ...
        self._clear_outgoing_sms()
        with freeze_time(date_reference_new), \
             mute_logger('harpiya.addons.marketing_automation.models.marketing_activity'), \
             self.capture_triggers('marketing_automation.ir_cron_campaign_execute_activities') as captured_triggers:
            campaign.execute_activities()
