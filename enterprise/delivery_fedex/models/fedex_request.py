...
from harpiya.tools.zeep import Client, Plugin, Settings
from harpiya.tools.zeep.exceptions import Fault
from harpiya.tools.zeep.wsdl.utils import etree_to_string

from harpiya.tools import remove_accents, float_repr
...
class FedexRequest():
    """ Low-level object intended to interface Harpiya recordsets with FedEx,
