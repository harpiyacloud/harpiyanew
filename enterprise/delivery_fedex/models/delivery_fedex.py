...
from harpiya import api, models, fields, _, tools
from harpiya.exceptions import UserError
from harpiya.tools import pdf, float_repr
from harpiya.tools.safe_eval import const_eval
...
class DeliveryCarrier(models.Model):
    ...
    fedex_weight_unit = fields.Selection([('LB', 'LB'),
                                          ('KG', 'KG')],
                                         default='LB')
    # Note about weight units: Harpiya (v9) currently works with kilograms.
