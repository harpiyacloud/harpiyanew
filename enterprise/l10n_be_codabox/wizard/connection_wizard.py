...
from harpiya.addons.l10n_be_codabox.const import get_error_msg
...
class L10n_Be_CodaboxConnectionWizard(models.TransientModel):
    ...
    fidu_password = fields.Char(
        string='Password',
        help='This is the password you have received from Harpiya the first time you connected to CodaBox.'
