...
class TestMailMobile(SMSCommon):
    ...
    def setUpClass(cls):
        ...
        cls.env['ir.config_parameter'].sudo().set_param('web.base.url', 'http://yourcompany.harpiya.com')
    ...
    def test_override_url_in_mail(self):
        ...
        original_expected_link = 'http://yourcompany.harpiya.com/mail/view?model=mail.activity&res_id=1'
...
class TestPushNotification(SMSCommon):
    ...
    def setUpClass(cls):
        ...
        sudo_icp.set_param('harpiya_ocn.project_id', 'Test')
    ...
    @patch('harpiya.addons.mail_mobile.models.mail_thread.iap_tools.iap_jsonrpc')
    ...
    def test_push_notifications_android_channel(self, jsonrpc):
        ...
        self.record_simple.with_user(self.user_email).message_post(
            body=Markup('<a href="/harpiya" data-oe-id="%i" data-oe-model="res.partner" >@user</a>') %
