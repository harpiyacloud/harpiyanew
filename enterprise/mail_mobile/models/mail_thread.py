...
from harpiya import models, api, tools
from harpiya.addons.iap.tools import iap_tools

_logger = logger.getLogger(__name__)

MOBILE_APP_IDENTIFIER = 'com.harpiya.mobile'
...
class MailThread(models.AbstractModel):
    ...
    def _notify_thread_by_ocn(self, message, recipients_data, msg_vals=False, **kwargs):
        ...
        if not icp_sudo.get_param('harpiya_ocn.project_id') or not icp_sudo.get_param('mail_mobile.enable_ocn'):
            return
