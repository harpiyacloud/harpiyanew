...
from harpiya.tests import tagged, freeze_time
...
class TestResPartner(AccountTestInvoicingCommon):
    ...
    def test_325_50_invoicing_and_paying_subpartner_should_impact_commercial_partner_legacy_issue(self):
        """ In previous version from Harpiya, the aml could get the partner_id instead of the commercial_partner_id
        set as a partner
        """
        parent_partner = self.env['res.partner'].create({
            'name': 'parent partner',
        ...
        # simulate the previous behavior of Harpiya setting the child_partner on the amls instead of commercial_partner_id
        # for details on this solved issue, see those 2 commits as examples:
        # https://github.com/harpiya/harpiya/commit/4606d1a8890
        # https://github.com/harpiya/harpiya/commit/91379d20da6f7114359c9147654a60fe86b904d5
