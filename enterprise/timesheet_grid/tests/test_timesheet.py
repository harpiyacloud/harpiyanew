...
from harpiya.addons.hr_timesheet.tests.test_timesheet import TestCommonTimesheet
from harpiya.exceptions import AccessError, UserError
from harpiya.tests import Form, freeze_time
...
class TestTimesheetValidation(TestCommonTimesheet, MockEmail):
    ...
    def _test_next_date(self, now, result, delay, interval):
        ...
        patchers = [patch('harpiya.fields.Datetime.now', _now)]
