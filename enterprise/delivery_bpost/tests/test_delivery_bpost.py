...
from harpiya.tests import Form, TransactionCase, tagged
from harpiya.addons.delivery_bpost.models.delivery_bpost import TRACKING_REF_DELIM
...
class TestDeliveryBpost(TransactionCase):
    ...
    def setUp(self):
        ...
        self.your_company.write({'name': 'Harpiya Software Technologies, LLC',
        ...
        self.agrolait.write({'name': 'Harpiya Brussels',
        ...
        self.think_big_system.write({'name': "Palais de l'Élysee",
                                 ...
                                 'phone': '0142928100'})
        self.harpiyainc = self.env['res.partner'].create({'name': "Harpiya Inc.",
                                 'is_company': True,
