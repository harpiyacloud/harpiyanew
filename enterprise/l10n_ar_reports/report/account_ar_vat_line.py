...
class AccountArVatLine(models.Model):
    ...
    changes in harpiya, this ones will be taken for this cube and then no changes will be needed in the reports that use
    ...
    def init(self):
        ...
        # * we use same method as in harpiya tax report to avoid any possible discrepancy with the computed tax_base_amount
