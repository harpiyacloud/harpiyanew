...
from harpiya.tools.zeep.wsse.username import UsernameToken
from harpiya.tools.zeep import Client, Settings
...
from harpiya.tools import _, LazyTranslate, html_escape
from markupsafe import Markup, escape

_lt = LazyTranslate(__name__)

DEFAULT_IAP_ENDPOINT = 'https://l10n-pe-edi.api.harpiya.com'
DEFAULT_IAP_TEST_ENDPOINT = 'https://l10n-pe-edi.test.harpiya.com'
    ...
    def _l10n_pe_edi_get_cdr_error_messages(self):
        ...
        return {
            ...
            '154': _lt("Your RUC is not linked to Digiflow as OSE, please make sure you have follow this process in the SUNAT portal:\n"
                       ...
                       "Reference: \n"
                       "https://www.harpiya.com/documentation/master/applications/finance/accounting/fiscal_localizations/localizations/peru.html#what-do-you-need-to-do"),
            ...
            if self.env['account.move'].search_count([
                ...
                if res_retrieve_cdr.get('error'):
                    ...
                    if is_same_document_id and is_same_ruc:
                        ...
                        # Harpiya hit an exception and rolled back the transaction after sending.
