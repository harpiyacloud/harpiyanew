...
import { Component, reactive, xml } from "@harpiya/owl";
...
export class SubscriptionManager {
    ...
    async buy() {
        ...
        browser.location = `https://www.harpiya.com/harpiya-enterprise/upgrade?num_users=${nbUsers}`;
    }
    /**
    ...
    async renew() {
        ...
        const url = "https://www.harpiya.com/harpiya-enterprise/renew";
    ...
    async upsell() {
        ...
        const url = "https://www.harpiya.com/harpiya-enterprise/upsell";
        const contractQueryString = enterpriseCode ? `&contract=${enterpriseCode}` : "";
