...
class PricerStore(models.Model):
    ...
    # The name of the Pricer store in Harpiya
    name = fields.Char(
        string='Store Name',
        help='Pricer Store name in Harpiya database',
        required=True
    )
    ...
    # Example: "https://1234.harpiya-be.pcm.pricer-plaza.com/api/public/core/v1/items"
    ...
    def unlink_label(self, pricer_tag_id):
        """
        Stop displaying product infromation on a pricer tag when deleting it from Harpiya database
        """
    ...
    def _update_pricer_tags(self, update_all):
        ...
        while maintaining user's pricer tags synchronized with Harpiya database
