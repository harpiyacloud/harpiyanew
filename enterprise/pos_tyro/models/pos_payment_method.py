...
from harpiya import fields, models, api, release
...
class PosPaymentMethod(models.Model):
    ...
    tyro_integrated_receipts = fields.Boolean("Integrated Receipts", default=True, help="If enabled, the Tyro receipt will be embedded in the Harpiya receipt. Otherwise the terminal will print a separate payment receipt.")
    ...
    def get_tyro_product_info(self):
        ...
        return {
            "posProductVendor": "Harpiya",
            "posProductName": "Harpiya Point of Sale",
