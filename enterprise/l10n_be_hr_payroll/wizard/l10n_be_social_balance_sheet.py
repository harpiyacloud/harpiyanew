...
from harpiya.tools.misc import xlsxwriter, format_date
...
class L10nBeSocialBalanceSheet(models.TransientModel):
    ...
    def export_report_xlsx(self):
        ...
        style_special_header = workbook.add_format({'bold': True, 'pattern': 1, 'bg_color': '#003563', 'align': 'center', 'bottom': 1})
        style_vertical_header = workbook.add_format({'bold': True, 'pattern': 1, 'bg_color': '#E0E0E0', 'align': 'center', 'bottom': 1, 'right': 1})
        style_special_vertical_header = workbook.add_format({'bold': True, 'pattern': 1, 'bg_color': '#003563', 'align': 'center', 'bottom': 1, 'right': 1})
