...
from harpiya.tools import float_compare, frozendict
...
class AppointmentType(models.Model):
    ...
    event_videocall_source = fields.Selection([('discuss', 'Harpiya Discuss')], string="Videoconference Link", default="discuss",
    ...
    slot_creation_interval = fields.Float('Create a slot every', default=1.0,
        help="Starting from the beginning of the time slot, Harpiya will create a new slot at regular intervals based on the time specified here.")
