...
import { setSelection } from '@web_editor/js/editor/harpiya-editor/src/utils/utils';
...
function assertHistorySteps(assert, editable, originalContent) {
    ...
    wysiwyg.harpiyaEditor.historyUndo();
    wysiwyg.harpiyaEditor.clean();
    assert.strictEqual(editable.innerHTML, originalContent);
    wysiwyg.harpiyaEditor.historyRedo();
    wysiwyg.harpiyaEditor.clean();
            ...
            models: {
                note: {
                    ...
                    records: [{
                        ...
                        body: '<p><a href="http://harpiya.com">Existing link</a></p>',
                    }],
                },
            },
        };
