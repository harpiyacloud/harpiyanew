...
from harpiya import Command, exceptions, http, fields, _
from harpiya.http import request, route
from harpiya.osv import expression
from harpiya.tools import DEFAULT_SERVER_DATETIME_FORMAT as dtf, email_normalize
from harpiya.tools.mail import is_html_empty
from harpiya.tools.misc import babel_locale_parse, get_lang
...
class AppointmentController(http.Controller):
    ...
    def _appointments_base_domain(cls, filter_appointment_type_ids, search=False, invite_token=False, additional_domain=None, filter_countries=False):
        ...
        Returns:
            list: A list of domain expressions suitable for use in Harpiya record filtering.
        """
