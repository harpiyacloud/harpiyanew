...
from harpiya.addons.appointment.tests.test_performance import AppointmentUIPerformanceCase
from harpiya.addons.appointment_hr.tests.test_performance import AppointmenHrPerformanceCase
