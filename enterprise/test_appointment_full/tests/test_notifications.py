...
from harpiya.addons.appointment.tests.common import AppointmentCommon
from harpiya.addons.google_calendar.models.res_users import ResUsers as GoogleUser
from harpiya.addons.google_calendar.tests.test_sync_common import TestSyncGoogle
from harpiya.addons.microsoft_calendar.models.res_users import ResUsers as MsftUser
from harpiya.addons.microsoft_calendar.tests.common import TestCommon as MsftTestCommon
...
@tagged('post_install', '-at_install', 'mail_flow')
class TestSyncHarpiya2GoogleMail(TestSyncGoogle, TestAppointmentNotificationCommon):
    @freeze_time('2020-02-01 09:00:00')
