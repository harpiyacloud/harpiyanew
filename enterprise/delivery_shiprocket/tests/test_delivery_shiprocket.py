...
from harpiya.addons.delivery_shiprocket.models.shiprocket_request import ShipRocket
from harpiya.addons.delivery_shiprocket.tests.common import ShiprocketCommon
...
class TestDeliveryShiprocket(ShiprocketCommon):
    ...
    def _get_expected_parcel_data(self):
        ...
        return {
            ...
            'billing_email': 'partner@harpiya.com',
            ...
            'shipping_email': 'partner@harpiya.com',
