...
from harpiya.addons.product.tests.common import ProductAttributesCommon
from harpiya.addons.website_sale.controllers.cart import Cart
from harpiya.addons.website_sale.controllers.combo_configurator import (
    WebsiteSaleComboConfiguratorController,
)
from harpiya.addons.website_sale.controllers.main import WebsiteSale
from harpiya.addons.website_sale.controllers.payment import PaymentPortal
from harpiya.addons.website_sale.models.product_template import ProductTemplate
...
class TestWebsiteSaleCart(ProductAttributesCommon, WebsiteSaleCommon):
    ...
    def test_checkout_no_delivery_method_available(self):
        ...
        with (
            ...
            patch(
                'harpiya.addons.website_sale.models.sale_order.SaleOrder._get_preferred_delivery_method',
