...
Harpiya is an <a href="https://www.harpiya.com/app/ecommerce">Open Source eCommerce</a>
...
Harpiya's unique *'edit inline'* and building blocks approach makes product pages
...
Harpiya's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Harpiya's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Harpiya marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. Harpiya proposes
...
SEO tools are ready to use, with no configuration required. Harpiya suggests
...
Create new landing pages easily with the Harpiya inline editing feature. Send
...
Benefit from the power of Harpiya, in your online store: a powerfull tax engine,
...
Everything is integrated with Harpiya. No pain, real time.
