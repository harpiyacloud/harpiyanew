...
from harpiya.tools import SQL, clean_context, float_round, groupby, lazy, str2bool
from harpiya.tools.image import image_data_uri
from harpiya.tools.json import scriptsafe as json_scriptsafe
from harpiya.tools.translate import _

from harpiya.addons.payment.controllers import portal as payment_portal
from harpiya.addons.portal.controllers.portal import _build_url_w_params
from harpiya.addons.sale.controllers import portal as sale_portal
from harpiya.addons.web_editor.tools import get_video_thumbnail
...
from harpiya.addons.website_sale.models.website import PRICELIST_SESSION_CACHE_KEY
...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    def add_product_media(self, media, type, product_product_id, product_template_id, combination_ids=None):
        ...
        if type == 'image':  # Image case
            ...
            media_create_data = [Command.create({
                'name': video_data.get('name', 'Harpiya Video'),
