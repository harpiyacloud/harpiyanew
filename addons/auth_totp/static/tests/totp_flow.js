import { queryAll, waitFor } from "@harpiya/hoot-dom";
...
function closeProfileDialog({content, totp_state}) {
    ...
    return [{
        content,
        //TODO: remove when PIPU macro PR is merged: https://github.com/harpiya/harpiya/pull/194508
