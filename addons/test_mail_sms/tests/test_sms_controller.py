...
from harpiya.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
from harpiya.tests.common import HttpCase, JsonRpcException
...
class TestSmsController(HttpCase, TestSMSActionsCommon):
    ...
    @mute_logger("harpiya.addons.base.models.ir_http")
    ...
    @mute_logger('harpiya.addons.base.models.ir_http', 'harpiya.addons.sms.controllers.main', 'harpiya.http')
