...
from harpiya.addons.calendar.controllers.main import CalendarController
from harpiya.addons.google_account.models.google_service import _get_client_secret
...
class GoogleCalendarController(CalendarController):
    ...
    def google_calendar_sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize Harpiya
            ...
            The dictionary may contains an url, to allow Harpiya Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted Harpiya to access his calendar !
