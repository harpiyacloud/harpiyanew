...
class GoogleCalendarAccountReset(models.TransientModel):
    ...
    delete_policy = fields.Selection(
        [('dont_delete', "Leave them untouched"),
         ...
         ('delete_harpiya', "Delete from Harpiya"),
    ...
    def reset_account(self):
        ...
        if self.delete_policy in ('delete_harpiya', 'delete_both', 'delete_google'):
        ...
        if self.delete_policy not in ('delete_harpiya', 'delete_both'):
