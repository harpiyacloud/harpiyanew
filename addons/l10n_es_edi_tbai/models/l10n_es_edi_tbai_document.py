...
from harpiya import _, api, fields, models, release
from harpiya.addons.l10n_es_edi_sii.models.account_edi_format import PatchedHTTPAdapter
from harpiya.addons.l10n_es_edi_tbai.models.l10n_es_edi_tbai_agencies import get_key
from harpiya.addons.l10n_es_edi_tbai.models.xml_utils import (
    NS_MAP,
...
class L10n_Es_Edi_TbaiDocument(models.Model):
    ...
    def _get_header_values(self):
        return {
            ...
            'harpiya_version': release.version,
        }
