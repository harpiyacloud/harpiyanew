...
from harpiya.modules import get_manifest
...
class WebClient(http.Controller):
    ...
    def bootstrap_translations(self, mods=None):
        ...
        if mods is None:
            mods = harpiya.tools.config['server_wide_modules']
            if request.db:
    ...
    def translations(self, unique, mods=None, lang=None):
        ...
        if mods:
            ...
            mods = list(request.env.registry._init_modules) + harpiya.tools.config['server_wide_modules']
    ...
    def version_info(self):
        return harpiya.service.common.exp_version()
