...
from harpiya.http import content_disposition, dispatch_rpc, request, Response
from harpiya.service import db
from harpiya.tools.misc import file_open, str2bool
from harpiya.tools.translate import _

from harpiya.addons.base.models.ir_qweb import render as qweb_render
...
class Database(http.Controller):
    ...
    def _render_template(self, **d):
        ...
        d['insecure'] = harpiya.tools.config.verify_admin_password('admin')
        d['list_db'] = harpiya.tools.config['list_db']
        d['langs'] = harpiya.service.db.exp_list_lang()
        d['countries'] = harpiya.service.db.exp_list_countries()
        d['pattern'] = DBNAME_PATTERN
        # databases list
        try:
            d['databases'] = http.db_list()
            d['incompatible_databases'] = harpiya.service.db.list_db_incompatible(d['databases'])
    ...
    def create(self, master_pwd, name, lang, password, **post):
        insecure = harpiya.tools.config.verify_admin_password('admin')
        ...
        try:
            ...
            with harpiya.modules.registry.Registry(name).cursor() as cr:
            ...
            return request.redirect('/harpiya')
    ...
    def backup(self, master_pwd, name, backup_format='zip'):
        ...
        if insecure and master_pwd:
            dispatch_rpc('db', 'change_admin_password', ["admin", master_pwd])
        try:
            harpiya.service.db.check_super(master_pwd)
            ...
            dump_stream = harpiya.service.db.dump_db(name, None, backup_format)
