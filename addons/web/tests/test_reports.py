...
class TestReports(harpiya.tests.HttpCase):
    def test_report_session_cookie(self):
        """ Asserts wkhtmltopdf forwards the user session when requesting resources to Harpiya, such as images,
    ...
    @mute_logger('harpiya.addons.base.models.ir_actions_report')
