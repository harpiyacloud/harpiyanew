...
class BasePreferences {
  #defaults = Object.freeze({
    ...
    // Harpiya: don't support scripting (#115302)
    enableScripting: false,
    // Harpiya: disable stamp editor
    enableUpdatedAddImage: false,
    // HARPIYA: open links in new tabs to keep harpiya document (#84594)
  ...
  try {
    ...
    activeService.renderPages().then(function () {
      ...
      if (activeServiceOnEntry.active) {
        // HARPIYA Patch: https://github.com/mozilla/pdf.js/issues/10630#issuecomment-855754913
