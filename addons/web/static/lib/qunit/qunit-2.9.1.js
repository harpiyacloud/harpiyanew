...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("HarpiyaBeforeTestHook", "HarpiyaAfterTestHook"); // Harpiya customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("HarpiyaBeforeTestHook"); // Harpiya customization
  	...
  	finish: async function finish() {
  		...
  		emit("HarpiyaAfterTestHook", this);
