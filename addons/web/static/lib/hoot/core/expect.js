 ...
 *
 * @typedef {import("@harpiya/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@harpiya/hoot-dom").FormatXmlOptions} FormatXmlOptions
 ...
 * @typedef {import("@harpiya/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@harpiya/hoot-dom").QueryTextOptions} QueryTextOptions
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/harpiya/i);
     */
