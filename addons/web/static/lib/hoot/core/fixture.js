...
/**
 * @typedef {Parameters<typeof import("@harpiya/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@harpiya/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@harpiya/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@harpiya/owl").Component} target
 */
