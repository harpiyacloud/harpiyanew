import { after, destroy, getFixture } from "@harpiya/hoot";
import { queryFirst, queryOne } from "@harpiya/hoot-dom";
import { App, Component, xml } from "@harpiya/owl";
...
/**
 * @typedef {import("@harpiya/owl").Component} Component
 *
 * @typedef {import("@web/env").HarpiyaEnv} HarpiyaEnv
 *
 * @typedef {Parameters<typeof import("@harpiya/owl").mount>[2]} MountOptions
 *
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@harpiya/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
