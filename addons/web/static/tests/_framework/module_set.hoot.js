...
import { describe, dryRun, globals, start, stop } from "@harpiya/hoot";
import { Deferred } from "@harpiya/hoot-dom";
import { watchKeys, watchListeners } from "@harpiya/hoot-mock";
import { whenReady } from "@harpiya/owl";
...
class ModuleSetLoader extends loader.constructor {
    ...
    constructor(moduleSet) {
        ...
        harpiya.define = this.define.bind(this);
        harpiya.loader = this;
    }
...
const AUTO_INCLUDED_ADDONS = {
    /**
     * spreadsheet addons defines a module that does not starts with `@spreadsheet` but `@harpiya` (`@harpiya/o-spreadsheet)
     * To ensure that this module is loaded, we have to include `harpiya` in the dependencies
     */
    spreadsheet: ["harpiya"],
    /**
...
const CSRF_TOKEN = harpiya.csrf_token;
...
const R_DEFAULT_MODULE = /^@harpiya\/(owl|hoot)/;
