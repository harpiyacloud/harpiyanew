import { after, afterEach, beforeEach, registerDebugInfo } from "@harpiya/hoot";
 ...
 *
 * @param {Partial<HarpiyaEnv>} [partialEnv]
 */
 ...
 *  (env: HarpiyaEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
