import { before, createJobScopedGetter, expect, getCurrent, registerDebugInfo } from "@harpiya/hoot";
import { mockFetch, mockWebSocket } from "@harpiya/hoot-mock";
...
export class MockServer {
    ...
    /** @type {import("@harpiya/hoot-mock").ServerWebSocket[]} */
    websockets = [];
    ...
    _findAction(id) {
        ...
        if (!actions.length) {
            throw makeServerError({
                errorName: "harpiya.addons.web.controllers.action.MissingActionError",
