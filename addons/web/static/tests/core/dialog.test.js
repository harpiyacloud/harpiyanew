import { destroy, expect, test } from "@harpiya/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@harpiya/hoot-dom";
import { animationFrame } from "@harpiya/hoot-mock";
import { Component, onMounted, useState, xml } from "@harpiya/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
