/** @harpiya-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { beforeEach, expect, test } from "@harpiya/hoot";
import { hover, queryFirst } from "@harpiya/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@harpiya/hoot-mock";
import { Component, onPatched, xml } from "@harpiya/owl";
import {
    contains,
    mountWithCleanup,
    patchWithCleanup,
