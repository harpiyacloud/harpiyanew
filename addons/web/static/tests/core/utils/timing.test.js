import { describe, destroy, expect, getFixture, test } from "@harpiya/hoot";
import { click, tick } from "@harpiya/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@harpiya/hoot-mock";
