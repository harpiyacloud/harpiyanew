...
test("escape", () => {
    ...
    expect(escape(`<a href="https://www.harpiya.com">harpiya<a>`)).toBe(
        `&lt;a href=&quot;https://www.harpiya.com&quot;&gt;harpiya&lt;a&gt;`
    );
    expect(escape(`<a href='https://www.harpiya.com'>harpiya<a>`)).toBe(
        `&lt;a href=&#x27;https://www.harpiya.com&#x27;&gt;harpiya&lt;a&gt;`
    );
    expect(escape("<a href='https://www.harpiya.com'>Harpiya`s website<a>")).toBe(
        `&lt;a href=&#x27;https://www.harpiya.com&#x27;&gt;Harpiya&#x60;s website&lt;a&gt;`
    );
});
...
test("escapeRegExp", () => {
    ...
    expect(escapeRegExp("[wowl]")).toBe("\\[wowl\\]");
    expect(escapeRegExp("[wowl.harpiya]")).toBe("\\[wowl\\.harpiya\\]");
    expect(escapeRegExp("^harpiya.define([.]*)$")).toBe("\\^harpiya\\.define\\(\\[\\.\\]\\*\\)\\$");
    expect(escapeRegExp("[.*+?^${}()|[]\\")).toBe("\\[\\.\\*\\+\\?\\^\\$\\{\\}\\(\\)\\|\\[\\]\\\\");
});
...
test("isEmail", () => {
    ...
    expect(isEmail("test@harpiya")).toBe(false);
    expect(isEmail("test@harpiya@harpiya.com")).toBe(false);
    expect(isEmail("te st@harpiya.com")).toBe(false);

    expect(isEmail("test@harpiya.com")).toBe(true);
});
