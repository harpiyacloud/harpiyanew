import { destroy, expect, getFixture, onError, test } from "@harpiya/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@harpiya/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@harpiya/hoot-mock";
import { Component, useRef, useState, xml } from "@harpiya/owl";
import {
    contains,
    getService,
    makeMockEnv,
