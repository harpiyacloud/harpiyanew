import { beforeEach, expect, getFixture, test } from "@harpiya/hoot";
import { microTick, tick } from "@harpiya/hoot-dom";
...
/** @type {typeof HarpiyaModuleLoader} */
const ModuleLoader = Object.getPrototypeOf(harpiya.loader.constructor);
