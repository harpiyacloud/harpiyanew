import { after, beforeEach, expect, test } from "@harpiya/hoot";
import {
    click,
    dblclick,
    drag,
...
import { Component, onRendered, onWillRender, xml } from "@harpiya/owl";
import {
    MockServer,
    clickKanbanLoadMore,
    clickModalButton,
...
test("quick create record: cancel when modal is opened", async () => {
    ...
    // Check harpiya/harpiya#61981 for more details.
...
test("kanban records are middle clickable by default", async () => {
    ...
    expect.verifySteps([
        ...
        'set current_action-{"id":1,"res_model":"partner","type":"ir.actions.act_window","views":[[false,"kanban"],[false,"form"]]}',
        "opened in new window: /harpiya/action-1/1",
        'set current_action-{"id":1,"res_model":"partner","type":"ir.actions.act_window","views":[[false,"kanban"],[false,"form"]]}',
    ]);
});
