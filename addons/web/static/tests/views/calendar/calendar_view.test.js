...
import { Component, onRendered, onWillRender, onWillStart, xml } from "@harpiya/owl";
import {
    MockServer,
    contains,
    defineActions,
...
/**
 * @param {import("@harpiya/hoot-dom").Target} from
 * @param {import("@harpiya/hoot-dom").Target} to
 * @param {{
