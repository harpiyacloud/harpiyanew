import { getFixture, after } from "@harpiya/hoot";
...
export async function startInteractions(
    ...
    if (harpiya.loader.modules.has("@mail/../tests/mail_test_helpers")) {
        const { defineMailModels } = harpiya.loader.modules.get("@mail/../tests/mail_test_helpers");
        defineMailModels();
    }
