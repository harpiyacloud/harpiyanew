/** @harpiya-module alias=@web/../tests/setup default=false */
...
import { App, EventBus, whenReady } from "@harpiya/owl";
...
function makeMockLocation() {
    return Object.assign(document.createElement("a"), {
        href: window.location.origin + "/harpiya",
        assign(url) {
            this.href = url;
        },
        reload() {},
