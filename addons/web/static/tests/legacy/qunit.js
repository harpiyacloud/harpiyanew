/** @harpiya-module alias=@web/../tests/qunit default=false */
...
export function setupQUnit() {
    ...
    QUnit.done(async (result) => {
        await harpiya.loader.checkErrorProm;
    ...
    QUnit.begin(function () {
        if (harpiya.debug && harpiya.debug.includes("assets")) {
    ...
    QUnit.on("HarpiyaAfterTestHook", (info) => {
