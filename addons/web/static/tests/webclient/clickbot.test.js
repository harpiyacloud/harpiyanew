...
import { animationFrame, Deferred, mockDate, runAllTimers, tick } from "@harpiya/hoot-mock";
import {
    defineActions,
    defineMenus,
    defineModels,
...
import { onWillStart, onWillUpdateProps } from "@harpiya/owl";
...
test("clickbot show rpc error when an error dialog is detected", async () => {
    ...
    const expectedRpcData = JSON.stringify({
        ...
        error: {
            ...
            code: 0,
            data: {
                name: "harpiya.exceptions.Programming error",
                debug: "traceback",
                arguments: [],
                context: {},
            },
            exceptionName: "harpiya.exceptions.Programming error",
            subType: "server",
            message: "This is a server Error, it should be displayed in an error dialog",
            id: null,
            model: "foo",
