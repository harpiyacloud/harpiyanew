...
export async function startWebClient(Webclient) {
    ...
    harpiya.isReady = false;

    await whenReady();
    const app = await mountComponent(Webclient, document.body, { name: "Harpiya Web Client" });
    const { env } = app;
    Component.env = env;
    ...
    // delete harpiya.debug; // FIXME: some legacy code rely on this
    harpiya.isReady = true;
}
