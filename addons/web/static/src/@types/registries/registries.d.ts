declare module "registries" {
    ...
    import { HarpiyaEnv } from "@web/env";
    ...
    export type ActionsRegistryItemShape = (((env: HarpiyaEnv, action: ActionDescription) => void) | typeof Component) & {
        displayName?: string;
        path?: string;
        target?: ActionMode;
    };
    ...
    export interface CogMenuRegistryItemShape {
        ...
        groupNumber: number;
        isDisplayed?: (env: HarpiyaEnv) => boolean;
    }

    export type DialogsRegistryItemShape = typeof Component;

    export type EffectsRegistryItemShape = (env: HarpiyaEnv, params: object) => ({ Component: typeof Component, props: object } | undefined);

    export type ErrorDialogsRegistryItemShape = typeof Component;

    export type ErrorHandlersRegistryItemShape = (env: HarpiyaEnv, error: Error, originalError: Error) => boolean;
    ...
    export type IrActionsReportHandlers = (action: ActionRequest, options: ActionOptions, env: HarpiyaEnv) => (void | boolean | Promise<void | boolean>);
