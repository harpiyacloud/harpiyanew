...
import { App, reactive } from "@harpiya/owl";
...
function setup(light, currentState) {
    env = harpiya.__WOWL_DEBUG__.root.env;
    ...
    isEnterprise = harpiya.info && harpiya.info.isEnterprise;
...
async function _clickEverywhere(xmlId, light, currentState) {
    ...
    console.log(`Harpiya flavor: ${isEnterprise ? "Enterprise" : "Community"}`);
