...
import { Component, useRef, useSubEnv } from "@harpiya/owl";
 ...
 * It uses a feature to automatically create links to other harpiya pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
