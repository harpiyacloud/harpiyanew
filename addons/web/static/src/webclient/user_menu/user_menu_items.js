import { Component, markup } from "@harpiya/owl";
...
function documentationItem(env) {
    const documentationURL = "https://www.harpiya.com/documentation/master";
    return {
        type: "item",
        id: "documentation",
...
export function harpiyaAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My Harpiya.com account"),
        callback: () => {
            rpc("/web/session/account")
                ...
                .catch(() => {
                    browser.open("https://accounts.harpiya.com/account", "_blank");
                });
        },
        sequence: 60,
    };
...
registry
    ...
    .add("harpiya_account", harpiyaAccountItem)
