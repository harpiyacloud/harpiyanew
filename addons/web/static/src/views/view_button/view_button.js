...
const harpiyaToBootstrapClasses = {
...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(harpiya.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in harpiyaToBootstrapClasses) {
                    cls = harpiyaToBootstrapClasses[cls];
                }
                classNames.push(cls);
