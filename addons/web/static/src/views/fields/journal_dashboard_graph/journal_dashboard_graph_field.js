...
import { Component, onWillStart, useEffect, useRef } from "@harpiya/owl";
...
export class JournalDashboardGraphField extends Component {
    ...
    getLineChartConfig() {
        ...
        const color10 = getColor(3, cookie.get("color_scheme"), "harpiya");
    ...
    getBarChartConfig() {
        ...
        const color13 = getColor(2, cookie.get("color_scheme"), "harpiya");
        const color19 = getColor(1, cookie.get("color_scheme"), "harpiya");
