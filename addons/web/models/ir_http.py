...
import harpiya
from harpiya import api, models, fields
from harpiya.http import request, DEFAULT_MAX_CONTENT_LENGTH
...
class IrHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = harpiya.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.harpiya.com/buy",
            "name": user.name,
            "username": user.login,
