import { markup, whenReady, validate } from "@harpiya/owl";
...
export const tourService = {
    ...
    start: async (_env, { orm, effect, overlay }) => {
        ...
        harpiya.startTour = startTour;
        harpiya.isTourReady = (tourName) => getTourFromRegistry(tourName).wait_for.then(() => true);
