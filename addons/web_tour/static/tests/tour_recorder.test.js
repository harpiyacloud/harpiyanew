...
import { click, edit, keyDown, keyUp, press, queryOne } from "@harpiya/hoot-dom";
import { animationFrame, runAllTimers } from "@harpiya/hoot-mock";
import {
    contains,
    defineWebModels,
    mountWithCleanup,
...
test("Click on element with unique harpiya class", async () => {
...
test("Click on element with no unique harpiya class", async () => {
    await mountWithCleanup(
        `
        <div class="o_parent">
            <div class="o_child_1 click"></div>
...
test("Find the nearest harpiya class", async () => {
