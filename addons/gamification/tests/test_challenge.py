...
from harpiya.addons.gamification.tests.common import TransactionCaseGamification
...
class test_challenge(TestGamificationCommon):
    ...
    @mute_logger('harpiya.models.unlink', 'harpiya.addons.mail', 'harpiya.addons.auth_signup')
