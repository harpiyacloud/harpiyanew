...
from harpiya.addons.payment_authorize import const
from harpiya.addons.payment_authorize.models.authorize_request import AuthorizeAPI
...
class PaymentProvider(models.Model):
    ...
    authorize_client_key = fields.Char(
        ...
        help="The public client key. To generate directly from Harpiya or from Authorize.Net backend.")
