...
- `16.1`
  - The "Authorize Currency" field is replaced by the generic "Currencies" field of `payment`.
    harpiya/harpiya#101018
- `16.0`
  - Archiving a token no longer deactivates the related payment method on Authorize. harpiya/harpiya#93774
- `15.4`
  - The support for full refunds is added. harpiya/harpiya#92279
- `15.0`
  - Support for ACH payments is added. harpiya/harpiya#75289
- `14.3`
  - The payment with redirection flow that existed alongside the direct payment flow is dropped.
    harpiya/harpiya#141661
