...
from harpiya.tools import config, DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, parse_version
...
class Base_ImportMapping(models.Model):
    ...
    not match Harpiya's field names or labels. This model is used
    ...
    def get_fields_tree(self, model, depth=FIELDS_RECURSION_LIMIT):
        ...
        .. class:: Field
            ...
            .. attribute:: model_name: str
                ...
                Used in the Harpiya Field Tooltip on the import view
