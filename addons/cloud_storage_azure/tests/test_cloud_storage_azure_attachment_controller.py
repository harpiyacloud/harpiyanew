...
from harpiya.addons.cloud_storage_azure.tests.test_cloud_storage_azure import TestCloudStorageAzureCommon
...
class TestCloudStorageAttachmentController(HttpCaseWithUserDemo, TestCloudStorageAzureCommon):
    def test_cloud_storage_azure_attachment_upload(self):
        ...
        with patch(
            "harpiya.addons.cloud_storage_azure.utils.cloud_storage_azure_utils.requests.post", post
        ):
                            ...
                            "ir.attachment": [
                                {
                                    ...
                                    "create_date": harpiya.fields.Datetime.to_string(
