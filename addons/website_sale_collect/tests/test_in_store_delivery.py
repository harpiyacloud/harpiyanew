...
from harpiya.addons.website_sale_collect.controllers.delivery import InStoreDelivery
...
class TestInStoreDeliveryController(PaymentHttpCommon, ClickAndCollectCommon):
    ...
    def test_order_not_created_on_fetching_pickup_location_with_empty_cart(self):
        ...
        with patch(
            'harpiya.addons.website_sale_collect.models.sale_order.SaleOrder._get_pickup_locations',
            return_value={}
        ):
