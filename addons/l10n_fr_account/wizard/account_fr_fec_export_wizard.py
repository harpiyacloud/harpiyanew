...
import csv
import io
from harpiya.tools import float_is_zero, SQL
...
class L10n_FrFecExportWizard(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # 1) the XSD file impose to have the label on the account.move, but Harpiya has the label on the account.move.line,
        # so that's a  problem !
