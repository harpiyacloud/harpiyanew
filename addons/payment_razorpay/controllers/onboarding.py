...
class RazorpayController(Controller):
    ...
    def razorpay_return_from_authorization(self, **data):
        ...
        # Retrieve the Razorpay data and Harpiya metadata from the redirect data.
        ...
        redirect_url = f'/harpiya/action-{action.id}/{int(provider_sudo.id)}'
