...
/**
 * @template T
 * @typedef {import("@harpiya/o-spreadsheet").StoreConstructor<T>} StoreConstructor<T>
 */
 ...
 * @param  {any[]} args
 * @return {Promise<{ store: T, container: InstanceType<DependencyContainer>, model: HarpiyaSpreadsheetModel }>}
 */
...
/**
 * @template T
 * @param {import("@harpiya/o-spreadsheet").Model} model
 * @param {StoreConstructor<T>} Store
 * @param  {any[]} args
 * @return {{ store: T, container: InstanceType<DependencyContainer>, model: HarpiyaSpreadsheetModel }}
 */
