...
import { helpers, registries, EvaluationError } from "@harpiya/o-spreadsheet";
...
functionRegistry.add("HARPIYA.LIST", HARPIYA_LIST);
functionRegistry.add("HARPIYA.LIST.HEADER", HARPIYA_LIST_HEADER);
