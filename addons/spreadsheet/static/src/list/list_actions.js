...
import { astToFormula, helpers } from "@harpiya/o-spreadsheet";
...
/**
 * @param {import("@harpiya/o-spreadsheet").CellPosition} position
...
/**
 * @param {import("@harpiya/o-spreadsheet").CellPosition} position
 * @param {import("@spreadsheet").HarpiyaGetters} getters
 * @returns {boolean}
 */
export const SEE_RECORD_LIST_VISIBLE = (position, getters) => {
    ...
    return !!(
        ...
        getFirstListFunction(cell.compiledFormula.tokens).functionName === "HARPIYA.LIST"
    );
};
