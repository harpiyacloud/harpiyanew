...
export class HarpiyaPyramidChart extends HarpiyaChart {
...
chartRegistry.add("harpiya_pyramid", {
    match: (type) => type === "harpiya_pyramid",
    createChart: (definition, sheetId, getters) =>
        new HarpiyaPyramidChart(definition, sheetId, getters),
    getChartRuntime: createHarpiyaChartRuntime,
    validateChartDefinition: (validator, definition) =>
        HarpiyaPyramidChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => HarpiyaPyramidChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () =>
        HarpiyaPyramidChart.getDefinitionFromContextCreation(),
    name: _t("Pyramid"),
});
