...
export class HarpiyaPieChart extends HarpiyaChart {
...
chartRegistry.add("harpiya_pie", {
    match: (type) => type === "harpiya_pie",
    createChart: (definition, sheetId, getters) => new HarpiyaPieChart(definition, sheetId, getters),
    getChartRuntime: createHarpiyaChartRuntime,
    validateChartDefinition: (validator, definition) =>
        HarpiyaPieChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => HarpiyaPieChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => HarpiyaPieChart.getDefinitionFromContextCreation(),
    name: _t("Pie"),
});
