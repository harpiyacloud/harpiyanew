...
export class HarpiyaComboChart extends HarpiyaChart {
...
chartRegistry.add("harpiya_combo", {
    match: (type) => type === "harpiya_combo",
    createChart: (definition, sheetId, getters) => new HarpiyaComboChart(definition, sheetId, getters),
    getChartRuntime: createHarpiyaChartRuntime,
    validateChartDefinition: (validator, definition) =>
        HarpiyaComboChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => HarpiyaComboChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => HarpiyaComboChart.getDefinitionFromContextCreation(),
    name: _t("Combo"),
});
