import { AbstractChart, CommandResult } from "@harpiya/o-spreadsheet";
 ...
 *
 * @typedef HarpiyaChartDefinition
 ...
 *
 * @typedef HarpiyaChartDefinitionDataSource
 * @property {MetaData} metaData
 * @property {SearchParams} searchParams
 *
 */

export class HarpiyaChart extends AbstractChart {
    /**
     * @param {HarpiyaChartDefinition} definition
    ...
    constructor(definition, sheetId, getters) {
        ...
        this.metaData = {
            ...definition.metaData,
            mode: this.type.replace("harpiya_", ""),
    ...
    static getDefinitionFromContextCreation() {
        throw new Error("It's not possible to convert an Harpiya chart to a native chart");
    }

    /**
     * @returns {HarpiyaChartDefinitionDataSource}
     */
    ...
    /**
     * @returns {HarpiyaChartDefinition}
     */
    getDefinition() {
        return {
