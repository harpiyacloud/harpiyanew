...
/**
 * @typedef {Object} HarpiyaModelMetaData
 * @property {string} resModel
 * @property {HarpiyaFields} [fields]
 *
 * @typedef {Object} HarpiyaModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class HarpiyaViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {HarpiyaModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {HarpiyaModelMetaData} */
    ...
    async loadMetadata() {
        if (!this._metaData.fields) {
            this._metaData.fields = await getFields(
                this.harpiyaDataProvider.fieldService,
    ...
    /**
     * @returns {HarpiyaFields} List of fields
     */
    getFields() {
     ...
     * @returns {HarpiyaField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
