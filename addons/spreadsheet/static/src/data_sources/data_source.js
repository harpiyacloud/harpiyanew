...
import { CellErrorType, EvaluationError } from "@harpiya/o-spreadsheet";
import { _t } from "@web/core/l10n/translation";

/**
 * @typedef {import("./harpiya_data_provider").HarpiyaDataProvider} HarpiyaDataProvider
...
export class LoadableDataSource {
    /**
     * @param {Object} param0
     * @param {HarpiyaDataProvider} param0.harpiyaDataProvider
     */
    constructor({ harpiyaDataProvider }) {
        /** @protected */
    ...
    get _orm() {
        return this.harpiyaDataProvider.orm;
    }

    get serverData() {
        return this.harpiyaDataProvider.serverData;
    }

    get modelDisplayNameService() {
        return this.harpiyaDataProvider.modelDisplayNameService;
    }
    ...
    async load(params) {
        if (params && params.reload) {
            this.harpiyaDataProvider.cancelPromise(this._loadPromise);
            this._loadPromise = undefined;
        }
        if (!this._loadPromise) {
            ...
            await this.harpiyaDataProvider.notifyWhenPromiseResolves(this._loadPromise);
        }
 ...
 * @param {string} model
 * @returns {Promise<import("@spreadsheet").HarpiyaFields>}
 */
