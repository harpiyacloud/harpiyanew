...
export class GlobalFiltersCoreViewPlugin extends HarpiyaCoreViewPlugin {
    ...
    constructor(config) {
        ...
        this.harpiyaDataProvider = config.custom.harpiyaDataProvider;
        /**
        ...
        switch (filter.type) {
            ...
            case "relation":
                ...
                if (!this.recordsDisplayName[filter.id]) {
                    ...
                    this.harpiyaDataProvider.notifyWhenPromiseResolves(promise);
                    return [[{ value: "" }]];
                }
