...
import { registries, helpers, constants } from "@harpiya/o-spreadsheet";
...
const harpiyaNumberDateAdapter = {
...
const harpiyaHourNumberAdapter = {
    normalizeServerValue(groupBy, field, readGroupResult) {
        return Number(readGroupResult[groupBy]);
    },
    increment(normalizedValue, step) {
...
const harpiyaMinuteNumberAdapter = {
    normalizeServerValue(groupBy, field, readGroupResult) {
        return Number(readGroupResult[groupBy]);
    },
    increment(normalizedValue, step) {
...
const harpiyaSecondNumberAdapter = {
    normalizeServerValue(groupBy, field, readGroupResult) {
        return Number(readGroupResult[groupBy]);
    },
    increment(normalizedValue, step) {
...
pivotTimeAdapterRegistry.add("week", falseHandlerDecorator(harpiyaWeekAdapter));
pivotTimeAdapterRegistry.add("month", falseHandlerDecorator(harpiyaMonthAdapter));
pivotTimeAdapterRegistry.add("quarter", falseHandlerDecorator(harpiyaQuarterAdapter));

extendSpreadsheetAdapter("day", harpiyaDayAdapter);
extendSpreadsheetAdapter("year", harpiyaYearAdapter);
extendSpreadsheetAdapter("day_of_month", harpiyaNumberDateAdapter);
extendSpreadsheetAdapter("iso_week_number", harpiyaNumberDateAdapter);
extendSpreadsheetAdapter("month_number", harpiyaNumberDateAdapter);
extendSpreadsheetAdapter("quarter_number", harpiyaNumberDateAdapter);
extendSpreadsheetAdapter("day_of_week", harpiyaDayOfWeekAdapter);
extendSpreadsheetAdapter("hour_number", harpiyaHourNumberAdapter);
extendSpreadsheetAdapter("minute_number", harpiyaMinuteNumberAdapter);
extendSpreadsheetAdapter("second_number", harpiyaSecondNumberAdapter);
