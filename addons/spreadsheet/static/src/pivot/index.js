...
import { PivotHarpiyaCorePlugin } from "./plugins/pivot_harpiya_core_plugin";
...
coreTypes.add("UPDATE_HARPIYA_PIVOT_DOMAIN");

invalidateEvaluationCommands.add("UPDATE_HARPIYA_PIVOT_DOMAIN");
...
inverseCommandRegistry.add("UPDATE_HARPIYA_PIVOT_DOMAIN", identity);

export { PivotHarpiyaCorePlugin, PivotCoreViewGlobalFilterPlugin, PivotUIGlobalFilterPlugin };
