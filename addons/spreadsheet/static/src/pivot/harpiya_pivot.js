...
import { NO_RECORD_AT_THIS_POSITION, HarpiyaPivotModel } from "./pivot_model";
import { EvaluationError, PivotRuntimeDefinition, registries, helpers } from "@harpiya/o-spreadsheet";
import { LOADING_ERROR } from "@spreadsheet/data_sources/data_source";
import { omit } from "@web/core/utils/objects";
import { HarpiyaPivotLoader } from "./harpiya_pivot_loader";
...
/**
 * @typedef {import("@harpiya/o-spreadsheet").FunctionResultObject} FunctionResultObject
 * @typedef {import("@harpiya/o-spreadsheet").PivotMeasure} PivotMeasure
 * @typedef {import("@harpiya/o-spreadsheet").PivotDomain} PivotDomain
 * @typedef {import("@harpiya/o-spreadsheet").PivotDimension} PivotDimension
 * @typedef {import("@harpiya/o-spreadsheet").PivotCoreMeasure} PivotCoreMeasure
 * @typedef {import("@spreadsheet").WebPivotModelParams} WebPivotModelParams
 * @typedef {import("@spreadsheet").HarpiyaPivot<HarpiyaPivotRuntimeDefinition>} IPivot
 * @typedef {import("@spreadsheet").HarpiyaFields} HarpiyaFields
 * @typedef {import("@spreadsheet").HarpiyaPivotCoreDefinition} HarpiyaPivotCoreDefinition
 * @typedef {import("@spreadsheet").HarpiyaGetters} HarpiyaGetters
 ...
 * @implements {IPivot}
 */
export class HarpiyaPivot {
    /**
     *
     * @override
     * @param {Object} services Services (see DataSource)
     * @param {Object} params
     * @param {HarpiyaPivotCoreDefinition} params.definition
     * @param {HarpiyaGetters} params.getters
     */
    constructor(services, { definition, getters }) {
        /** @type {"HARPIYA"} */
        this.type = "HARPIYA";

        /** @type {HarpiyaPivotCoreDefinition} @protected */
        this.coreDefinition = definition;

        this.needsReevaluation = false;

        /** @type {HarpiyaPivotRuntimeDefinition | undefined} @protected */
        this.runtimeDefinition = undefined;

        /** @type {HarpiyaPivotModel | undefined} @protected */
        this.model = undefined;

        /** @type {HarpiyaGetters} @protected */
        this.getters = getters;

        /** @protected */
        this.loader = new HarpiyaPivotLoader(services.harpiyaDataProvider, this._load.bind(this));

        /** @type {HarpiyaFields | undefined} @protected */
        this._fields = undefined;

        /** @protected @type {HarpiyaDataProvider}*/
        this.harpiyaDataProvider = services.harpiyaDataProvider;
    ...
    /**
     * @param {HarpiyaPivotCoreDefinition} nextDefinition
     */
    onDefinitionChange(nextDefinition) {
        ...
        if (
            ...
            if (
                ...
                this.coreDefinition = nextDefinition;
                const runtimeDefinition = new HarpiyaPivotRuntimeDefinition(
                    this.coreDefinition,
                    this.getFields()
                );
    ...
    async createModelAndDefinition() {
        ...
        const definition = new HarpiyaPivotRuntimeDefinition(this.coreDefinition, this.getFields());
        const model = new HarpiyaPivotModel(
            { _t },
            {
            ...
            {
                orm: this.harpiyaDataProvider.orm,
                serverData: this.harpiyaDataProvider.serverData,
    ...
    /**
     * @param {import("@harpiya/o-spreadsheet").Maybe<FunctionResultObject>[]} args
     *
     * @returns {PivotDomain}
     */
...
export class HarpiyaPivotRuntimeDefinition extends PivotRuntimeDefinition {
    /**
     * @param {HarpiyaPivotCoreDefinition} definition
     * @param {HarpiyaFields} fields
     */
...
supportedPivotPositionalFormulaRegistry.add("HARPIYA", true);
