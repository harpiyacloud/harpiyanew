...
export class PivotCoreGlobalFilterPlugin extends HarpiyaCorePlugin {
        ...
        globalFiltersFieldMatchers["pivot"] = {
            getIds: () =>
                this.getters
                    ...
                    .filter(
                        (id) =>
                            this.getters.getPivotCoreDefinition(id).type === "HARPIYA" &&
                            id in this.pivots
                    ),
            ...
            getModel: (pivotId) => {
                ...
                return pivot.type === "HARPIYA" && pivot.model;
            },
        };
    }
    ...
    handle(cmd) {
        switch (cmd.type) {
            ...
            case "DUPLICATE_PIVOT": {
                ...
                if(pivotDefinition.type !== "HARPIYA") {
                    break;
                }
    ...
    export(data) {
        for (const id in this.pivots) {
            ...
            data.pivots[id].fieldMatching =
                pivot.type === "HARPIYA" ? this.pivots[id].fieldMatching : {};
        }
    }
}
