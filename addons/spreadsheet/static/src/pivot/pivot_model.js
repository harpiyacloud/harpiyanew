...
import { helpers, constants, EvaluationError, SpreadsheetPivotTable } from "@harpiya/o-spreadsheet";
...
/**
 * @typedef {import("@harpiya/o-spreadsheet").PivotTableColumn} PivotTableColumn
 * @typedef {import("@harpiya/o-spreadsheet").PivotTableRow} PivotTableRow
 ...
 */
export class HarpiyaPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").HarpiyaEnv} env
     * @param {import("@spreadsheet").HarpiyaPivotModelParams} params
    ...
    constructor(env, params, services) {
        ...
        /**
         * @type {import("@spreadsheet").HarpiyaGetters}
         */
    ...
    /**
     * Get the Harpiya domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
    ...
    /**
     * @param {import("@harpiya/o-spreadsheet").PivotDimension} dimension
