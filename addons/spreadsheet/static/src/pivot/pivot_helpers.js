...
import { EvaluationError, helpers } from "@harpiya/o-spreadsheet";
 ...
 * @typedef {import("@harpiya/o-spreadsheet").Granularity} Granularity
 * */
...
export const HARPIYA_AGGREGATORS = {};

for (const type in AGGREGATORS_BY_FIELD_TYPE) {
    HARPIYA_AGGREGATORS[type] = {};
    for (const aggregator of AGGREGATORS_BY_FIELD_TYPE[type]) {
        HARPIYA_AGGREGATORS[type][aggregator] = AGGREGATOR_NAMES[aggregator];
    }
}
 ...
 * @param {Record<string, HarpiyaField | undefined>} allFields
 * @param {string} groupFieldString
 * @returns {{field: HarpiyaField, granularity: Granularity, isPositional: boolean, dimensionWithGranularity: string}}
 */
