...
class BadHarpiyaLinkError extends EvaluationError {
    constructor(menuId) {
        super(
...
export const spreadsheetLinkMenuCellService = {
    ...
    start(env) {
        function _getIrMenuByXmlId(xmlId) {
            ...
            if (!menu) {
                throw new BadHarpiyaLinkError(xmlId);
            }
            return menu;
        }

        urlRegistry
            .add("HarpiyaMenuIdLink", {
                sequence: 65,
                ...
                createLink(url, label) {
                    ...
                    if (!menu) {
                        throw new BadHarpiyaLinkError(menuId);
                    }
                    return {
                        url,
                        label: _t(label),
