...
from harpiya.exceptions import ValidationError, MissingError

from harpiya.addons.spreadsheet.utils.validate_data import fields_in_spreadsheet, menus_xml_ids_in_spreadsheet
...
class SpreadsheetMixin(models.AbstractModel):
    ...
    def _empty_spreadsheet_data(self):
        ...
        locale = lang._harpiya_lang_to_spreadsheet_locale()
        return {
            "version": 1,
            "sheets": [
                {
