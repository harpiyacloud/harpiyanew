...
class IrWebsocket(models.AbstractModel):
    ...
    def _serve_ir_websocket(self, event_name, data):
        ...
        message, Harpiya.sh does not use this method. Each new event should have a corresponding http
        route and Harpiya.sh infrastructure should be updated to reflect it. On top of that, the
