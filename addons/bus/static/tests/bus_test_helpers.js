import { after, expect, registerDebugInfo } from "@harpiya/hoot";
import { Deferred } from "@harpiya/hoot-mock";
import {
    MockServer,
    asyncStep,
    defineModels,
...
import { on, runAllTimers, waitUntil } from "@harpiya/hoot-dom";
...
/** @type {Record<string, (env: HarpiyaEnv, id: string, payload: any) => any>} */
const busMessageHandlers = {};
/** @type {Map<HarpiyaEnv, { id: number, type: string, payload: NotificationPayload }[]>} */
 ...
 *
 * @param {string} type
 * @param {(env: HarpiyaEnv, id: string, payload: any) => any} handler
 */
