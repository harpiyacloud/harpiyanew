...
import harpiya
from harpiya import api, modules
from .models.bus import dispatch
from harpiya.http import root, Request, Response, SessionExpiredException, get_default_session
from harpiya.modules.registry import Registry
from harpiya.service import model as service_model
from harpiya.service.server import CommonServer
from harpiya.service.security import check_session
...
class Websocket:
    ...
    def __init__(self, sock, session, cookies):
        ...
        self.__selector = (
            ...
            if harpiya.evented and hasattr(selectors, 'PollSelector')
...
class WebsocketConnectionHandler:
    ...
    def _handle_public_configuration(cls, request):
        if not os.getenv('HARPIYA_BUS_PUBLIC_SAMESITE_WS'):
            return
