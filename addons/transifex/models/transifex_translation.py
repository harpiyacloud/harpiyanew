...
class TransifexTranslation(models.AbstractModel):
    ...
    def _get_transifex_projects(self):
        ...
        first section is [main], after '[harpiya-16.sale]'
        ...
        projects = {}
        for addon_path in harpiya.addons.__path__:
            for tx_path in (
                ...
                if isfile(tx_path):
                    ...
                    for sec in tx_config_file.sections()[1:]:
                        if len(sec.split(":")) != 6:
                            # old format ['main', 'harpiya-16.base', ...]
                            tx_project, tx_mod = sec.split(".")
                        else:
                            # tx_config_file.sections(): ['main', 'o:harpiya:p:harpiya-16:r:base', ...]
    ...
    def _update_transifex_url(self, translations):
        ...
        # e.g. 'https://www.transifex.com/harpiya/'
        ...
        for translation in translations:
            ...
            # e.g. https://www.transifex.com/harpiya/harpiya-16/translate/#fr_FR/sale/42?q=text:'Sale+Order'
