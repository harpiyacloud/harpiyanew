...
from harpiya.addons.website_google_map.controllers.main import GoogleMap
from harpiya.addons.website_partner.controllers.main import WebsitePartnerPage
