...
from harpiya.tests.common import tagged, new_test_user, TransactionCase
from harpiya.tools import mute_logger

from harpiya.addons.base.tests.common import HttpCase
...
from harpiya.addons.website_crm_partner_assign.controllers.main import (
    WebsiteAccount,
...
class TestPartnerAssign(TransactionCase):
    ...
    def setUp(self):
        ...
        patcher = patch('harpiya.addons.base_geolocalize.models.base_geocoder.BaseGeocoder.geo_find', wraps=geo_find)
...
class TestPartnerLeadPortal(TestCrmCommon):
    ...
    @patch('harpiya.http.GeoIP')
    def test_03_crm_partner_assign_geolocalization(self, GeoIpMock):
        """
            This test checks situation when "{HarpiyaURL}/partners" is visited from foreign country without resellers.
        ...
        """
        # Patch GeoIp so it acts, as if Harpiya client is located in Mexico
