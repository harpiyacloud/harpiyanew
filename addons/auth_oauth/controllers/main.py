...
from harpiya import api, http, SUPERUSER_ID, _
...
from harpiya.addons.auth_signup.controllers.main import AuthSignupHome as Home
from harpiya.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
    ...
    def signin(self, **kw):
        ...
        try:
            ...
            if redirect:
                ...
                url = '/harpiya/action-%s' % action
            elif menu:
                url = '/harpiya?menu_id=%s' % menu
