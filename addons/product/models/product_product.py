...
from harpiya.tools import float_compare, groupby
from harpiya.tools.image import is_image_size_above
from harpiya.tools.misc import unique
...
class ProductProduct(models.Model):
    ...
    def copy(self, default=None):
        ...
        returned.
        """
        # copy variant is disabled in https://github.com/harpiya/harpiya/pull/38303
