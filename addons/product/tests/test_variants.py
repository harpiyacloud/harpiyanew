...
from harpiya.tests import tagged, TransactionCase, Form
from harpiya.tools import mute_logger

from harpiya.addons.product.tests.common import ProductVariantsCommon, ProductAttributesCommon
...
class TestVariantsExclusion(ProductAttributesCommon):
    ...
    def test_dynamic_variants_unarchive(self):
        ...
        with patch(
            'harpiya.addons.product.models.product_product.ProductProduct._filter_to_unlink',
