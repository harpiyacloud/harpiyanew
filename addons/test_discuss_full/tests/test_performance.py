...
from harpiya.tests.common import users, tagged, HttpCase, warmup
...
class TestDiscussFullPerformance(HttpCase, MailCommon):
    ...
    def setUp(self):
        ...
        with patch(
            "harpiya.http.GeoIP.country_code",
    ...
    def _get_init_store_data_result(self):
        ...
        return {
            ...
            "Store": {
                ...
                "harpiyabot": {"id": self.user_root.partner_id.id, "type": "partner"},
