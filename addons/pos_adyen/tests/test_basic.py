...
class TestAdyenPoS(TestPointOfSaleHttpCommon):
    def test_adyen_basic_order(self):
        ...
        with patch('harpiya.addons.pos_adyen.models.pos_payment_method.requests.post', post), \
             patch('harpiya.addons.pos_adyen.controllers.main.consteq', lambda a,b: True):
