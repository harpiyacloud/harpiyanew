...
export class PaymentAdyen extends PaymentInterface {
    ...
    _handleHarpiyaConnectionFailure(data = {}) {
        // handle timeout
        ...
        this._show_error(
            _t(
                "Could not connect to the Harpiya server, please check your internet connection and try again."
            )
        );
    ...
    _callAdyen(data, operation = false) {
        return this.pos.data
            ...
            .catch(this._handleHarpiyaConnectionFailure.bind(this));
    }
    ...
    async handleAdyenStatusResponse() {
        ...
        if (!notification) {
            this._handleHarpiyaConnectionFailure();
            return;
        }
