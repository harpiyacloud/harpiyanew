...
from harpiya.addons.website_hr_recruitment.controllers.main import WebsiteHrRecruitment
...
class TestWebsiteHrRecruitmentForm(harpiya.tests.HttpCase):
    def test_tour(self):
        ...
        with harpiya.tests.RecordCapturer(self.env['hr.applicant'], []) as capt:
