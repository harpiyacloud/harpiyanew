...
from harpiya.addons.payment.controllers.portal import PaymentPortal
...
class TestFlows(PaymentHttpCommon):
    ...
    def test_transaction_wrong_flow(self):
        ...
        with mute_logger("harpiya.http"), self.assertRaises(
            JsonRpcException,
            msg='harpiya.exceptions.UserError: The payment should either be direct, with redirection, or made by a token.',
        ):
    ...
    def test_transaction_wrong_token(self):
        ...
        with mute_logger('harpiya.http'), self.assertRaises(JsonRpcException, msg='harpiya.exceptions.ValidationError: The access token is invalid.'):
    ...
    @mute_logger('harpiya.addons.payment.models.payment_transaction')
