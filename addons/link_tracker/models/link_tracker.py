...
from harpiya import tools, models, fields, api, _
...
from harpiya.tools.mail import validate_url
...
class LinkTracker(models.Model):
    ...
    tracked by Harpiya. Clicks are counter on each link. A tracker is linked to
