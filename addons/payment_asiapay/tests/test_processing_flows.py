...
from harpiya.addons.payment_asiapay.controllers.main import AsiaPayController
from harpiya.addons.payment_asiapay.tests.common import AsiaPayCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(AsiaPayCommon, PaymentHttpCommon):

    @mute_logger('harpiya.addons.payment_asiapay.controllers.main')
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'harpiya.addons.payment_asiapay.controllers.main.AsiaPayController.'
