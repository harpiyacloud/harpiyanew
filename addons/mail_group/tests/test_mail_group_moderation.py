...
from harpiya.addons.mail_group.tests.data import GROUP_TEMPLATE
from harpiya.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('harpiya.models.unlink', 'harpiya.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('harpiya.addons.base.models.ir_rule', 'harpiya.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('harpiya.addons.mail.models.mail_thread', 'harpiya.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('harpiya.addons.mail.models.mail_thread', 'harpiya.addons.mail_group.models.mail_group_message', 'harpiya.models.unlink')
    @users('employee')
    ...
    @mute_logger('harpiya.addons.mail_group.models.mail_group')
    @users('employee')
