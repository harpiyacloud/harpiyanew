...
from harpiya.addons.payment_xendit.controllers.main import XenditController
from harpiya.addons.payment_xendit.tests.common import XenditCommon


@tagged('post_install', '-at_install')
class TestProcessingFlow(XenditCommon, PaymentHttpCommon):

    @mute_logger('harpiya.addons.payment_xendit.controllers.main')
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'harpiya.addons.payment_xendit.controllers.main.XenditController'
