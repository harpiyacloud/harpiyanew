...
from harpiya.addons.sale_management.tests.common import SaleManagementCommon
from harpiya.addons.sale_pdf_quote_builder.controllers.quotation_document import (
...
class TestPDFQuoteBuilder(SaleManagementCommon):
    ...
    def setUpClass(cls):
        ...
        cls.internal_user = cls._create_new_internal_user(login='internal.user@test.harpiya.com')
    ...
    def test_quotation_document_upload_no_template(self):
        ...
        if 'website' not in self.env:
            ...
            from harpiya.addons.website.tools import MockRequest  # noqa: PLC0415
    ...
    def _test_custom_content_kanban_like(self):
        ...
        self.start_tour(
            f'/harpiya/sales/{self.sale_order.id}',
