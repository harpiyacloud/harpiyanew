# Part of Harpiya. See LICENSE file for full copyright and licensing details.
{
    ...
    'website': 'https://www.harpiya.com/documentation/master/applications/finance/fiscal_localizations/luxembourg.html',
...
""",
    'author': 'Harpiya Software Technologies, LLC, ADN, ACSONE SA/NV',
    'depends': [
        'account',
        'base_iban',
        'base_vat',
