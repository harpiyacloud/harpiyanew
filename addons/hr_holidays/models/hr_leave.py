...
from harpiya import api, Command, fields, models
...
from harpiya.tools.date_intervals import float_to_time, HOURS_PER_DAY
        ...
        for holiday in holidays:
            if not self._context.get('leave_fast_create'):
                ...
                if holiday.validation_type == 'no_validation':
                    ...
                    holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype_xmlid="mail.mt_comment") # Message from HarpiyaBot (sudo)
