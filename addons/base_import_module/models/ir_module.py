...
from harpiya.exceptions import AccessDenied, AccessError, UserError
from harpiya.fields import Domain
from harpiya.http import request
from harpiya.modules.module import adapt_version, MANIFEST_NAMES
from harpiya.release import major_version
from harpiya.tools import convert_csv_import, convert_sql_import, convert_xml_import, exception_to_unicode
from harpiya.tools import file_open, file_open_temporary_directory, ormcache

_logger = logging.getLogger(__name__)

APPS_URL = "https://apps.harpiya.com"
...
class IrModuleModule(models.Model):
    ...
    def _import_module(self, module, path, force=False, with_demo=False):
        ...
        if unmet_dependencies:
            ...
            raise UserError(_("Studio customizations require the Harpiya Studio app."))
    ...
    def _get_missing_dependencies(self, zip_data):
        ...
        if unavailable_modules:
            ...
            description += _(
                ...
                "https://www.harpiya.com/pricing-plan for more information.\n"
                "If you need Website themes, it can be downloaded from https://github.com/harpiya/design-themes.\n"
            )
        else:
            description = _(
