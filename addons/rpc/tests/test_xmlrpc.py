...
from harpiya.addons.base.tests.common import SavepointCaseWithUserDemo
from harpiya.exceptions import AccessDenied, AccessError
from harpiya.http import _request_stack
from harpiya.service import common as auth
from harpiya.service import model
from harpiya.tests import common
from harpiya.tools import DotDict
...
class TestXMLRPC(common.HttpCase):
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   harpiya.api.model(lambda *_: collections.defaultdict(int)))
