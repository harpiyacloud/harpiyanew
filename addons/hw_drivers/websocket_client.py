...
from harpiya.addons.hw_drivers import main
...
def send_to_controller(device_type, params, server_url=None):
    """Confirm the operation's completion by sending a response back to the Harpiya server
...
class WebsocketClient(Thread):
    ...
    def __init__(self, channel, server_url=None):
        ...
        :param str server_url: URL of the Harpiya server (provided by decorator).
        """
    ...
    def run(self):
        self.ws = websocket.WebSocketApp(self.url,
            header={"User-Agent": "HarpiyaIoTBox/1.0"},
