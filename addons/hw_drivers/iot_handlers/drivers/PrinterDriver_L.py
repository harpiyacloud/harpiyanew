...
from harpiya.addons.hw_drivers.controllers.proxy import proxy_drivers
from harpiya.addons.hw_drivers.driver import Driver
from harpiya.addons.hw_drivers.event_manager import event_manager
from harpiya.addons.hw_drivers.iot_handlers.interfaces.PrinterInterface_L import PPDs, conn, cups_lock
from harpiya.addons.hw_drivers.main import iot_devices
from harpiya.addons.hw_drivers.tools import helpers, wifi
from harpiya.addons.hw_drivers.websocket_client import send_to_controller
...
class PrinterDriver(Driver):
    ...
    def send_status(self):
        """ Sends the current status of the printer to the connected Harpiya instance.
        """
        self.data = {
            'value': '',
            'state': self.state,
    ...
    def print_status_zpl(self):
        ...
        title = "IoT Box Connected" if helpers.get_harpiya_server_url() else "IoT Box Status"
    ...
    def _printer_status_content(self):
        ...
        title = b'IoT Box Connected' if helpers.get_harpiya_server_url() else b'IoT Box Status'
