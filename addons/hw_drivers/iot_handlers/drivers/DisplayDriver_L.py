...
from harpiya.addons.hw_drivers.browser import Browser, BrowserState
...
from harpiya.addons.hw_drivers.tools.helpers import Orientation
...
class DisplayController(http.Controller):
    ...
    def customer_facing_display(self, action, pos_id=None, access_token=None, data=None):
        ...
        if action in ['open', 'open_kiosk']:
            origin = helpers.get_harpiya_server_url()
