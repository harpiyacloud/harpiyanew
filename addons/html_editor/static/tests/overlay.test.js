...
import { click, hover, queryOne, waitFor, waitForNone } from "@harpiya/hoot-dom";
...
test("Toolbar should not overflow scroll container", async () => {
    ...
    const editable = queryOne(".harpiya-editor-editable");
...
test("Table column control should always be displayed on top of the table", async () => {
    ...
    const scrollableElement = queryOne(".o_content");
    const table = queryOne(".harpiya-editor-editable table");
    await hover(".harpiya-editor-editable td");
