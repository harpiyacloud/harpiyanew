...
import { click, manuallyDispatchProgrammaticEvent, press, waitFor } from "@harpiya/hoot-dom";
 ...
 * @param {string} html
 */
export function pasteHarpiyaEditorHtml(editor, html) {
    return pasteData(editor, html, "application/vnd.harpiya.harpiya-editor");
}
/**
 * @param {Node} node
 */
