...
export class CollaborationSelectionAvatarPlugin extends Plugin {
    ...
    static dependencies = ["history", "position", "localOverlay", "collaborationHarpiya"];
    resources = {
        /** Handlers */
    ...
    /**
     * @param {import("./collaboration_harpiya_plugin").CollaborationSelection} selection
     */
    ...
    drawPeerAvatar(selectionInfo) {
        ...
        const peerMetadata = this.dependencies.collaborationHarpiya.getPeerMetadata(peerId);
        if (!peerMetadata) {
            return;
        }
