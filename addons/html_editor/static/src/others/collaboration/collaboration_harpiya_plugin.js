...
/**
 * @typedef { Object } CollaborationHarpiyaShared
 * @property { CollaborationHarpiyaPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationHarpiyaPlugin extends Plugin {
    static id = "collaborationHarpiya";
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    ...
                    case "ptp_disconnect":
                        ...
                        // todo: to implement
                        // this.harpiyaEditor.multiselectionRemove(fromPeerId);
                        break;
