...
import { useState, useEffect, useRef } from "@harpiya/owl";
...
export class ChatGPTPromptDialog extends ChatGPTDialog {
    ...
    setup() {
        super.setup();
        this.assistantAvatarUrl = `${browser.location.origin}/web_editor/static/src/img/harpiyabot_transparent.png`;
        this.userAvatarUrl = `${
    ...
    /** @returns {string} */
    get authorName() {
        return this.message.author === "user" ? _t("You") : _t("HarpiyaBot");
    }
