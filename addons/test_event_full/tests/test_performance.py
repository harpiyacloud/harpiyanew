...
from harpiya.addons.test_event_full.tests.common import TestEventFullCommon
from harpiya.addons.website.tests.test_performance import UtilPerf
...
class TestOnlineEventPerformance(EventPerformanceCase, UtilPerf):
    ...
    #                 'harpiya.__DEBUG__.services["web_tour.tour"].run("wevent_performance_register")',
    #                 'harpiya.__DEBUG__.services["web_tour.tour"].tours.wevent_performance_register.ready',
    #                 login=None,
    #                 timeout=200,
    #             )
