...
from harpiya import _, release
from harpiya.tools import cleanup_xml_node
...
class L10nHuEdiConnection:
    def __init__(self, env):
        ...
        :param env: the Harpiya environment
        """
        self.env = env
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since Harpiya can't store timezone-aware datetimes
    ...
    def _get_header_values(self, credentials, invoice_hashs=None):
        ...
        request_id = 'HARPIYA' + secrets.token_hex(13)
        ...
        return {
            ...
            'softwareName': 'Harpiya Enterprise',
            'softwareOperation': 'ONLINE_SERVICE',
            'softwareMainVersion': harpiya_version,
            'softwareDevName': 'Harpiya Software Technologies, LLC',
            'softwareDevContact': 'andu@harpiya.com',
