...
from harpiya.addons.event.tests.common import EventCase
from harpiya.addons.mail.tests.common import MailCase
from harpiya.tests import tagged, users, warmup
from harpiya.tools import formataddr, mute_logger
...
class TestMailSchedule(EventMailCommon):
    ...
    @mute_logger('harpiya.addons.base.models.ir_model', 'harpiya.models')
    ...
    @mute_logger('harpiya.addons.event.models.event_mail')
    @users('user_eventmanager')
            ...
            [{
                ...
                'mail_mail_values': {
                    'body': f'<p>Communication for {self.test_event.name} scheduled on {before_scheduler.scheduled_date} failed. '
                            f'This may be linked to template <a href="{before_scheduler.get_base_url()}/harpiya/mail.template/{self.template_reminder.id}">'
    ...
    @mute_logger('harpiya.addons.event.models.event_mail', 'harpiya.addons.mail.models.mail_render_mixin')
    @users('user_eventmanager')
    def test_event_mail_schedule_fail_global_composer_message(self):
        ...
        self.assertMailNotifications(
            ...
            [{
                ...
                'mail_mail_values': {
                    'body': f'<p>Communication for {self.test_event.name} scheduled on {before_scheduler.scheduled_date} failed. '
                            f'This is due to an error in template <a href="{before_scheduler.get_base_url()}/harpiya/mail.template/{self.template_reminder.id}">'
    ...
    @mute_logger(
        'harpiya.addons.event.models.event_mail',
        'harpiya.addons.event.models.event_mail_registration',
        'harpiya.addons.event.models.event_registration',
    )
            ...
            [{
                ...
                'mail_mail_values': {
                    'body': f'<p>Communication for {self.test_event.name} scheduled on {test_dt} failed. '
                            f'This may be linked to template <a href="{onsub_scheduler.get_base_url()}/harpiya/mail.template/{onsub_scheduler.template_ref.id}">'
