...
from harpiya import _, api, Command, fields, models, tools
...
from harpiya.tools import format_date, format_datetime, format_time, frozendict
from harpiya.tools.mail import is_html_empty, html_to_inner_content
from harpiya.tools.misc import formatLang
...
class EventEvent(models.Model):
    ...
    def get_kiosk_url(self):
        return self.get_base_url() + "/harpiya/registration-desk"
