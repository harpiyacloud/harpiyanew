...
from harpiya.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from harpiya.addons.mail.tests.common import MailCase, mail_new_test_user
...
from harpiya import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('harpiya.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
