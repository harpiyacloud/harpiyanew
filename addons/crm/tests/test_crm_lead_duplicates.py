...
from harpiya.addons.crm.tests.common import TestCrmCommon
...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.emails_provider_generic = {
            ...
            ('fp@harpiya.com', 'fp@harpiya.com'),
            ('fp.alias@mail.harpiya.com', 'fp.alias@mail.harpiya.com'),
        }
        cls.emails_provider_company = {
            ('robert.poilvert@mycompany.com', 'mycompany.com'),
            ('fp@subdomain.harpiya.com', 'subdomain.harpiya.com'),
        }
        ...
        cls.lead_generic_email_dupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': '"Fabulous Fab" <fp@HARPIYA.COM>',
                'name': 'Dupe1 of fp@harpiya.com (same email)',
                'type': 'lead',
            },
            {
                'email_from': 'FP@harpiya.com',
                'name': 'Dupe2 of fp@harpiya.com (same email)',
                'type': 'lead',
            },
            # phone_sanitized based
            {
                'email_from': 'not.fp@not.harpiya.com',
                'name': 'Dupe3 of fp@harpiya.com (same phone sanitized)',
                'phone': '+1 202 555 0123',
                'type': 'lead',
            },
            {
                'email_from': 'not.fp@not.harpiya.com',
                'phone': '+1 202 555 0123',
                'name': 'Dupe4 of fp@harpiya.com (same phone sanitized)',
                'type': 'lead',
            },
            # same commercial entity
            {
                'name': 'Dupe5 of fp@harpiya.com (same commercial entity)',
                'partner_id': cls.test_partners[1].id,
            },
            {
                'name': 'Dupe6 of fp@harpiya.com (same commercial entity)',
    ...
    def test_assert_initial_values(self):
        ...
        self.assertEqual(lead_generic.email_domain_criterion, 'fp@harpiya.com')
        self.assertEqual(lead_generic.email_normalized, 'fp@harpiya.com')
