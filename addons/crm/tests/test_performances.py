...
from harpiya.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('harpiya.models.unlink', 'harpiya.addons.crm.models.crm_team', 'harpiya.addons.crm.models.crm_team_member')
