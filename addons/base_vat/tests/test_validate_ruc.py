...
from harpiya._monkeypatches.stdnum import new_get_soap_client
...
class TestStructure(TransactionCase):
    ...
    def test_parent_validation(self):
        ...
        with patch('harpiya.addons.base_vat.models.res_partner.check_vies', type(self)._vies_check_func):
