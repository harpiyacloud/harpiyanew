...
export class LinkPopoverWidget {
    static createFor(params) {
        ...
        params.wysiwyg?.harpiyaEditor.observerUnactive('LinkPopoverWidget');
        popoverWidget.start(); // This is not async
        params.wysiwyg?.harpiyaEditor.observerActive('LinkPopoverWidget');
    ...
    start() {
        ...
        const editable = this.wysiwyg.harpiyaEditor.editable;
        this.$target.popover({
            html: true,
            content: this.$el,
            placement: 'bottom',
        ...
        if (document !== this.wysiwyg.harpiyaEditor.document) {
            $(this.wysiwyg.harpiyaEditor.document).on('mouseup.link_popover', onClickDocument);
        }
    ...
    destroy() {
        ...
        $(this.wysiwyg.harpiyaEditor.document).off('.link_popover');
