...
export class LinkTools extends Link {
    ...
    applyLinkToDom() {
        ...
        this.props.wysiwyg.harpiyaEditor.historyStep();
    ...
    _onColorpaletteColorPicked(cssProperty, params) {
        ...
        this.props.wysiwyg.harpiyaEditor.execCommand('applyColor', '', 'color');
        this.props.wysiwyg.harpiyaEditor.execCommand('applyColor', '', 'backgroundColor');
    ...
    __onURLInput() {
        ...
        this.props.wysiwyg.harpiyaEditor.historyPauseSteps('_onURLInput');
        this._checkDocumentState();
        this._syncContent();
        this._adaptPreview();
        this.props.wysiwyg.harpiyaEditor.historyUnpauseSteps('_onURLInput');
    }
    /**
