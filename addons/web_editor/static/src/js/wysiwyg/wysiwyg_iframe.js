...
import { useEffect } from "@harpiya/owl";
...
patch(Wysiwyg.prototype, {
    ...
    _loadIframe() {
        var self = this;
        this.$editable = $('<div class="note-editable oe_structure harpiya-editor-editable"></div>');
        this.$el.removeClass('note-editable oe_structure harpiya-editor-editable');
        ...
        var def = new Promise(function (resolve) {
            window.top[self._onUpdateIframeId] = function (_avoidDoubleLoad) {
                ...
                const $iframeWrapper = $('<div class="iframe-editor-wrapper harpiya-editor">');
...
function getWysiwygIframeContent(params) {
    ...
    return `
        ...
        <script type="text/javascript">
            window.harpiya?.define('root.widget', ['@web/legacy/js/public/public_widget'], function (require) {
                'use strict';
    ...
    <body class="o_in_iframe">
        ...
        <script type="text/javascript">
            window.harpiya?.define('web_editor.wysiwyg.iniframe', [], function (require) {
                'use strict';
