import { HarpiyaEditor, parseHTML, setSelection, insertCharsAt } from '../../src/HarpiyaEditor.js';
import {
...
const testMultiEditor = async spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        HarpiyaEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new HarpiyaEditor(clientInfo.editable, Object.assign({
            toSanitize: false,
    ...
    HarpiyaEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
