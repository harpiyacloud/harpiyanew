import { HarpiyaEditor } from '../src/HarpiyaEditor.js';
...
export async function testEditor(Editor = HarpiyaEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteHarpiyaEditorHtml = async (editor, html) => pasteData(editor, html, 'text/harpiya-editor');
...
export class BasicEditor extends HarpiyaEditor {}
