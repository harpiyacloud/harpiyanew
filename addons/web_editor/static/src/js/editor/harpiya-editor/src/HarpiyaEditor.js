...
export class HarpiyaEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.options = defaultOptions(
            {
                ...
                // `convertNumericToUnit` as harpiya-editor utils to avoid this
        ...
        this.editable.classList.add("harpiya-editor-editable");
     ...
     * from outside the harpiyaEditor.
     */
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const harpiyaHtml = dataHtmlElement.innerHTML.replace(/\uFEFF/g, "");
        const harpiyaText = selection.toString().replace(/\uFEFF/g, "");
        clipboardEvent.clipboardData.setData('text/plain', harpiyaText);
        clipboardEvent.clipboardData.setData('text/html', harpiyaHtml);
        clipboardEvent.clipboardData.setData('text/harpiya-editor', harpiyaHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('harpiya-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const harpiyaEditorHtml = ev.clipboardData.getData('text/harpiya-editor');
        ...
        } else if (harpiyaEditorHtml) {
            const fragment = parseHTML(this.document, harpiyaEditorHtml);
