import { getAdjacentPreviousSiblings, isBlock, rgbToHex, commonParentGet } from '../editor/harpiya-editor/src/utils/utils';
...
export async function toInline($editable, options) {
    $editable.removeClass('harpiya-editor-editable');
    const editable = $editable.get(0);
    ...
    $editable.addClass('harpiya-editor-editable');
}
/**
...
function fontToImg($editable) {
    const editable = $editable.get(0);
    const { fonts } = harpiya.loader.modules.get("@web_editor/js/wysiwyg/fonts");
