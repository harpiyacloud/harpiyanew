...
""",
    ...
    'assets': {
        ...
        'web_editor.wysiwyg_iframe_editor_assets': [
            ...
            'web/static/lib/harpiya_ui_icons/*',
            ...
            'web/static/lib/owl/harpiya_module.js',
            ...
            # harpiya-editor
            'web_editor/static/src/js/editor/harpiya-editor/src/utils/utils.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/utils/constants.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/align.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/commands.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/deleteBackward.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/deleteForward.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/enter.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/shiftEnter.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/shiftTab.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/tab.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/toggleList.js',
            ...
            'web/static/lib/bootstrap/scss/_variables-dark.scss',
            'web/static/lib/bootstrap/scss/_maps.scss',
            'web_editor/static/src/js/editor/harpiya-editor/src/style.scss',
        ...
        'web_editor.assets_tests_styles': [
            ('include', 'web._assets_helpers'),
            'web_editor/static/src/js/editor/harpiya-editor/src/base_style.scss',
            'web_editor/static/src/js/editor/harpiya-editor/src/checklist.scss',
        ],
        'web_editor.assets_wysiwyg': [
            ...
            # harpiya-editor
            'web_editor/static/src/js/editor/harpiya-editor/src/HarpiyaEditor.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/utils/constants.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/utils/sanitize.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/utils/serialize.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/tablepicker/TablePicker.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/powerbox/patienceDiff.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/powerbox/Powerbox.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/align.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/commands.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/deleteBackward.js',
            'web_editor/static/src/js/editor/harpiya-editor/src/commands/deleteForward.js',
        ...
        "web.assets_web_dark": [
            'web_editor/static/src/scss/harpiya-editor/powerbox.dark.scss',
            'web_editor/static/src/scss/harpiya-editor/tablepicker.dark.scss',
            'web_editor/static/src/scss/harpiya-editor/tableui.dark.scss',
        ...
        'web.qunit_suite_tests': [
            ...
            'web_editor/static/src/js/editor/harpiya-editor/test/utils.js'
        ],
        'web_editor.mocha_tests': [
            ...
            'web_editor/static/src/js/editor/harpiya-editor/src/**/*js',
            'web_editor/static/src/js/editor/harpiya-editor/test/spec/*js',
            'web_editor/static/src/js/editor/harpiya-editor/test/*js',
