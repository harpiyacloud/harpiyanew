...
from harpiya import _, api, exceptions, fields, models
from harpiya.exceptions import LockError, MissingError
from harpiya.fields import Domain
from harpiya.http import request
from harpiya.tools import safe_eval
...
def _get_domain_fields(env, model, domain):
    ...
    # see: https://github.com/harpiya/harpiya/pull/189772#issuecomment-2548804283
