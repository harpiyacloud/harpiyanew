...
from harpiya.addons.google_address_autocomplete.controllers.google_address_autocomplete import (
    AutoCompleteController,
)
from .mock_google_places import make_mock_google_route

from harpiya.tests import patch, HttpCase, tagged

CONTROLLER_PATH = "harpiya.addons.google_address_autocomplete.controllers.google_address_autocomplete.AutoCompleteController"
...
class TestUI(HttpCase):
    def test_address_autocomplete(self):
        with patch.object(
            ...
            self.start_tour(
                "/harpiya/companies", "autocomplete_address_tour", login="admin"
            )
    ...
    def test_no_access(self):
        ...
        self.assertEqual(res.json()["error"]["data"]["name"], "harpiya.exceptions.AccessError")
