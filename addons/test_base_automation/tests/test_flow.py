...
from harpiya.tests import Form, common, tagged
...
if not env.context.get('old_values', None):  # on create
    ...
    def test_013_recompute(self):
        ...
        patcher = patch('harpiya.addons.mail.models.mail_template.MailTemplate.send_mail', _patched_send_mail)
...
if env.context.get('old_values', None):  # on write
    ...
    def test_021_recursive(self):
        ...
        patcher = patch('harpiya.addons.base_automation.models.base_automation.BaseAutomation._process', _patch)
        self.startPatcher(patcher)
...
action = {
    ...
    def test_004_check_method_trigger_field(self):
        ...
        with self.assertLogs('harpiya.addons.base_automation', 'WARNING') as capture, self.enter_registry_test_mode():
...
class TestHttp(common.HttpCase):
    def test_webhook_trigger(self):
        ...
        with mute_logger("harpiya.addons.base_automation.models.base_automation"):
