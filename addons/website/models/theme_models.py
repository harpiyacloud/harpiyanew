...
import logging
from harpiya import api, fields, models, modules
from harpiya.tools.translate import xml_translate
from harpiya.modules.module import get_resource_from_path

from harpiya.addons.base.models.ir_asset import AFTER_DIRECTIVE, APPEND_DIRECTIVE, BEFORE_DIRECTIVE, DEFAULT_SEQUENCE, INCLUDE_DIRECTIVE, PREPEND_DIRECTIVE, REMOVE_DIRECTIVE, REPLACE_DIRECTIVE
