...
from harpiya import api, fields, models, tools, release
from harpiya.addons.website.models.ir_http import sitemap_qs2dom
from harpiya.addons.website.tools import similarity_score, text_from_html, get_base_domain
from harpiya.addons.portal.controllers.portal import pager
from harpiya.addons.iap.tools import iap_tools
from harpiya.exceptions import AccessError, UserError, ValidationError
from harpiya.http import request
from harpiya.modules.module import get_manifest
from harpiya.osv.expression import AND, OR, FALSE_DOMAIN
from harpiya.tools import SQL, Query, sql as sqltools
from harpiya.tools.translate import _, xml_translate
...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.harpiya.com'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.harpiya.com'
...
class Website(models.Model):
        ...
        for model_name, field_name in html_fields:
            ...
            if dependency_records:
                ...
                dependencies[model_name] += [{
                    ...
                    'link': 'website_url' in rec and rec.website_url or f'/harpiya/{model_name}/{rec.id}',
    ...
    def get_website_page_ids(self):
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the Harpiya framework works.
    ...
    def get_client_action_url(self, url, mode_edit=False):
        ...
        return "/harpiya/action-website.website_preview?" + urls.url_encode(action_params)
