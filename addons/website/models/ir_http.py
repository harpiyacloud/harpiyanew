...
from harpiya import SUPERUSER_ID
...
from harpiya.osv.expression import FALSE_DOMAIN
from harpiya.addons.base.models.ir_http import EXTENSION_TO_WEB_MIMETYPES
from harpiya.addons.http_routing.models import ir_http
...
class IrHttp(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(harpiya.tools.config['server_wide_modules'])
