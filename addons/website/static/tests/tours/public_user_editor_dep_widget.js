...
harpiya.loader.bus.addEventListener("module-started", (e) => {
    if (e.detail.moduleName === "@web_editor/js/frontend/loadWysiwygFromTextarea") {
        const publicWidget = harpiya.loader.modules.get("@web/legacy/js/public/public_widget")[Symbol.for('default')];
