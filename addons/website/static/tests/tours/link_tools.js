...
import { boundariesIn, setSelection, nodeSize } from '@web_editor/js/editor/harpiya-editor/src/utils/utils';
...
registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL harpiya.com",
        trigger: '#toolbar:not(.oe-floating) #o_link_dialog_url_input',
        run: 'edit harpiya.com',
    },
    clickOnImgStep,
    {
        content: "Select the newly created link",
        trigger: ':iframe #wrap .s_text_image a[href="http://harpiya.com"]:contains("harpiya.com")',
        run() {
    ...
    },
    {
        ...
        trigger: ':iframe .popover:contains("http://harpiya.com") a .fa-chain-broken',
        run: 'click',
    },
    {
        content: "Check that the link was removed",
        trigger: ':iframe #wrap .s_text_image p:contains("Go to harpiya:"):not(:has(a))',
    },
    // Recreate the link.
    {
    ...
    {
        content: "Click on the newly created link",
        trigger: ':iframe .s_text_image a[href="http://harpiya.com"]:contains("harpiya.com")',
        run: "click",
    },
    {
        content: "Change content (editing the label input) to harpiya website_2",
        trigger: '#o_link_dialog_label_input:value(harpiya.com)',
        run: 'edit harpiya website_2',
    },
    {
        content: "Change content (editing the DOM) to harpiya website",
        trigger: ':iframe .s_text_image a[href="http://harpiya.com"]:contains("harpiya website_2")',
        run: 'editor harpiya website',
    },
    clickOnImgStep,
    {
        content: "Click again on the link",
        trigger: ':iframe .s_text_image a[href="http://harpiya.com"]:contains("harpiya website")',
        run: "click",
    },
    {
        content: "Check that the label input contains the new content",
        trigger: '#o_link_dialog_label_input:value(harpiya website)',
    },
    {
    ...
    ...clickOnEditAndWaitEditMode(),
    {
        content: "The new link content should be harpiya website and url harpiya.be",
        trigger: ':iframe .s_text_image a[href="http://harpiya.be"]:contains("harpiya website")',
        run: "click",
    },
    {
        content: "The new link content should be harpiya website and url harpiya.be",
    ...
    ...clickOnSave(),
    {
        ...
        trigger: ':iframe .s_text_image a.btn.btn-secondary[href="http://harpiya.be"]:contains("harpiya website")',
    },
    // 4. Add link on image.
    ...clickOnEditAndWaitEditMode(),
    ...insertSnippet({
    ...
    },
    {
        ...
        // TODO: remove && click
        run: "edit harpiya.com && click(we-title:contains(Your URL))",
    },
    {
    ...
    },
    {
        ...
        trigger: ':iframe .popover div a:contains("http://harpiya.com")',
    },
    ...clickOnSave(),
    {
    ...
    clickOnElement("card's text", ":iframe header .s_mega_menu_cards span"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "edit https://www.harpiya.com",
    },
    {
        content: "Check nothing is lost",
        trigger: ":iframe header .s_mega_menu_cards a[href='https://www.harpiya.com']:has(img):has(h4):has(span)",
    },
    ...
    },
    {
        ...
        trigger: ':iframe #wrap .s_text_image p',
        run: "editor harpiya.com",
    },
    {
        content: "Select text",
        trigger: ':iframe #wrap .s_text_image p:contains(harpiya.com)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: ":iframe .s_text_image p a[href='http://harpiya.com']:contains('harpiya.com')",
    },
    {
        content: "Click on link to open the link tools",
        trigger: ":iframe .s_text_image p a[href='http://harpiya.com']",
        run: "click",
    },
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("https://harpiya.com")
            // To see what happens with edit, add `pause:true` to the previous step
            // and type yourself https://harpiya.com in #o_link_dialog_url_input
            // The label will be ohttps://
            this.anchor.value = "https://harpiya.com";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
        content: "Check that link was updated",
        trigger: ":iframe .s_text_image p a[href='https://harpiya.com']:contains('harpiya.com')",
    },
    {
    ...
    },
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("http://harpiya.com")
            this.anchor.value = "http://harpiya.com";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
    ...
    // TODO this step which was added by https://github.com/harpiya/harpiya/commit/9fc283b514d420fdfd66123845d9ec3563572692
