...
registerWebsitePreviewTour('snippet_social_media', {
    ...
    ...addNewSocialNetwork(10, 9, 'https://instagr.am/harpiya.official/'),
    {
        ...
        trigger: ":iframe .s_social_media" +
                 ...
                 ":has(a:eq(9)[href='https://instagr.am/harpiya.official/']:has(i.fa-instagram))",
    },
    ...
    },
    {
        ...
        run: "edit https://instagram.com/harpiya.official/ && click body",
    },
    ...preventRaceConditionStep,
    ...clickOnSave(),
    ...clickOnEditAndWaitEditMode(),
