...
import { UNMERGEABLE_SELECTORS } from "@web_editor/js/editor/harpiya-editor/src/utils/sanitize";
 ...
 */
HTMLElement.prototype.oDeleteBackwardHarpiyaEditor = HTMLElement.prototype.oDeleteBackward;
HTMLElement.prototype.oDeleteBackward = function (offset, alreadyMoved = false, offsetLimit) {
    ...
    this.oDeleteBackwardHarpiyaEditor(...arguments);
};
