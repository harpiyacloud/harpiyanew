...
/**
 * The goal of this patch is to correctly handle HarpiyaEditor's behaviour for text
 * highlight elements.
 */
patch(HarpiyaEditor.prototype, {
    /**
     * @override
     */
    _onClipboardCopy(e) {
        ...
        if (firstChild && firstChild.className && firstChild.className.includes("o_text_highlight_item")) {
            ...
            e.clipboardData.setData("text/harpiya-editor", html);
        }
    },
});
