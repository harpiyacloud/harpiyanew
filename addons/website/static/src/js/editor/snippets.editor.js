...
import * as HarpiyaEditorLib from "@web_editor/js/editor/harpiya-editor/src/utils/utils";
import { Component, onMounted, onWillStart, useEffect, useRef, useState } from "@harpiya/owl";
...
const getTraversedNodes = HarpiyaEditorLib.getTraversedNodes;
...
export class WebsiteSnippetsMenu extends weSnippetEditor.SnippetsMenu {
    ...
    _getDragAndDropOptions(options = {}) {
        // TODO: This is currently not in use by Harpiya's D&D
        // There is currently no way in Harpiya D&D to offset the edge scrolling.
     ...
     */
    _getSelection() {
        return this.options.wysiwyg.harpiyaEditor.document.getSelection();
    }
    /**
     * @override
     */
    _addToolbar() {
        ...
        this.options.wysiwyg.harpiyaEditor.computeFontSizeSelectorValues();
    }
    /**
    * @override
    */
    ...
    _handleTextOptions(classSelector, optionClassList, textOptionsPostActivate = () => {}) {
        ...
        if (selectedTextEl) {
            const restoreCursor = HarpiyaEditorLib.preserveCursor(this.$body[0].ownerDocument);
            ...
            this.options.wysiwyg.harpiyaEditor.historyResetLatestComputedSelection();
