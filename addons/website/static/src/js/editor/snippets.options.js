...
import { Component, markup, useEffect, useRef, useState } from "@harpiya/owl";
...
options.registry.OptionsTab = options.registry.WebsiteLevelColor.extend({
    ...
    async updateUI() {
        ...
        // If the gray palette has been generated by Harpiya standard option,
        ...
        // same hue by the Harpiya editor, there might be rounding errors
                ...
                this.trigger_up('menu_dialog', {
                    ...
                    save: (name, url) => {
                        ...
                        return this.orm.call(
                            ...
                            widget.wysiwyg.harpiyaEditor.observerUnactive();
                            widget.$target.attr('href', url);
                            $menu.text(name);
                            widget.wysiwyg.harpiyaEditor.observerActive();
                        });
                    },
                });
                widget.popover.hide();
...
options.registry.TextHighlight = options.Class.extend({
    ...
    */
    ...
    _autoAdaptHighlights() {
        this.trigger_up("snippet_edition_request", { exec: async () =>
            await this._refreshPublicWidgets($(this.options.wysiwyg.harpiyaEditor.editable))
        });
    },
