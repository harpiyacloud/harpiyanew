...
class TestWebsitePageManager(harpiya.tests.HttpCase):
    ...
    def test_01_page_manager(self):
        ...
        self.start_tour('/harpiya#action=website.action_website_pages_list', 'website_page_manager_direct_access', login='admin')
