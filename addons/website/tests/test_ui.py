...
from harpiya.addons.web_editor.controllers.main import Web_Editor
from harpiya.addons.website.tests.common import HttpCaseWithWebsiteUser
from harpiya.fields import Command


@harpiya.tests.tagged('-at_install', 'post_install')
class TestUiCustomizeTheme(harpiya.tests.HttpCase):
...
class TestUiHtmlEditor(HttpCaseWithUserDemo):
    ...
    def test_code_editor_usable(self):
        ...
        url = '/harpiya/action-website.website_preview'
        self.start_tour(url, 'website_code_editor_usable', login='admin')


@harpiya.tests.tagged('external', '-standard', '-at_install', 'post_install')
...
@harpiya.tests.tagged('-at_install', 'post_install')
class TestUiTranslate(harpiya.tests.HttpCase):
...
class TestUi(HttpCaseWithWebsiteUser):
    ...
    def test_01_admin_tour_homepage(self):
        self.start_tour("/harpiya", 'homepage', login='admin')
    ...
    def test_10_website_conditional_visibility(self):
        ...
        self.start_tour('/harpiya', 'conditional_visibility_2', login='website_user')
    ...
    def test_19_website_page_options(self):
        self.start_tour("/harpiya", "website_page_options", login="admin")
    ...
    def test_21_website_start_cloned_snippet(self):
        self.start_tour('/harpiya', 'website_start_cloned_snippet', login='admin')

    def test_22_website_gray_color_palette(self):
        self.start_tour('/harpiya', 'website_gray_color_palette', login='admin')
    ...
    def test_26_website_media_dialog_icons(self):
        self.env.ref('website.default_website').write({
            'social_twitter': 'https://twitter.com/Harpiya',
            'social_facebook': 'https://www.facebook.com/Harpiya',
            'social_linkedin': 'https://www.linkedin.com/company/harpiya',
            'social_youtube': 'https://www.youtube.com/user/OpenERPonline',
            'social_github': 'https://github.com/harpiya',
            'social_instagram': 'https://www.instagram.com/explore/tags/harpiya/',
            'social_tiktok': 'https://www.tiktok.com/@harpiya',
        })
        self.start_tour("/", 'website_media_dialog_icons', login='admin')

    def test_27_website_clicks(self):
        self.start_tour('/harpiya', 'website_click_tour', login='admin')
