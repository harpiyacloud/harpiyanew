...
from harpiya.service.model import retrying
...
class TestWebsiteResUsers(TransactionCase):
    ...
    def test_change_login(self):
        ...
        with self.assertRaises(psycopg2.errors.UniqueViolation), mute_logger('harpiya.sql_db'):
    ...
    def test_same_website_message(self):
        ...
        with self.enter_registry_test_mode():
            ...
            with TestCase.assertRaises(self, ValidationError), mute_logger('harpiya.sql_db'):
