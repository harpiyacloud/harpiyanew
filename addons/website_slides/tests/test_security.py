...
from harpiya.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('harpiya.models', 'harpiya.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('harpiya.models.unlink', 'harpiya.addons.base.models.ir_rule', 'harpiya.addons.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("harpiya.exceptions.ValidationError", res2.text)
