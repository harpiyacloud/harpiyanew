...
from harpiya.tools import is_html_empty
...
class SlideChannel(models.Model):
    ...
    def _default_cover_properties(self):
        ...
        channels headers across Harpiya versions (pre-customization, with purple gradient fitting the
        ...
        res.update({
            ...
            'background_color_style': (
                ...
                'background-image: linear-gradient(120deg, #003563, #78516F);'
            ),
            'opacity': '0',
    ...
    def create(self, vals_list):
        for vals in vals_list:
            # Ensure creator is member of its channel it is easier for them to manage it (unless it is harpiyabot)
