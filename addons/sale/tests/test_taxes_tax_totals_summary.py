from harpiya.addons.account.tests.test_taxes_tax_totals_summary import TestTaxesTaxTotalsSummary
from harpiya.addons.sale.tests.common import TestTaxCommonSale
