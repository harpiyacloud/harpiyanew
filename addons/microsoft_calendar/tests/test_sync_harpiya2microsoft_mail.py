...
from harpiya.addons.microsoft_calendar.tests.common import TestCommon


class TestSyncHarpiya2MicrosoftMail(TestCommon, MailCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.users = []
