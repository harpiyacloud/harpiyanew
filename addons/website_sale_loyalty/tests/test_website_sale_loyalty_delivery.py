...
from harpiya.addons.base.tests.common import DISABLED_MAIL_CONTEXT
from harpiya.addons.website_sale.tests.common import MockRequest, WebsiteSaleCommon
from harpiya.addons.website_sale_loyalty.controllers.delivery import WebsiteSaleLoyaltyDelivery
