...
class HarpiyaEdiProxyAuth(requests.auth.AuthBase):
    ...
    def __call__(self, request):
        ...
        request.headers.update({
            'harpiya-edi-client-id': self.id_client,
            'harpiya-edi-signature': h.hexdigest(),
            'harpiya-edi-timestamp': msg_timestamp,
        })
        return request
