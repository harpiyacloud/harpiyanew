...
import harpiya
from harpiya import api, models, exceptions, tools, http
from harpiya.addons.base.models import ir_http
from harpiya.addons.base.models.ir_http import RequestUID
from harpiya.addons.base.models.ir_qweb import keep_query, QWebException
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        if request.is_frontend_multilang:
            ...
            if request.httprequest.method in ('GET', 'HEAD'):
                ...
                except harpiya.exceptions.MissingError:
