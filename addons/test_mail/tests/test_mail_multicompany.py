...
from harpiya.addons.test_mail.models.test_mail_corner_case_models import MailTestMultiCompanyWithActivity
from harpiya.addons.test_mail.tests.common import TestRecipients
from harpiya.exceptions import AccessError
from harpiya.tests import tagged, users, HttpCase
            ...
            with self.subTest(login=login, mc_record=mc_record):
                ...
                if not login:
                    ...
                    if mc_error:
                        ...
                        self.assertEqual(parsed_url.path, '/harpiya/action-mail.action_discuss')
                    else:
