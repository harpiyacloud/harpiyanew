...
from harpiya import exceptions
from harpiya.addons.mail.models.mail_message import MailMessage
from harpiya.addons.mail.models.mail_thread import MailThread
from harpiya.addons.mail.tests.common import mail_new_test_user, MailCommon
from harpiya.addons.test_mail.data import test_mail_data
from harpiya.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE, THAI_EMAIL_WINDOWS_874
from harpiya.addons.test_mail.models.mail_test_ticket import MailTestTicket
from harpiya.addons.test_mail.models.test_mail_models import MailTestGateway, MailTestGatewayGroups
from harpiya.sql_db import Cursor
from harpiya.tests import Form, tagged, RecordCapturer
from harpiya.tools import mute_logger
from harpiya.tools.mail import email_split_and_format, formataddr
...
class TestEmailParsing(MailCommon):
    ...
    def test_message_parse_and_replace_binary_octetstream(self):
        ...
        with self.assertLogs('harpiya.addons.mail.models.mail_thread', level="WARNING") as capture:
        ...
        self.assertEqual(capture.output, [
            ("WARNING:harpiya.addons.mail.models.mail_thread:Message containing an unexpected "
    ...
    def test_message_parse_eml(self):
        ...
        mail = self.format(test_mail_data.MAIL_EML_ATTACHMENT, email_from='"Sylvie Lelitre" <test.sylvie.lelitre@agrolait.com>', to=f'generic@{self.alias_domain}',
                           msg_id='<cb7eaf62-58dc-2017-148c-305d0c78892f@harpiya.com>',
                           references='<f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@harpiya.com>',
    ...
    def test_message_parse_extract_bounce_rfc822_headers_qp(self):
        ...
        incoming_bounce = self.format(
            ...
            email_from='MAILER-DAEMON@mailserver.harpiya.com (Mail Delivery System)',
            email_to='bounce@xxx.harpiya.com',
            delivered_to='bounce@xxx.harpiya.com'
        )
...
class MailGatewayCommon(MailCommon):
    ...
    def _reinject(self, force_msg_id=False, debug_log=False):
        ...
        if mail["headers"].get("X-Harpiya-Message-Id"):
            extra += f'\nX-Harpiya-Message-Id: {mail["headers"]["X-Harpiya-Message-Id"]}'
...
class TestMailgateway(MailGatewayCommon):
    ...
    @mute_logger('harpiya.addons.mail.models.mail_thread', 'harpiya.models')
    ...
    @mute_logger('harpiya.addons.mail.models.mail_thread')
    ...
    def test_message_process_followers(self):
        """ Incoming email: recognized author not archived and not harpiyabot:
        ...
        harpiyabot.active = True
        harpiyabot.email = 'harpiyabot@example.com'
        with self.mock_mail_gateway():
            record4 = self.format_and_process(
                MAIL_TEMPLATE, harpiyabot.email_formatted, f'groups@{self.alias_domain}',
                subject='Harpiyabot Automatic Answer')

        self.assertEqual(record4.message_ids[0].author_id, harpiyabot)
        self.assertEqual(record4.message_ids[0].email_from, harpiyabot.email_formatted)
        self.assertEqual(record4.message_follower_ids.partner_id, self.env['res.partner'],
                         'message_process: harpiyabot -> no follower')
    ...
    @mute_logger('harpiya.addons.mail.models.mail_mail', 'harpiya.addons.mail.models.mail_thread', 'harpiya.models.unlink', 'harpiya.tests')
    ...
    @mute_logger('harpiya.addons.mail.models.mail_mail', 'harpiya.addons.mail.models.mail_thread', 'harpiya.models')
    def test_message_route_alias_owner_author_notify(self):
        ...
        self.assertFalse(self.user_root.active, 'notification logic relies on harpiyabot being archived')
        ...
        for email_to, test_user in itertools.product(email_tos, test_users):
            with self.subTest(test_user=test_user, email_to=email_to):
                ...
                self.assertEqual(new_messages.create_uid, self.user_root,
                                 'Harpiyabot should be creating the message')
    ...
    @mute_logger('harpiya.addons.mail.models.mail_thread', 'harpiya.models.unlink', 'harpiya.addons.mail.models.mail_mail')
    ...
    @mute_logger('harpiya.addons.mail.models.mail_thread', 'harpiya.addons.mail.models.mail_mail', 'harpiya.models.unlink')
    ...
    @mute_logger('harpiya.addons.mail.models.mail_thread', 'harpiya.addons.mail.models.mail_mail', 'harpiya.models', 'harpiya.sql_db')
    def test_message_process_alias_config_invalid_defaults(self):
        ...
        with self.mock_mail_gateway(), patch('harpiya.addons.mail.models.mail_alias.MailAlias._alias_bounce_incoming_email',
        ...
        with self.assertRaises(Exception), patch('harpiya.addons.mail.models.mail_alias.MailAlias._alias_bounce_incoming_email',
                                                 autospec=True) as _alias_bounce_incoming_email_mock:
    ...
    @mute_logger('harpiya.addons.mail.models.mail_thread', 'harpiya.models', 'harpiya.tests')
    ...
    @mute_logger('harpiya.addons.mail.models.mail_thread', 'harpiya.models.unlink')
    ...
    @mute_logger('harpiya.addons.mail.models.mail_thread', 'harpiya.models.unlink', 'harpiya.addons.mail.models.mail_mail', 'harpiya.tests')
    def test_message_process_external_notification_reply(self):
        ...
        self.assertFalse(new_msg.is_internal, "Responses to messages sent by harpiyabot should always be public.")
        ...
        new_msg = self.test_record.message_ids[0]
        self.assertTrue(new_msg.is_internal, "Responses to messages sent by anyone but harpiyabot should keep"
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by harpiya should update thread accordingly """
    ...
    def test_message_process_references_external_buggy_message_id(self):
        ...
        harpiya should update thread accordingly. Special case when the
    ...
    def test_message_process_extra_model_res_id(self):
        ...
        # Harpiya 10 update: compat mode has been removed and should not work anymore
    ...
    def test_message_hebrew_iso8859_8_i(self):
        ...
        # python, check that Harpiya is still capable of decoding it.
...
class TestMailGatewayLoops(MailGatewayCommon):
    ...
    @mute_logger('harpiya.addons.mail.models.mail_mail', 'harpiya.addons.mail.models.mail_thread')
    ...
    def test_routing_loop_auto_notif(self):
        """ Test Harpiya servers talking to each other """
        with self.mock_mail_gateway():
            record = self.format_and_process(
                MAIL_TEMPLATE,
                self.other_partner.email_formatted,
    ...
    def test_routing_loop_follower_alias(self):
        ...
        # simulate this email coming back to the same Harpiya server -> msg_id is
...
class TestMailGatewayReplies(MailGatewayCommon):
    ...
    def test_routing_reply_incoming_email(self):
        ...
        self.assertMailNotifications(
            reply,
            [{
                'content': 'Harpiya Reply',
                'email_values': {
                    'message_id': reply.message_id,
                    'references': f'{email.message_id} {reply.message_id}',  # should contain reference to HarpiyaExternal message
                },
                'mail_mail_values': {
    ...
    def test_routing_reply_internal_messages(self):
        """ Test routing notably between two Harpiyas when internal messages
        ...
        Action                  Harpiya1                   Harpiya2
        RFQ-like                                        creation log
                                                        initial_msg
        Harpiya2 replies           creation log
                                reply                   reply
        -some internal work-                            user_notification
        Harpiya1 replies           reply_2                 reply_2 (incoming email)
        -some internal work-                            log
        Harpiya2 replies           reply_3                 reply_3 (outgoing email)

        Purpose: have references from Harpiya2 containing message IDs to try to
        ...
        gateway_record.message_post(
            author_id=self.env.ref('base.partner_root').id,
            body='HarpiyaExternal Inquiry',
            email_from=self.partner_1.email_normalized,
            message_type='comment',
            subtype_id=self.env.ref('mail.mt_comment').id,
        )
        self.assertEqual(gateway_record.message_partner_ids, self.partner_admin)
        log, harpiyaext_msg = gateway_record.message_ids[1], gateway_record.message_ids[0]
        self.assertEqual(harpiyaext_msg.parent_id, log, 'Log serves as thread ancestor')
        ...
        self.assertMailNotifications(
            ...
            [{
                ...
                'email_values': {
                    'message_id': reply.message_id,
                    'references': f'{harpiyaext_msg.message_id} {reply.message_id}',  # should contain reference to HarpiyaExternal message
                },
                'mail_mail_values': {
        ...
        # coming from Harpiya1: their reply as an incoming email
        with self.mock_mail_gateway():
            self.format_and_process(
                MAIL_TEMPLATE, self.email_from, reply.reply_to,
                subject='Gateway Creation',
                extra=f'References: {reply.message_id} <msg1@harpiya1>',
                debug_log=True,
            )
        ...
        self.assertMailNotifications(
            ...
            [{
                ...
                'email_values': {
                    ...
                    'references': f'{harpiyaext_msg.message_id} {reply.message_id} {reply_2.message_id}',  # should contain reference to HarpiyaExternal message
                },
                'mail_mail_values': {
        ...
        self.assertMailNotifications(
            reply_3,
            [{
                'content': 'Harpiya Reply 2',
                'email_values': {
                    'message_id': reply_3.message_id,
                    'references': f'{harpiyaext_msg.message_id} {reply.message_id} {reply_2.message_id} {reply_3.message_id}',  # should contain reference to HarpiyaExternal message
                },
                'mail_mail_values': {
                    'notified_partner_ids': self.partner_1 + self.partner_admin,
                    'parent_id': log,  # log serves as thread ancestor
