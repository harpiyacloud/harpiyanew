...
from harpiya import fields, exceptions, tests
from harpiya.addons.mail.tests.common import mail_new_test_user, MailCommon
from harpiya.addons.test_mail.models.test_mail_models import MailTestActivity
from harpiya.tests import Form, HttpCase, users
...
class TestActivityMixin(TestActivityCommon):
    ...
    def test_mail_activity_state(self):
        ...
        with patch('harpiya.addons.mail.models.mail_activity.datetime', MockedDatetime):
    ...
    def test_mail_activity_mixin_search_state_basic(self):
        ...
        with patch('harpiya.addons.mail.models.mail_activity.datetime', MockedDatetime), \
            patch('harpiya.addons.mail.models.mail_activity_mixin.datetime', MockedDatetime):
