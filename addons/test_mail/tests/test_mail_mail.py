...
from harpiya import api, Command, fields, SUPERUSER_ID
from harpiya.addons.base.models.ir_mail_server import MailDeliveryException
from harpiya.addons.mail.tests.common import MailCommon
from harpiya.exceptions import AccessError, LockError
from harpiya.tests import common, tagged, users
...
class TestMailMail(MailCommon):
    ...
    def test_mail_mail_send_exceptions_origin(self):
        ...
        for default_from in [False, '']:
            ...
            self._reset_data()
            with self.mock_mail_gateway(), mute_logger('harpiya.addons.mail.models.mail_mail'):
...
class TestMailMailServer(MailCommon):
    ...
    def test_mail_mail_values_headers(self):
        """ Test headers content, notably X-Harpiya-Message-Id added to keep context
        ...
        self.assertDictEqual(
            self._mails[0]['headers'],
            {
                ...
                'X-Harpiya-Message-Id': message_id,
            }
        )
    ...
    @mute_logger('harpiya.addons.mail.models.mail_mail')
    @patch('harpiya.addons.base.models.ir_attachment.IrAttachment.file_size', new_callable=PropertyMock)
...
class TestMailMailRace(MailCommon):
    ...
    def test_mail_bounce_during_send(self):
        ...
        def send_email(self, message, *args, **kwargs):
            with this.registry.cursor() as cr, mute_logger('harpiya.sql_db'):
                try:
