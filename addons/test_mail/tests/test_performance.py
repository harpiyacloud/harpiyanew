...
from harpiya.tools.misc import limited_field_access_token
...
from harpiya.tests import Form, users, warmup, tagged
...
class TestMessageToStorePerformance(BaseMailPerformance):
    ...
    def setUpClass(cls):
        ...
        cls.link_previews = cls.env["mail.link.preview"].create(
            [
                {"source_url": "https://www.harpiya.com"},
                            ...
                            "mail.message": self._filter_messages_fields(
                                {
                                    ...
                                    "email_from": '"HarpiyaBot" <harpiyabot@example.com>',
                                    "id": message.id,
