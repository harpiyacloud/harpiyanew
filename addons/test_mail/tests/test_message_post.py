...
from harpiya.addons.base.tests.test_ir_cron import CronMixinCase
from harpiya.addons.mail.tests.common import mail_new_test_user, MailCommon
from harpiya.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from harpiya.addons.test_mail.models.test_mail_models import MailTestSimple
from harpiya.addons.test_mail.tests.common import TestRecipients
from harpiya.service.model import call_kw
from harpiya.exceptions import AccessError
from harpiya.tests import tagged
from harpiya.tools import mute_logger, formataddr
from harpiya.tests.common import users
...
class TestMailNotifyAPI(TestMessagePostCommon):
    ...
    @mute_logger('harpiya.models.unlink')
    @users('employee')
...
class TestMessageNotify(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('harpiya.addons.mail.models.mail_mail', 'harpiya.models.unlink', 'harpiya.tests')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    @mute_logger('harpiya.addons.mail.models.mail_mail', 'harpiya.models.unlink')
    @users('employee')
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. harpiyabot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
                ...
                with self.assertSinglePostNotifications(
                        ...
                        message_info={
                            ...
                            'mail_mail_values': {
                                'headers': {
                                    'Return-Path': f'{expected_alias_domain.bounce_alias}@{expected_alias_domain.name}',
                                    'X-Harpiya-Objects': f'{record._name}-{record.id}',
                                },
                            },
                            'message_values': {
    ...
    @mute_logger('harpiya.addons.mail.models.mail_mail', 'harpiya.tests')
    ...
    @users('employee')
    @mute_logger('harpiya.addons.mail.models.mail_mail', 'harpiya.addons.mail.models.mail_message_schedule', 'harpiya.models.unlink')
    ...
    @mute_logger('harpiya.addons.mail.models.mail_mail', 'harpiya.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('harpiya.addons.base.models.ir_model', 'harpiya.addons.mail.models.mail_mail')
