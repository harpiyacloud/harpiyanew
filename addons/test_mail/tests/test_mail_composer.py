...
from harpiya.addons.mail.wizard.mail_compose_message import MailComposeMessage
...
from harpiya.fields import Datetime as FieldDatetime
from harpiya.exceptions import AccessError, UserError
from harpiya.tests import Form, tagged, users
from harpiya.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('harpiya.tests', 'harpiya.addons.mail.models.mail_mail', 'harpiya.models.unlink')
    ...
    @mute_logger('harpiya.tests', 'harpiya.addons.base.models.ir_rule', 'harpiya.addons.mail.models.mail_mail', 'harpiya.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('harpiya.models.unlink', 'harpiya.addons.mail.models.mail_mail', 'harpiya.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('harpiya.models.unlink', 'harpiya.addons.mail.models.mail_mail')
