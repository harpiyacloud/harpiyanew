...
class TestMailAlias(TestMailAliasCommon):
    ...
    def test_alias_name_unique_copy(self):
        ...
        with mute_logger('harpiya.sql_db'), self.assertRaises(psycopg2.errors.UniqueViolation):
...
class TestAliasCompany(TestMailAliasCommon):
    ...
    def test_alias_domain_setup(self):
        ...
        with self.assertRaises(psycopg2.errors.ForeignKeyViolation), mute_logger('harpiya.sql_db'):
