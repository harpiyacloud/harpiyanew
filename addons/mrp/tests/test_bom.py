...
from harpiya import exceptions, Command, fields
from harpiya.tests import Form
from harpiya.addons.mrp.tests.common import TestMrpCommon
from harpiya.tests.common import HttpCase, tagged, freeze_time
from harpiya.tools import float_compare, float_round, float_repr
...
class TestBoM(TestMrpCommon):
    ...
    def test_cycle_on_bom_sequencing(self):
        ...
        # (see harpiya/addons/web/controllers/main.py:1352)
...
class TestTourBoM(HttpCase):
    ...
    def test_mrp_bom_product_catalog(self):
        ...
        url = f'/harpiya/action-mrp.mrp_bom_form_action/{self.bom.id}'
    ...
    def test_manufacture_from_bom(self):
        ...
        """
        url = '/harpiya/action-mrp.mrp_bom_form_action'
