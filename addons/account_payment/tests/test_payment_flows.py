...
from harpiya.tests import tagged, JsonRpcException
from harpiya.tools import mute_logger

from harpiya.addons.account_payment.controllers.payment import PaymentPortal
...
class TestFlows(AccountPaymentCommon, PaymentHttpCommon):
    ...
    def test_invoice_overdue_payment_flow(self):
        ...
        self.authenticate('TestUser', 'Harpiya@123')
