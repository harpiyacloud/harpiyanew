...
import { advanceTime, queryOne } from "@harpiya/hoot-dom";
            ...
            <div class="container mt-3">
                <div class="alert alert-info alert-dismissible fade show d-print-none css_editable_mode_hidden">
                    <div class="text-center">
                        ...
                        <a class="alert-link" href="/harpiya/action-account.action_move_out_invoice_type/2"><i class="oi oi-arrow-right me-1"></i>Back to edit mode</a>
                    </div>
                            ...
                            <div class="d-flex col-lg-4 col-xxl-3 d-print-none">
                                <div class="o_portal_sidebar_content flex-grow-1 mb-4 mb-lg-0 pe-lg-4" id="sidebar_content">
                                    ...
                                    <div class="d-none d-lg-block mt-5 small text-center text-muted" data-oe-model="ir.ui.view" data-oe-id="549" data-oe-field="arch" data-oe-xpath="/t[1]/div[1]/div[1]/div[2]">
                                        Powered by <a target="_blank" href="http://www.harpiya.com?utm_source=db&amp;utm_medium=portal" title="harpiya"><img src="/web/static/img/logo.png" alt="Harpiya Logo" height="15" loading="lazy" style=""></a>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="alert alert-warning mt-2">
                                                            ...
                                                            <div class="mt-2">
                                                                ...
                                                                <a name="activate_stripe" href="/harpiya/action-payment.action_activate_stripe" role="button" class="btn btn-primary me-2 d-none" data-oe-model="ir.ui.view" data-oe-id="612" data-oe-field="arch" data-oe-xpath="/t[1]/div[1]/div[2]/a[1]"> ACTIVATE STRIPE </a>
                                                                <a role="button" type="action" class="btn-link alert-warning me-2" href="/harpiya/action-payment.action_payment_provider" data-oe-model="ir.ui.view" data-oe-id="612" data-oe-field="arch" data-oe-xpath="/t[1]/div[1]/div[2]/a[3]">
