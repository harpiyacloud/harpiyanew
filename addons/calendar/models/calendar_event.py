...
from harpiya.addons.base.models.res_partner import _tz_get
from harpiya.addons.calendar.models.calendar_attendee import CalendarAttendee
from harpiya.addons.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from harpiya.addons.calendar.models.utils import interval_from_events
from harpiya.tools.date_intervals import intervals_overlap
from harpiya.tools.translate import _
from harpiya.tools.misc import get_lang
from harpiya.tools import html2plaintext, html_sanitize, is_html_empty, single_email_re
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'Harpiya'
