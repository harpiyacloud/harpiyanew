...
from harpiya.tests.common import TransactionCase, new_test_user
...
class TestAccessRights(TransactionCase):
    ...
    @classmethod
    @mute_logger('harpiya.tests', 'harpiya.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_meeting_edit_access_notification_handle_in_harpiya(self):
        # set notifications to "handle in Harpiya" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in Harpiya" notification setting can
