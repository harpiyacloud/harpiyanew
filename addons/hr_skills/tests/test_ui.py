...
from harpiya.tests import tagged, Form, HttpCase
...
class SkillsTestUI(HttpCase):
    def test_ui(self):
        ...
        self.start_tour("/harpiya", 'hr_skills_tour', login='admin')

    def test_ui2(self):

        self.start_tour("/harpiya", 'hr_skills_type_tour', login='admin')
