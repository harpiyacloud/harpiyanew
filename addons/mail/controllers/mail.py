...
from harpiya.addons.mail.tools.discuss import add_guest_to_context
...
class MailController(http.Controller):
    ...
    def _redirect_to_messaging(cls):
        url = '/harpiya/action-mail.action_discuss'
    ...
    def _redirect_to_record(cls, model, res_id, access_token=None, **kwargs):
        ...
        url = f'/harpiya/{model_in_url}/{res_id}?{url_encode(url_params)}'
        return request.redirect(url)
    ...
    def _mail_thread_message_redirect(self, message):
        ...
        return request.redirect(f'/harpiya/{model_in_url}/{message.res_id}?highlight_message_id={message.id}')
