...
from harpiya.addons.bus.controllers.websocket import WebsocketController
from harpiya.http import request, route, SessionExpiredException
...
class WebsocketControllerPresence(WebsocketController):
    ...
    def update_bus_presence(self, inactivity_period):
        ...
        This is mainly used by Harpiya.sh."""
