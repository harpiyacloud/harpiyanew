...
from harpiya.addons.mail.controllers.mail import MailController
from harpiya.addons.mail.controllers.discuss.public_page import PublicPageController
...
class DiscussMailController(MailController):
    ...
    def _mail_thread_message_redirect(self, message):
        ...
        return request.redirect(f'/harpiya/action-mail.action_discuss?active_id={message.res_id}&highlight_message_id={message.id}')
