...
class ResUsers(models.Model):
    ...
    _notification_type = models.Constraint(
        ...
        'Only internal user can receive notifications in Harpiya',
    )
    ...
    def _init_store_data(self, store: Store):
        ...
        store.add_global_values(
            ...
            # sudo: res.partner - exposing HarpiyaBot data is considered acceptable
            harpiyabot=Store.One(self.env.ref("base.partner_root").sudo()),
        )
