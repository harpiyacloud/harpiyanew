...
from harpiya import api, fields, release, SUPERUSER_ID
from harpiya.exceptions import UserError
from harpiya.models import AbstractModel
...
class Publisher_WarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to Harpiya's publisher warranty server to check the
