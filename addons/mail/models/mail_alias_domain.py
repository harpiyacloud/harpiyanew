...
from harpiya.addons.mail.models.mail_alias import dot_atom_text
...
class MailAliasDomain(models.Model):
    ...
    name = fields.Char(
        'Name', required=True,
        help="Email domain e.g. 'example.com' in 'harpiya@example.com'")
    ...
    def _migrate_icp_to_domain(self):
        ...
        not be lost (harpiya.sh use case). """
