    ...
    def get_empty_list_help(self, help_message):
        ...
        return Markup(_('''
            <p class="o_view_nocontent_smiling_face">
                ...
                To protect you from spam and reply loops, Harpiya automatically blocks emails
                coming to your gateway past a threshold of <b>%(threshold)i</b> emails every <b>%(minutes)i</b>
                minutes. If there are some addresses from which you need to receive very frequent
                updates, you can however add them below and Harpiya will let them go through.
            </p>''')) % {
