...
from harpiya import _, api, fields, models, modules, SUPERUSER_ID, tools
...
class MailMail(models.Model):
    ...
    def _prepare_outgoing_list(self, mail_server=False, doc_to_followers=None):
        ...
        headers['X-Harpiya-Message-Id'] = self.message_id
        ...
        for mail_server_id, alias_domain_id, smtp_from, batch_ids in self._split_by_mail_configuration():
            ...
            try:
                ...
                if raise_exception:
                    ...
                    # exceptions, it is encapsulated into an Harpiya MailDeliveryException
