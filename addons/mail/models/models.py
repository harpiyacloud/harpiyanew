...
from harpiya import api, exceptions, models, tools, _
from harpiya.addons.mail.tools.alias_error import AliasError
from harpiya.tools import parse_contact_from_email
from harpiya.tools.mail import email_normalize, email_split_and_format
...
class Base(models.AbstractModel):
    ...
    def _message_get_suggested_recipients_batch(self, reply_discussion=False, reply_message=None,
        ...
        # ban emails: never propose harpiyabot nor aliases
    ...
    def _notify_by_email_get_headers(self, headers=None):
        ...
        if not self:
            return headers
        self.ensure_one()
        headers['X-Harpiya-Objects'] = f"{self._name}-{self.id}"
