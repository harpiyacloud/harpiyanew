...
import { animationFrame, leave, press, queryFirst } from "@harpiya/hoot-dom";
import { Deferred, mockDate, mockTouch, mockUserAgent, tick } from "@harpiya/hoot-mock";
import {
    asyncStep,
    Command,
    mockService,
...
test("Update the link previews when a message is edited", async () => {
    ...
    await click(".o-mail-Message [title='Expand']");
    await click(".o-mail-Message-moreMenu [title='Edit']");
    await insertText(".o-mail-Message .o-mail-Composer-input", "http://harpiya.com", {
        replace: true,
    });
    await click(".o-mail-Message a", { text: "save" });
    await contains(".o-mail-Message-body", { text: "http://harpiya.com" });
