...
import { after, before, beforeEach, expect, test } from "@harpiya/hoot";
import { press, queryOne } from "@harpiya/hoot-dom";
import { animationFrame, enableTransitions } from "@harpiya/hoot-mock";
import {
    contains,
    defineModels,
    fields,
...
test("HtmlMail save inline html", async function () {
    ...
    await press("enter");
    expect(".harpiya-editor-editable").toHaveInnerHTML("<h1> first </h1>");
