...
import { markup } from "@harpiya/owl";
...
test("Search highlight", async () => {
    const testCases = [
        {
            input: markup("test harpiya"),
            output: `test <span class="${HIGHLIGHT_CLASS}">harpiya</span>`,
            searchTerm: "harpiya",
        },
        {
            input: markup('<a href="https://www.harpiya.com">https://www.harpiya.com</a>'),
            output: `<a href="https://www.harpiya.com">https://www.<span class="${HIGHLIGHT_CLASS}">harpiya</span>.com</a>`,
            searchTerm: "harpiya",
        },
        {
            input: '<a href="https://www.harpiya.com">https://www.harpiya.com</a>',
            output: `&lt;a href="https://www.<span class="${HIGHLIGHT_CLASS}">harpiya</span>.com"&gt;https://www.<span class="${HIGHLIGHT_CLASS}">harpiya</span>.com&lt;/a&gt;`,
            searchTerm: "harpiya",
        },
        {
            input: markup('<a href="https://www.harpiya.com">Harpiya</a>'),
            output: `<a href="https://www.harpiya.com"><span class="${HIGHLIGHT_CLASS}">Harpiya</span></a>`,
            searchTerm: "harpiya",
        },
        {
            input: markup('<a href="https://www.harpiya.com">Harpiya</a> Harpiya is a free software'),
            output: `<a href="https://www.harpiya.com"><span class="${HIGHLIGHT_CLASS}">Harpiya</span></a> <span class="${HIGHLIGHT_CLASS}">Harpiya</span> is a free software`,
            searchTerm: "harpiya",
        },
        {
            input: markup("harpiya is a free software"),
            output: `<span class="${HIGHLIGHT_CLASS}">harpiya</span> is a free software`,
            searchTerm: "harpiya",
        },
        {
            input: markup("software HARPIYA is a free"),
            output: `software <span class="${HIGHLIGHT_CLASS}">HARPIYA</span> is a free`,
            searchTerm: "harpiya",
        },
        {
            input: markup(`<ul>
                <li>Harpiya</li>
                <li><a href="https://harpiya.com">Harpiya ERP</a> Best ERP</li>
            </ul>`),
            output: `<ul>
                <li><span class="${HIGHLIGHT_CLASS}">Harpiya</span></li>
                <li><a href="https://harpiya.com"><span class="${HIGHLIGHT_CLASS}">Harpiya</span> ERP</a> Best ERP</li>
            </ul>`,
            searchTerm: "harpiya",
        },
        {
            input: markup("test <strong>Harpiya</strong> test"),
            output: `<span class="${HIGHLIGHT_CLASS}">test</span> <strong><span class="${HIGHLIGHT_CLASS}">Harpiya</span></strong> <span class="${HIGHLIGHT_CLASS}">test</span>`,
            searchTerm: "harpiya test",
        },
        {
