/** @harpiya-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@harpiya/hoot";
import { queryAll, queryFirst } from "@harpiya/hoot-dom";
 ...
 *  element.
 * @property {HTMLElement|HarpiyaEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when HarpiyaEnv, special key `target`. See @start
