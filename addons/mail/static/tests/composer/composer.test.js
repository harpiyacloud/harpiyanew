...
import { Deferred, animationFrame, tick } from "@harpiya/hoot-mock";
import {
    Command,
    getService,
    onRpc,
...
import { press, queryFirst } from "@harpiya/hoot-dom";
...
test("Show recipient list when there is more than 5 followers.", async () => {
    ...
    const partnerIds = pyEnv["res.partner"].create([
        { name: "test name 1", email: "test1@harpiya.com" },
        { name: "test name 2", email: "test2@harpiya.com" },
        { name: "test name 3", email: "test3@harpiya.com" },
        { name: "test name 4", email: "test4@harpiya.com" },
        { name: "test name 5", email: "test5@harpiya.com" },
        { name: "test name 6", email: "test6@harpiya.com" },
    ]);
    ...
    await contains("li", { text: "test name 1 <test1@harpiya.com>" });
    await contains("li", { text: "test name 2 <test2@harpiya.com>" });
    await contains("li", { text: "test name 3 <test3@harpiya.com>" });
    await contains("li", { text: "test name 4 <test4@harpiya.com>" });
    await contains("li", { text: "test name 5 <test5@harpiya.com>" });
    await contains("li", { text: "test name 6 <test6@harpiya.com>" });
...
test("Show 'No recipient found.' with 0 followers.", async () => {
    const pyEnv = await startServer();
    const partnerId = pyEnv["res.partner"].create({ name: "test name 1", email: "test1@harpiya.com" });
    await start();
