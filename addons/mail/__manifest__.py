...
Communicate with your colleagues/customers/guest within Harpiya.
...
from Harpiya itself, and that too with great possibilities. For example,
...
these accounts will be automatically downloaded into your Harpiya system. All
POP3/IMAP-compatible servers are supported, included those that require an
encrypted SSL/TLS connection.
This can be used to easily create email-based workflows for many email-enabled Harpiya documents, such as:
----------------------------------------------------------------------------------------------------------
...
mailbox-to-Harpiya integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within Harpiya, and the
...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    'assets': {
        ...
        'mail.assets_harpiya_sfu': [
            'mail/static/lib/harpiya_sfu/harpiya_sfu.js',
        ],
        'mail.assets_lamejs': [
        ...
        'mail.assets_public': [
            ...
            'web/static/lib/harpiya_ui_icons/style.css',
