...
from harpiya.addons.bus.tests.common import WebsocketCase
from harpiya.addons.mail.tests.common import MailCommon
from harpiya.addons.bus.models.bus import channel_with_db, json_dump
...
class TestMailPresence(WebsocketCase, MailCommon):
    def _receive_presence(self, sender, recipient):
        ...
        self.subscribe(
            websocket,
            [f"harpiya-presence-{sender_bus_target._name}_{sender_bus_target.id}"],
