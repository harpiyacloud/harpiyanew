...
from harpiya.addons.mail.models.discuss.discuss_channel import channel_avatar, group_avatar
...
from harpiya.tests import HttpCase, tagged, users
from harpiya.tools import html_escape, mute_logger
