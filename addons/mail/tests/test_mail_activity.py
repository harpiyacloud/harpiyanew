...
from harpiya.addons.mail.models.mail_activity import MailActivity
from harpiya.addons.mail.tests.common import MailCommon
from harpiya.tests import Form, tagged, HttpCase
...
class TestMailActivityChatter(HttpCase):
    ...
    def test_mail_activity_schedule_from_chatter(self):
        ...
        self.start_tour(
            f"/harpiya/res.partner/{testuser.partner_id.id}",
