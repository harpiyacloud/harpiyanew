...
from harpiya.addons.mail.tools import link_preview
...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ("http://localhost:8069/", "http://localhost:8069/harpiya", 0),
                ("http://localhost:8069/", "http://localhost:8069/harpiya/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/web/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/", 1),
                ("http://localhost:8069/", "http://localhost:8069/harpiya-experience", 1),
                ("http://localhost:8069/", "http://localhost:8069/chat/5/bFtIfYHRco", 0),
                ("https://www.harpiya.com/", "https://www.harpiya.com/web", 0),
                ("https://www.harpiya.com/", "https://www.harpiya.com/harpiya", 0),
                ("https://www.harpiya.com/", "https://www.harpiya.com/harpiya/", 0),
                ("https://www.harpiya.com/", "https://www.harpiya.com/harpiya?debug=assets", 0),
                ("https://www.harpiya.com/", "https://www.harpiya.com/harpiya#anchor", 0),
                ("https://www.harpiya.com/", "https://www.harpiya.com/harpiya-experience", 1),
                ("https://www.harpiya.com/", "https://www.harpiya.com/harpiya/1519/tasks/4102866", 0),
                ("http://www.harpiya.com/", "https://www.harpiya.com/harpiya/1519/tasks/4102866", 1),
                ("https://www.harpiya.com/", "https://wwwaharpiya.com/harpiya/", 1),
                ("https://www.harpiya.com/", "https://www.harpiya.com/chat/", 0),
                ("https://www.harpiya.com/", "https://www.harpiya.com/chat/5/bFtIfYHRco", 0),
                ("http://www.harpiya.com/", "https://www.harpiya.com/chat/5/bFtIfYHRco", 1),
                ("https://clients.harpiya.com/", "https://www.harpiya.com/harpiya/1519/tasks/4102866", 1),
                ("https://clients.harpiya.com/", "https://www.harpiya.com/chat/5/bFtIfYHRco", 1),
            ]
    ...
    def test_remove_unused_link_preview(self):
        with (
            ...
            message = self.test_partner.message_post(
                body=Markup(
                    '<a href="https://www.harpiya.com/harpiya-experience">Nothing link</a> <a href="https://www.harpiya.com/harpiya-experience-2025">Other Nothing link</a>'
                ),
            ...
            self.test_partner._message_update_content(
                message, Markup('<a href="https://www.harpiya.com/harpiya-experience">Nothing link</a>')
            )
            self.env["mail.link.preview"]._create_from_message_and_notify(message)
            link_preview_count = self.env["mail.message.link.preview"].search_count(
                [("message_id", "=", message.id)]
