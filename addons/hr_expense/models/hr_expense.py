...
from harpiya import api, fields, Command, models, _
from harpiya.exceptions import RedirectWarning, UserError, ValidationError
from harpiya.tools import clean_context, email_normalize, float_repr, float_round, format_date, is_html_empty
...
class HrExpense(models.Model):
    ...
    def _compute_currency_rate(self):
        """
            We want the default harpiya rate when the following change:
