...
from harpiya.tools.pdf import HarpiyaPdfFileReader, HarpiyaPdfFileWriter
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if report.report_name == 'hr_expense.report_expense':
            for expense in self.env['hr.expense'].browse(res_ids):
                ...
                expense_report = HarpiyaPdfFileReader(stream, strict=False)
                output_pdf = HarpiyaPdfFileWriter()
                ...
                for attachment in attachments:
                    ...
                    attachment_reader = HarpiyaPdfFileReader(attachment_stream, strict=False)
