...
from harpiya import api, fields, models, _, Command, tools, SUPERUSER_ID
from harpiya.http import request
from harpiya.exceptions import AccessError, ValidationError, UserError
from harpiya.tools import SQL, convert
...
class PosConfig(models.Model):
    ...
    sequence_id = fields.Many2one('ir.sequence', string='Order IDs Sequence', readonly=True,
        help="This sequence is automatically created by Harpiya but you can change it "
