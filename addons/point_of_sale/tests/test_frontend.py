...
from harpiya.addons.account.tests.common import AccountTestInvoicingHttpCommon
from harpiya.addons.point_of_sale.tests.common_setup_methods import setup_product_combo_items
from harpiya.addons.point_of_sale.models.pos_config import PosConfig
