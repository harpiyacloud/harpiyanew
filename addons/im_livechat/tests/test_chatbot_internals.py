...
from harpiya.addons.im_livechat.tests import chatbot_common
from harpiya.tests.common import JsonRpcException, new_test_user, tagged
from harpiya.tools.misc import limited_field_access_token, mute_logger
from harpiya.addons.bus.models.bus import json_dump
...
class ChatbotCase(MailCommon, chatbot_common.ChatbotCase):
    ...
    def test_chatbot_steps(self):
        ...
        with self.assertRaises(JsonRpcException, msg='harpiya.exceptions.ValidationError'), mute_logger("harpiya.http"):
    ...
    def test_forward_to_specific_operator(self):
                            ...
                            "discuss.channel": [
                                {
                                    ...
                                    "name": "HarpiyaBot Ernest Employee",
                                },
                            ],
                            "res.partner": self._filter_partners_fields(
                                {
        ...
        self.assertEqual(discuss_channel.name, "HarpiyaBot Ernest Employee")
