...
from harpiya.addons.im_livechat.tests.common import TestImLivechatCommon
from harpiya.addons.mail.tests.common import MailCommon
from harpiya.tests import new_test_user, tagged
...
class TestGetDiscussChannel(TestImLivechatCommon, MailCommon):
    ...
    def test_channel_get_livechat_visitor_info(self):
        ...
        with patch('harpiya.http.GeoIP.country_code', new_callable=PropertyMock(return_value=belgium.code)):
