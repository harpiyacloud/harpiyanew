...
from harpiya.addons.bus.websocket import WebsocketConnectionHandler
...
class Im_LivechatChannel(models.Model):
    ...
    header_background_color = fields.Char(default="#003563", help="Default background color of the channel header once open")
    title_color = fields.Char(default="#FFFFFF", help="Default title color of the channel once open")
    button_background_color = fields.Char(default="#003563", help="Default background color of the Livechat button")
