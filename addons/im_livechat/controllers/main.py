...
from harpiya.tools import replace_exceptions
from harpiya.addons.mail.tools.discuss import add_guest_to_context, Store
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/harpiya_ui_icons', type='http', auth='none', cors="*")
    def harpiya_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/harpiya_ui_icons/fonts/harpiya_ui_icons.woff2').get_response()
