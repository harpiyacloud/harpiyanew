...
from harpiya import _, api, Command, fields, models, modules
from harpiya.addons.base.models.ir_qweb_fields import Markup, nl2br, nl2br_enclose
from harpiya.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
from harpiya.addons.l10n_it_edi.models.account_payment_method_line import L10N_IT_PAYMENT_METHOD_SELECTION
from harpiya.exceptions import UserError
from harpiya.tools import cleanup_xml_node, float_compare, float_is_zero, float_repr, html2plaintext
...
class AccountMove(models.Model):
    ...
    def _l10n_it_edi_import_invoice(self, invoice, data, is_new):
        """ Decodes a l10n_it_edi move into an Harpiya move.
