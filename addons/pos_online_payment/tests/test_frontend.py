...
from harpiya.addons.pos_online_payment.tests.online_payment_common import OnlinePaymentCommon
from harpiya.addons.account.models.account_payment_method import AccountPaymentMethod
from harpiya.osv.expression import AND
from harpiya.addons.point_of_sale.tests.common import archive_products
...
class TestUi(AccountTestInvoicingCommon, OnlinePaymentCommon):
    ...
    def test_invalid_access_token(self):
        ...
        with mute_logger('harpiya.http'): # Mutes "The provided order or access token is invalid." online payment portal error.
