...
@patch('harpiya.addons.certificate.models.certificate.CertificateCertificate._compute_is_valid', _compute_is_valid)
class TestEdiFacturaeXmls(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.certificate_module = "harpiya.addons.certificate.models.certificate"
        cls.move_module = "harpiya.addons.l10n_es_edi_facturae.models.account_move"
