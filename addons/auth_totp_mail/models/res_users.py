...
from harpiya.exceptions import AccessDenied, UserError
from harpiya.http import request
from harpiya.tools.misc import babel_locale_parse, hmac

from harpiya.addons.auth_totp.models.totp import hotp, TOTP
...
class ResUsers(models.Model):
    ...
    def get_totp_invite_url(self):
        return '/harpiya/action-auth_totp_mail.action_activate_two_factor_authentication'
