# Part of Harpiya. See LICENSE file for full copyright and licensing details.
{
    ...
    'website': 'https://www.harpiya.com/documentation/master/applications/finance/fiscal_localizations/india.html',
...
Harpiya allows to manage Indian Accounting by providing Two Formats Of Chart of Accounts i.e Indian Chart Of Accounts - Standard and Indian Chart Of Accounts - Schedule VI.

Note: The Schedule VI has been revised by MCA and is applicable for all Balance Sheet made after
31st March, 2011. The Format has done away with earlier two options of format of Balance
Sheet, now only Vertical format has been permitted Which is Supported By Harpiya.
  """,
