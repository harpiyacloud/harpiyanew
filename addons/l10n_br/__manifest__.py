# Part of Harpiya. See LICENSE file for full copyright and licensing details.
{
    ...
    'version': '1.0',
    'website': 'https://www.harpiya.com/documentation/master/applications/finance/fiscal_localizations/brazil.html',
...
configure Harpiya in order to properly use Avatax and send the needed fiscal
...
""",
    'author': 'Akretion, Harpiya Brasil',
    'depends': [
        'account',
        'account_qr_code_emv',
