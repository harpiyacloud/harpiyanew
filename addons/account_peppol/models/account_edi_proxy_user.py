...
from harpiya import _, api, fields, models, modules, tools
from harpiya.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
from harpiya.addons.account_peppol.exceptions import get_ebms_message, get_exception_message
from harpiya.addons.account_peppol.tools.demo_utils import handle_demo
...
class Account_Edi_Proxy_ClientUser(models.Model):
    ...
    def _get_proxy_urls(self):
        ...
        urls['peppol'] = {
            'prod': 'https://peppol.api.harpiya.com',
            'test': 'https://peppol.test.harpiya.com',
            'demo': 'demo',
        }
        return urls
    ...
    def _peppol_register_sender_as_receiver(self):
        ...
        # but we need the field for future in case the user decided to migrate away from Harpiya
