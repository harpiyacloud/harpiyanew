...
from harpiya.tests.common import tagged, TransactionCase, freeze_time
...
class TestPeppolParticipant(TransactionCase):
    ...
    def test_create_success_receiver_two_steps(self):
        ...
        with patch('harpiya.addons.account_peppol.models.res_company.ResCompany._get_company_info_on_peppol',
    ...
    def test_config_update_email(self):
        ...
        with patch('harpiya.addons.account_peppol.models.account_edi_proxy_user.Account_Edi_Proxy_ClientUser._call_peppol_proxy') as mocked_patch:
