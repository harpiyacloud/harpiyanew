...
from harpiya.tests.common import TransactionCase, tagged
from harpiya.addons.account.tests.common import AccountTestInvoicingCommon
from harpiya.tools import DEFAULT_SERVER_DATETIME_FORMAT
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        old_action_post = harpiya.addons.account.models.account_move.AccountMove.action_post
        old_create = harpiya.models.BaseModel.create
        ...
        post_patch = patch('harpiya.addons.account.models.account_move.AccountMove.action_post', new_action_post)
        create_patch = patch('harpiya.models.BaseModel.create', new_create)
    ...
    def test_realtime_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        def _today(*args, **kwargs):
            return date_po
        patchers = [
            patch('harpiya.fields.Date.context_today', _today),
        ]
    ...
    def test_average_realtime_with_delivery_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        patchers = [
            patch('harpiya.fields.Date.context_today', _today),
            patch('harpiya.fields.Datetime.now', _now),
        ]
    ...
    def test_incoming_with_negative_qty(self):
        ...
        # it is negative qty transfer so Harpiya will create delivery instead of receipt.
