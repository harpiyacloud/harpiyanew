...
from harpiya.tools import frozendict, float_compare, Query, SQL
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_move_line_residual_amounts(self, aml_values, counterpart_currency, shadowed_aml_values=None, other_aml_values=None):
        ...
        def get_harpiya_rate(aml, other_aml, currency):
        ...
        if currency == company_currency \
            ...
            rate = get_harpiya_rate(aml, other_aml, counterpart_currency)
