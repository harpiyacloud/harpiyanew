...
from harpiya import api, Command, fields, models, _
...
from harpiya.tools import groupby
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(
        ...
        required=True,
        selection=[
            ('harpiya', "Full Reference (INV/2024/00001)"),
            ('euro', "European (RF83INV202400001)"),
            ('number', "Numbers only (202400001)"),
        ],
        default=_default_invoice_reference_model,
        help="You can choose different models for each type of reference. The default one is the Harpiya reference.",
    )
    ...
    inbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Get paid by any method outside of Harpiya.\n"
    ...
    outbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Pay by any method outside of Harpiya.\n"
        "Check: Pay bills by check and print it from Harpiya.\n"
    ...
    alias_name = fields.Char(help="Send one separate email for each invoice.\n"
                                  ...
                                  "Only PDF and XML files will be interpreted by Harpiya")
