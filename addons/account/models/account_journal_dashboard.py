...
from harpiya import models, api, _, fields, Command, tools
from harpiya.exceptions import UserError
from harpiya.osv import expression
from harpiya.release import version
from harpiya.tools import DEFAULT_SERVER_DATE_FORMAT as DF, SQL
from harpiya.tools.misc import formatLang, format_date as harpiya_format_date, get_lang
...
class AccountJournal(models.Model):
    ...
    def _transform_activity_dict(self, activity_data):
        return {
            ...
            'date': harpiya_format_date(self.env, activity_data['date_deadline']),
        }
    ...
    def _get_bank_cash_graph_data(self):
        ...
        for journal in self:
            ...
            color = '#003563' if 'e' in version else '#7c7bad'
