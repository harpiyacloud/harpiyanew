...
featurePluginRegistry.add("harpiyaAccountingAggregates", AccountingPlugin);
...
cellMenuRegistry.add("move_lines_see_records", {
    ...
    async execute(env, newWindow) {
        ...
        if ( func.functionName === "HARPIYA.PARTNER.BALANCE" ) {
        ...
        if ( date_range?.value && !isEvaluationError(date_range.value) ) {
            ...
            if ( ["HARPIYA.PARTNER.BALANCE", "HARPIYA.RESIDUAL"].includes(func.functionName) ) {
