...
import { EvaluationError } from "@harpiya/o-spreadsheet";
...
functionRegistry.add("HARPIYA.DEBIT", {
...
functionRegistry.add("HARPIYA.BALANCE", {
...
functionRegistry.add("HARPIYA.FISCALYEAR.START", {
...
functionRegistry.add("HARPIYA.FISCALYEAR.END", {
...
functionRegistry.add("HARPIYA.ACCOUNT.GROUP", {
