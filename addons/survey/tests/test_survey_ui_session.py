...
from harpiya.tests.common import tagged, HttpCase
...
class TestUiSession(HttpCase):
    ...
    def test_admin_survey_session(self):
        ...
        with patch('harpiya.addons.survey.models.survey_survey.SurveySurvey.action_open_session_manager', action_open_session_manager_mock):
            self.start_tour('/harpiya', 'test_survey_session_start_tour', login='admin')
        ...
        with patch('harpiya.addons.survey.models.survey_survey.SurveySurvey.action_open_session_manager', action_open_session_manager_mock):
            self.start_tour('/harpiya', 'test_survey_session_manage_tour', login='admin')
