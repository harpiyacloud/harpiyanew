...
import { closestElement } from "@web_editor/js/editor/harpiya-editor/src/HarpiyaEditor";
...
export class MassMailingWysiwyg extends Wysiwyg {
    ...
    setSnippetsMenuFolded(fold = true) {
        ...
        this.harpiyaEditor.toolbar = this.toolbarEl;
        this.harpiyaEditor.autohideToolbar = !!fold;
    ...
    async getSnippetsMenuClass() {
        ...
        const { MassMailingSnippetsMenu } = await harpiya.loader.modules.get('@mass_mailing/js/snippets.editor');
