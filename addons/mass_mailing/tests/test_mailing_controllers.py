...
class TestMailingControllers(TestMailingControllersCommon):
    ...
    @mute_logger('harpiya.http', 'harpiya.addons.website.models.ir_ui_view')
...
class TestMailingTracking(TestMailingControllersCommon):
    ...
    @mute_logger('harpiya.addons.mail.models.mail_mail', 'harpiya.addons.mass_mailing.models.mailing')
