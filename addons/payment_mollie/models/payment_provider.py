...
from harpiya import _, fields, models, service
from harpiya.exceptions import ValidationError

from harpiya.addons.payment_mollie import const
...
class PaymentProvider(models.Model):
    ...
    def _mollie_make_request(self, endpoint, data=None, method='POST'):
        ...
        harpiya_version = service.common.exp_version()['server_version']
        ...
        headers = {
            ...
            "User-Agent": f'Harpiya/{harpiya_version} MollieNativeHarpiya/{module_version}',
        }
