...
from harpiya.addons.payment_mollie.controllers.main import MollieController
from harpiya.addons.payment_mollie.tests.common import MollieCommon
...
class MollieTest(MollieCommon, PaymentHttpCommon):
    ...
    @mute_logger(
        'harpiya.addons.payment_mollie.controllers.main',
        'harpiya.addons.payment_mollie.models.payment_transaction',
    )
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'harpiya.addons.payment_mollie.models.payment_provider.PaymentProvider'
