...
from harpiya.tests import Form, users, new_test_user
from harpiya.addons.hr.tests.common import TestHrCommon
...
class TestHrEmployee(TestHrCommon):
        ...
        user_1, user_2, user_3 = self.env['res.users'].create([
            {
                'name': 'Test User',
                'login': 'test_user',
                'email': 'test_user@harpiya.com',
            },
            {
                'name': 'Test User 2',
                'login': 'test_user_2',
                'email': 'test_user_2@harpiya.com',
                'create_employee': True,
            },
            {
                'name': 'Test User 3',
                'login': 'test_user_3',
                'email': 'test_user_3@harpiya.com',
    ...
    def test_set_user_on_new_employee(self):
        ...
        employee_form.user_id = self.res_users_hr_officer
        with mute_logger('harpiya.sql_db'), self.assertRaises(UniqueViolation), self.assertRaises(ValidationError):
            employee_form.save()
    ...
    def test_search_hr_employee_no_access(self):
        ...
        with self.assertNoLogs('harpiya.domains'):
            self.assertEqual(
                employee.ids,
