...
from harpiya import api, fields, models, _, tools
from harpiya.fields import Domain
from harpiya.exceptions import ValidationError, AccessError, RedirectWarning
from harpiya.osv import expression
from harpiya.tools import convert, format_date
...
class HrEmployee(models.Model):
    ...
    def create(self, vals_list):
        ...
        for employee in employees:
            ...
            url = '/harpiya/%s/action-hr.plan_wizard_action?active_model=hr.employee&menu_id=%s' % (employee.id, hr_root_menu.id)
