...
product_name = 'Harpiya'
description = 'Harpiya Server'
long_desc = '''Harpiya is a complete ERP and CRM. The main features are accounting (analytic
...
"""
url = 'https://www.harpiya.com'
author = 'OpenERP S.A.'
author_email = 'info@harpiya.com'
license = 'LGPL-3'

nt_service_name = "harpiya-server-" + series.replace('~','-')
