...
from harpiya.tests.common import TransactionCase, BaseCase
from harpiya.tools import mute_logger
from harpiya.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('harpiya.tools.safe_eval')
    def test_05_safe_eval_forbiddon(self):
        ...
        with self.assertRaises(ValueError):
            safe_eval("import harpiya", mode="exec")
