...
from harpiya.sql_db import db_connect, TestCursor
from harpiya.tests import common
from harpiya.tests.common import BaseCase, HttpCase
from harpiya.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('harpiya.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:harpiya.sql_db:Found different un-closed cursor', msg)
