...
from harpiya.tests import BaseCase, TransactionCase, tagged, BaseCase
from harpiya.tests.common import _logger as test_logger
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when HARPIYA_TEST_FAILURE_RETRIES is set"""
