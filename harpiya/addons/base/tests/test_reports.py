...
@harpiya.tests.tagged('post_install', '-at_install', 'post_install_l10n')
class TestReports(harpiya.tests.TransactionCase):
...
class TestReportsRenderingCommon(harpiya.tests.HttpCase):
    ...
    def save_pdf(self):
        ...
        harpiya.tests.save_test_file(self._testMethodName, self.last_pdf_content, 'pdf_', 'pdf', document_type='Report PDF', logger=_logger)
...
@harpiya.tests.tagged('post_install', '-at_install', 'pdf_rendering')
...
@harpiya.tests.tagged('post_install', '-at_install', '-standard', 'pdf_rendering')
...
class TestAggregatePdfReports(harpiya.tests.HttpCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
