...
from harpiya.http import _request_stack
from harpiya.tests import Form, TransactionCase, new_test_user, tagged, HttpCase, users, warmup
...
class TestUsers(UsersCommonCase):
    ...
    @mute_logger('harpiya.sql_db', 'harpiya.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('harpiya.addons.base.models.res_users.request', request)
