...
from harpiya.tests.common import standalone
from harpiya.tests.test_module_operations import install
from harpiya.tools import mute_logger
from harpiya.tools.convert import ParseError
...
def test_isolated_install(env):
    ...
    try:
        with mute_logger('harpiya.modules.registry'):
