...
import harpiya
import harpiya.modules.module  # get_manifest, don't from-import it
from harpiya import api, fields, models, tools
from harpiya.tools import misc
from harpiya.tools.constants import ASSET_EXTENSIONS, EXTERNAL_ASSET
...
class IrAsset(models.Model):
    ...
    def _fill_asset_paths(self, bundle, asset_paths, seen, addons, installed, **assets_params):
        ...
        for addon in addons:
            for command in harpiya.modules.module._get_manifest_cached(addon)['assets'].get(bundle, ()):
    ...
    def _topological_sort(self, addons_tuple):
        ...
        def mapper(addon):
            manif = harpiya.modules.module._get_manifest_cached(addon)
    ...
    def _get_paths(self, path_def, installed):
        ...
        Ex: ('/base/static/file.js', '/home/user/source/harpiya/harpiya/addons/base/static/file.js', 643636800)
        ...
        addon = path_parts[0]
        addon_manifest = harpiya.modules.module._get_manifest_cached(addon)
