...
from harpiya.tools import OrderedSet
from harpiya.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an harpiya
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`harpiya.osv.orm.Model.write` expects.

        :param model: :class:`harpiya.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`harpiya.fields.Field`
