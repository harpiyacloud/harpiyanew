...
QWeb is the primary templating engine used by Harpiya. It is an XML templating
...
<https://www.harpiya.com/documentation/master/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed harpiya user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``has_group`` Harpiya method from ``res.users`` model.
...
from harpiya import api, models, tools
from harpiya.modules import get_module_path
from harpiya.modules.registry import _REGISTRY_CACHES
from harpiya.tools import config, safe_eval, pycompat
from harpiya.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from harpiya.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from harpiya.tools.json import scriptsafe
from harpiya.tools.lru import LRU
from harpiya.tools.misc import str2bool, file_open, file_path
from harpiya.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from harpiya.http import request
from harpiya.tools.profiler import QwebTracker
from harpiya.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from harpiya.addons.base.models.assetsbundle import AssetsBundle
from harpiya.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Harpiya 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__harpiyaAssetError=1"
