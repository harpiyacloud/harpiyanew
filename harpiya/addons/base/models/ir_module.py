...
from harpiya.exceptions import AccessDenied, UserError, ValidationError
from harpiya.osv import expression
from harpiya.tools.parse_version import parse_version
from harpiya.tools.misc import topological_sort, get_flag
from harpiya.tools.translate import TranslationImporter, get_po_paths, get_datafile_translation_path
...
class IrModuleModule(models.Model):
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Harpiya is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(harpiya.tools.config['server_wide_modules']) & set(self.mapped('name'))
