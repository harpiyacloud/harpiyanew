...
from harpiya.tools import _, frozendict
from harpiya.tools.float_utils import float_compare
from harpiya.tools.misc import unquote
from harpiya.tools.safe_eval import safe_eval, test_python_expr
...
class IrActionsServer(models.Model):
    ...
    Since Harpiya 8.0 a button 'Create Menu Action' button is available on the
