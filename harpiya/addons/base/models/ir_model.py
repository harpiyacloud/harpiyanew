...
from harpiya import api, fields, models, tools, Command
from harpiya.exceptions import AccessError, UserError, ValidationError
from harpiya.osv import expression
from harpiya.tools import lazy_property, split_every, sql, unique, OrderedSet, SQL
from harpiya.tools.safe_eval import safe_eval, datetime, dateutil, time
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in harpiya.modules.loading.
...
class IrModelFields(models.Model):
    ...
    def _drop_column(self):
        from harpiya.orm.model_classes import pop_field
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement Harpiya many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by Harpiya
    ...
    def _module_data_uninstall(self, modules_to_remove):
        ...
        """
        from harpiya.orm.model_classes import add_field
