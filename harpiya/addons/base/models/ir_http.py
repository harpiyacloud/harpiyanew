...
import harpiya
from harpiya import api, http, models, tools
from harpiya.api import SUPERUSER_ID
from harpiya.exceptions import AccessDenied
from harpiya.http import request, Response, ROUTING_KEYS, SAFE_HTTP_METHODS
from harpiya.modules.registry import Registry
from harpiya.service import security
from harpiya.tools.json import json_default
from harpiya.tools.misc import get_lang, submap
from harpiya.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and harpiya.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (harpiya.exceptions.AccessError, harpiya.exceptions.MissingError) as e:
                ...
                if isinstance(e, harpiya.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(harpiya.tools.config['server_wide_modules'])
    ...
    def _gc_sessions(self):
        if os.getenv("HARPIYA_SKIP_GC_SESSIONS"):
            return
