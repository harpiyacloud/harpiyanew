...
from harpiya import api, fields, models, tools, _, modules
from harpiya.exceptions import UserError
from harpiya.tools import formataddr, email_normalize, encapsulate_email, email_domain_extract, email_domain_normalize, human_size
...
_test_logger = logging.getLogger('harpiya.tests')
...
class IrMail_Server(models.Model):
    ...
    from_filter = fields.Char(
        ...
        help='Comma-separated list of addresses or domains for which this server can be used.\n'
             'e.g.: "notification@harpiya.com" or "harpiya.com"')
    ...
    def connect(self, host=None, port=None, user=None, password=None, encryption=None,
        ...
        """Returns a new SMTP connection to the given SMTP server.
           ...
           :param ssl_certificate: filename of the SSL certificate used for authentication
               Used when no mail server is given and overwrite  the harpiya-bin argument "smtp_ssl_certificate"
           :param ssl_private_key: filename of the SSL private key used for authentication
               Used when no mail server is given and overwrite  the harpiya-bin argument "smtp_ssl_private_key"
        ...
        # Store the "from_filter" of the mail server / harpiya-bin argument to  know if we
    ...
    def _alter_message(self, message, smtp_from, smtp_to_list):
        ...
        del message['Bcc']                   # see harpiya/harpiya@2445f9e3c22db810d61996afde883e4ca608f15b
    ...
    def _find_mail_server(self, email_from, mail_servers=None):
        ...
        - Mail server to use to send the email (None if we use the harpiya-bin arguments)
        ...
        # Skip if passed email_from is False (example Harpiyabot has no email address)
        ...
        # 5: SMTP config in harpiya-bin arguments
        from_filter = self.env['ir.mail_server']._get_default_from_filter()
