...
from harpiya.exceptions import AccessError, MissingError, UserError
from harpiya.http import Stream, request
from harpiya.tools import file_open, replace_exceptions
from harpiya.tools.image import image_process, image_guess_size_from_field_name
from harpiya.tools.mimetypes import guess_mimetype, get_extension
from harpiya.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:harpiya.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~harpiya.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`harpiya.tools.image.image_process`.
