...
class TestError(common.HttpCase):
    ...
    def test_01_private(self):
        with self.assertRaisesRegex(Exception, r"Private method"), mute_logger('harpiya.http'):
    ...
    def test_01_create(self):
        ...
        with self.assertRaises(Fault) as ctx, mute_logger("harpiya.sql_db", "harpiya.http"):
    ...
    def test_03_sql_constraint(self):
        with mute_logger("harpiya.sql_db"), self.assertLogs("harpiya.http", level="WARNING") as capture:
