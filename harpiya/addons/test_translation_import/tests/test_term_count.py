...
from harpiya.tools.misc import file_open, mute_logger, file_path
from harpiya.tools.translate import TranslationModuleReader, TranslationRecordReader, code_translations, CodeTranslations, PYTHON_TRANSLATION_COMMENT, JAVASCRIPT_TRANSLATION_COMMENT, translation_file_reader
from harpiya import Command
from harpiya.addons.base.models.ir_fields import BOOLEAN_TRANSLATIONS
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_spreadsheet_new_dataset(self):
        ...
        self.assertEqual(set(terms), {
            ...
            'Scorecard title',
            'Opportunities',
            'Harpiya Chart horizontal axis title',
            'Harpiya Chart vertical axis title'
        })
