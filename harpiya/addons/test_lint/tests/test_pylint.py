...
from harpiya.modules import get_modules, get_module_path
...
class TestPyLint(TransactionCase):
    ...
    def test_pylint(self):
        ...
        options = [
            ...
            '--load-plugins=pylint.extensions.bad_builtin,_harpiya_checker_sql_injection,_harpiya_checker_gettext,_harpiya_checker_unlink_override',
