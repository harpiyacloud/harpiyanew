...
from harpiya.addons.test_lint.tests.lint_case import LintCase
from harpiya.modules import get_module_path, get_modules
    ...
    def test_check_tests(self):
        ...
        for modroot in map(get_module_path, get_modules()):
            ...
            for f in p.rglob('test_*.py'):
                ...
                if f.match("harpiya/addons/base/tests/test_uninstall.py"):
                    continue
