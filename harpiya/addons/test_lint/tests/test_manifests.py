...
from harpiya.modules import get_modules
from harpiya.modules.module import _DEFAULT_MANIFEST, module_manifest, get_module_path
...
class ManifestLinter(BaseCase):
    ...
    def _load_manifest(self, module):
        """Do not rely on harpiya/modules/module -> load_manifest
