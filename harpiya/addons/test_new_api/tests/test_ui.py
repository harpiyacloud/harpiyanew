...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/harpiya/action-test_new_api.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@harpiya.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(harpiya.tests.HttpCase):

    @mute_logger('harpiya.sql_db', 'harpiya.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/harpiya/action-test_new_api.action_categories",
