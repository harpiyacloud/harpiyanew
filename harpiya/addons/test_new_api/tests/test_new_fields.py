...
from harpiya import models, fields, Command
from harpiya.addons.base.tests.common import TransactionCaseWithUserDemo
from harpiya.addons.base.tests.test_expression import TransactionExpressionCase
from harpiya.exceptions import AccessError, MissingError, UserError, ValidationError
from harpiya.fields import Domain
from harpiya.tests import TransactionCase, tagged, Form, users
from harpiya.tools import mute_logger, float_repr
from harpiya.tools.date_utils import add, subtract, start_of, end_of
from harpiya.tools.image import image_data_uri
...
%endif"""
    ...
    @mute_logger('harpiya.addons.base.models.ir_model')
    ...
    def test_85_binary_guess_zip(self):
        from harpiya.addons.base.tests.test_mimetypes import ZIP
    ...
    def test_86_text_base64_guess_svg(self):
        from harpiya.addons.base.tests.test_mimetypes import SVG
...
class TestX2many(TransactionExpressionCase):
    ...
    def test_10_ondelete_many2many(self):
        ...
        with self.assertRaises(psycopg2.IntegrityError):
            with mute_logger('harpiya.sql_db'):
                record_a.unlink()
...
%endif"""
    ...
    @patch('harpiya.orm.fields_textual.html_sanitize', return_value='<p>comment</p>')
...
class TestSelectionOndeleteAdvanced(TransactionCase):
    ...
    def test_ondelete_unexisting_policy(self):
        from harpiya.orm.model_classes import add_to_registry
...
class TestFieldParametersValidation(TransactionCase):
    def test_invalid_parameter(self):
        ...
        with self.assertLogs('harpiya.fields', level='WARNING') as cm:
            self.registry._setup_models__(self.env.cr)

        self.assertTrue(cm.output[0].startswith(
            "WARNING:harpiya.fields:Field test_new_api.field_parameter_validation.name: "
