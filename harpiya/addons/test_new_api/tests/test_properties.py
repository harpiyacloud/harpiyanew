...
from harpiya.fields import Command, Domain
from harpiya.exceptions import AccessError, UserError, ValidationError
from harpiya.tests import Form, TransactionCase, users
from harpiya.tools import mute_logger, get_lang
...
class PropertiesCase(TestPropertiesMixin):
    ...
    @mute_logger('harpiya.models.unlink', 'harpiya.fields')
    ...
    @users('test')
    @mute_logger('harpiya.addons.base.models.ir_rule', 'harpiya.fields')
    ...
    def test_properties_field_security(self):
        ...
        self.env.invalidate_all()
        with patch('harpiya.addons.test_new_api.models.test_new_api.Test_New_ApiMultiTag.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        ...
        self.env.invalidate_all()
        with patch('harpiya.addons.test_new_api.models.test_new_api.Test_New_ApiDiscussion.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        self.assertEqual(values['value'], (tag.id, 'Test Tag'))
...
class PropertiesGroupByCase(TestPropertiesMixin):
    ...
    @mute_logger('harpiya.fields', 'harpiya.models.unlink')
