...
from harpiya.modules.module import load_script
from harpiya.orm.registry import Registry
...
VERSION_RE = re.compile(
    r"""^
        # Optional prefix with Harpiya version
        ((
            6\.1|
        ...
        # After Harpiya version we allow precisely 2 or 3 parts
...
class MigrationManager:
    ...
    def _get_files(self) -> None:
        def _get_upgrade_path(pkg: str) -> Iterator[str]:
            for path in harpiya.upgrade.__path__:
    ...
    def migrate_module(self, pkg: module_graph.ModuleNode, stage: typing.Literal['pre', 'post', 'end']) -> None:
        ...
        def compare(version: str) -> bool:
            ...
            if majorless_version:
                # We should not re-execute major-less scripts when upgrading to new Harpiya version
