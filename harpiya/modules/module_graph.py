...
from harpiya.tools import lazy_property, OrderedSet
from harpiya.tools.sql import column_exists
...
class ModuleNode:
    """
    Loading and upgrade info for an Harpiya module
    """
...
class ModuleGraph:
    """
    Sorted Harpiya modules ordered by (module.phase, module.depth, module.name)
    """
