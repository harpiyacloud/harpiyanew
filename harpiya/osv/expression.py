...
Harpiya will use the SQL function 'unaccent' when available for the
...
import harpiya.orm.domains as orm_domains
import harpiya.modules
from harpiya.tools import Query, SQL
...
def get_unaccent_wrapper(cr):
    ...
    return harpiya.modules.registry.Registry(cr.dbname).unaccent
