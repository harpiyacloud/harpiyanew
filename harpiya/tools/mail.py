...
class _Cleaner(clean.Cleaner):
    ...
    def kill_conditional_comments(self, doc):
        ...
        https://github.com/harpiya/harpiya/pull/119325/files#r1301064789
...
def tag_quote(el):
    ...
    # harpiya, gmail and outlook automatic signature wrapper
    is_signature_wrapper = 'harpiya_signature_wrapper' in el_class or 'gmail_signature' in el_class or el_id == "Signature"
...
def plaintext2html(text, container_tag=None):
    ...
    html entities, using :func:`~harpiya.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    within harpiya, this assumption is certain to fall short for international
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within harpiya, this assumption is certain to fall
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@harpiya.com
    * Output: "Admin" <notifications@harpiya.com>
    """
