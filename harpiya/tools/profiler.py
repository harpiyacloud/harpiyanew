...
class SyncCollector(Collector):
    ...
    Note that --limit-memory-hard may need to be increased when launching Harpiya.
    """
    name = 'traces_sync'
    ...
    def end(self):
        ...
        try:
            ...
            if self.db:
                ...
                from harpiya.sql_db import db_connect  # only import from harpiya if/when needed.
