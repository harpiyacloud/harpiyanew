...
from harpiya.tools import SQL, OrderedSet, is_list_of
from harpiya.tools.misc import has_list_types
...
if typing.TYPE_CHECKING:
    from harpiya.tools import Query
...
class Properties(Field):
    ...
    like Harpiya fields but without being independently stored in database.
    ...
    current record. The container must have a :class:`~harpiya.fields.PropertiesDefinition`
...
class PropertiesDefinition(Field):
    """ Field used to define the properties definition (see :class:`~harpiya.fields.Properties`
