...
from harpiya.exceptions import CacheMiss, UserError
from harpiya.tools import SQL, human_size, image_process, lazy_property
...
class Image(Binary):
    ...
    :param bool verify_resolution: whether the image resolution should be verified
        ...
        See :class:`harpiya.tools.image.ImageProcess` for maximum image resolution (default: ``50e6``).
