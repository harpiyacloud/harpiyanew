...
from harpiya.exceptions import AccessError, MissingError
from harpiya.tools import Query, SQL, lazy_property, sql
from harpiya.tools.constants import PREFETCH_MAX
from harpiya.tools.misc import SENTINEL, OrderedSet, Sentinel
...
_logger = logging.getLogger('harpiya.fields')
...
class Field(typing.Generic[T]):
    ...
    def _get_attrs(self, model_class: type[BaseModel], name: str) -> dict[str, typing.Any]:
        ...
        if 'group_operator' in attrs:
            warnings.warn("Since Harpiya 18, 'group_operator' is deprecated, use 'aggregator' instead", DeprecationWarning, stacklevel=2)
