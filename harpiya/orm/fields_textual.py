...
from harpiya.netsvc import COLOR_PATTERN, DEFAULT, GREEN, RED, ColoredFormatter
from harpiya.tools import SQL, html_normalize, html_sanitize, sql
from harpiya.tools.misc import SENTINEL, Sentinel
from harpiya.tools.sql import pattern_to_translated_trigram_pattern, pg_varchar, value_to_translated_trigram_pattern
...
class Html(BaseString):
    ...
    def _get_attrs(self, model_class, name):
        ...
        # we do not need this Microsoft Outlook client feature for emails displayed Harpiya's web client.
