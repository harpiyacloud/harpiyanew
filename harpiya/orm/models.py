...
from harpiya.exceptions import AccessError, LockError, MissingError, ValidationError, UserError
from harpiya.tools import (
...
from harpiya.tools.constants import GC_UNLINK_LIMIT, PREFETCH_MAX
from harpiya.tools.lru import LRU
from harpiya.tools.misc import ReversedIterable, exception_to_unicode, unquote
from harpiya.tools.translate import _, LazyTranslate
...
_logger = logging.getLogger('harpiya.models')
_unlink = logging.getLogger('harpiya.models.unlink')
    ...
    def __new__(meta, name, bases, attrs):
        ...
        if attrs.get('_register', True):
            ...
            if '_module' not in attrs:
                ...
                assert module.startswith('harpiya.addons.'), \
                    f"Invalid import of {module}.{name}, it should start with 'harpiya.addons'."
...
class BaseModel(metaclass=MetaModel):
    """Base class for Harpiya models.

    Harpiya models are created by inheriting one of the following:
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    the :attr:`~harpiya.models.BaseModel._register` attribute may be set to False.
    """
    ...
    If set to ``False``, override :meth:`~harpiya.models.BaseModel.init`
    ...
    .. tip:: To create a model without any table, inherit
            from :class:`~harpiya.models.AbstractModel`.
    """
    ...
    _module: str | None = None          #: the model's module (in the Harpiya sense)
    ...
    .. warning::
      ...
      :attr:`~harpiya.models.Model._inherits`-ed models, the inherited field will
    ...
    def _compute_display_name(self):
        ...
        it can be made field-dependent using :attr:`~harpiya.api.depends` and
        context-dependent using :attr:`~harpiya.api.depends_context`.
        """
        if self._rec_name:
        ...
        for order_part in order.split(','):
            ...
            if (
                ...
                formula: ((7 - first_week_day) + day_in_SQL) % 7
                               ...
                               | week starts on
                           SQL | mon   sun   sat
                               |  1  |  7  |  6   <-- first_week_day (in harpiya)
                          -----|-----------------
                    mon     1  |  0  |  1  |  2
                    tue     2  |  1  |  2  |  3
                    wed     3  |  2  |  3  |  4
    ...
    def _field_to_sql(self, alias: str, field_expr: str, query: (Query | None) = None, flush: bool = True) -> SQL:
        ...
        result to make method :meth:`~harpiya.api.Environment.execute_query` flush
    ...
    def _check_company(self, fnames=None):
        ...
        :raises UserError: if the `company_id` of the value of any field is not
            ...
            :class:`~harpiya.addons.base.models.res_company`).

        For :class:`~harpiya.addons.base.models.res_users` relational fields,
    ...
    def unlink(self) -> typing.Literal[True]:
        ...
        from harpiya.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
    ...
    def write(self, vals: ValuesType) -> typing.Literal[True]:
        ...
        * For numeric fields (:class:`~harpiya.fields.Integer`,
          :class:`~harpiya.fields.Float`) the value should be of the
          corresponding type
        * For :class:`~harpiya.fields.Boolean`, the value should be a
          :class:`python:bool`
        * For :class:`~harpiya.fields.Selection`, the value should match the
          selection values (generally :class:`python:str`, sometimes
          :class:`python:int`)
        * For :class:`~harpiya.fields.Many2one`, the value should be the
          database identifier of the record to set
        * The expected value of a :class:`~harpiya.fields.One2many` or
          :class:`~harpiya.fields.Many2many` relational field is a list of
          :class:`~harpiya.fields.Command` that manipulate the relation the
          implement. There are a total of 7 commands:
          :meth:`~harpiya.fields.Command.create`,
          :meth:`~harpiya.fields.Command.update`,
          :meth:`~harpiya.fields.Command.delete`,
          :meth:`~harpiya.fields.Command.unlink`,
          :meth:`~harpiya.fields.Command.link`,
          :meth:`~harpiya.fields.Command.clear`, and
          :meth:`~harpiya.fields.Command.set`.
        * For :class:`~harpiya.fields.Date` and `~harpiya.fields.Datetime`,
          ...
          .. warning::
            ...
            :const:`harpiya.tools.misc.DEFAULT_SERVER_DATE_FORMAT` and
            :const:`harpiya.tools.misc.DEFAULT_SERVER_DATETIME_FORMAT`
    ...
    def ensure_one(self) -> Self:
        ...
        :raise harpiya.exceptions.ValueError: ``len(self) != 1``
        """
        try:
...
class Model(AbstractModel):
    """ Main super-class for regular database-persisted Harpiya models.

    Harpiya models are created by inheriting from this class::
