...
from harpiya.exceptions import MissingError, UserError
from harpiya.tools import SQL, OrderedSet, Query, sql, unique
from harpiya.tools.constants import PREFETCH_MAX
from harpiya.tools.misc import SENTINEL, Sentinel, unquote
...
class Many2one(_Relational[M]):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~harpiya.models.Model._check_company`. Has a different behaviour
...
class Many2many(_RelationalMulti[M]):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~harpiya.models.Model._check_company`. Add a default company
