...
"""The Harpiya API module defines method decorators.
"""
...
def constrains(*args) -> Decorator:
    ...
    Should raise :exc:`~harpiya.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall: bool) -> Decorator:
    """
    Mark a method to be executed during :meth:`~harpiya.models.BaseModel.unlink`.
...
def onchange(*args: str) -> Decorator:
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/harpiya/harpiya/issues/2693>`_.
...
def autovacuum(method: C) -> C:
    ...
    as in :meth:`~harpiya.addons.base.models.ir_cron.IrCron._commit_progress`.
    """
