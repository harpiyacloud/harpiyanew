...
from harpiya.tools.func import locked
from harpiya.tools.lru import LRU
from harpiya.tools.misc import Collector, format_frame
...
if typing.TYPE_CHECKING:
    ...
    from harpiya.fields import Field
    from harpiya.models import BaseModel
    from harpiya.sql_db import BaseCursor, Connection, Cursor
    from harpiya.modules import module_graph


_logger = logging.getLogger('harpiya.registry')
_schema = logging.getLogger('harpiya.schema')
...
class Registry(Mapping[str, type["BaseModel"]]):
    ...
    def new(
        ...
        *,
        ...
        try:
            ...
            from harpiya.modules.loading import load_modules, reset_modules_state  # noqa: PLC0415
            try:
    ...
    def init(self, db_name: str) -> None:
        ...
        if config['test_enable']:
            from harpiya.tests.result import HarpiyaTestResult  # noqa: PLC0415
            self._assertion_report: HarpiyaTestResult | None = HarpiyaTestResult()
        else:
        ...
        from harpiya.modules import db  # noqa: PLC0415
        ...
        for indexname, tablename, field in expected:
            ...
            if index and indexname not in existing and \
                ...
                if index == 'trigram':
                    ...
                    from harpiya.modules.db import FunctionStatus  # noqa: PLC0415
