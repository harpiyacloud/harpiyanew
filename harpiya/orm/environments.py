...
"""The Harpiya API module defines Harpiya Environments.
"""
...
from harpiya.exceptions import AccessError, UserError, CacheMiss
from harpiya.sql_db import BaseCursor
from harpiya.tools import clean_context, frozendict, lazy_property, OrderedSet, Query, SQL
from harpiya.tools.translate import get_translation, get_translated_module, LazyGettext
from harpiya.tools.misc import StackMap, SENTINEL
...
_logger = logging.getLogger('harpiya.api')
...
class Environment(Mapping[str, "BaseModel"]):
    ...
    def __call__(
        ...
        :type cursor: :class:`~harpiya.sql_db.Cursor`
    ...
    def user(self) -> BaseModel:
        ...
        :rtype: :class:`res.users record<~harpiya.addons.base.models.res_users.ResUsers>`"""
    ...
    def company(self) -> BaseModel:
        ...
        :rtype: :class:`res.company record<~harpiya.addons.base.models.res_company.Company>`
    ...
    def companies(self) -> BaseModel:
        ...
        :rtype: :class:`res.company recordset<~harpiya.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry: Registry):
        ...
        # temporary directories (managed in harpiya.tools.file_open_temporary_directory)
