...
from harpiya.modules.module import get_module_root, MANIFEST_NAMES
from harpiya.service.db import _create_empty_database, DatabaseExists
from harpiya.tools import config


class Start(Command):
    """ Quickly start the harpiya server with default options """
