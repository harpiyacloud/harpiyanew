...
Harpiya tests customisation combined with the need of a cross version compatibility
started to make TestSuite and other unitest object more complicated than vendoring
the part we need for Harpiya. This versions is simplified in order
...
class TestSuite(BaseTestSuite):
    ...
    def run(self, result, debug=False):
        for test in self:
            ...
            harpiya.modules.module.current_test = test
