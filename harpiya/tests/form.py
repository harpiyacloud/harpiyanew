# -*- coding: utf-8 -*-
"""
The module :mod:`harpiya.tests.form` provides an implementation of a client form
...
class Form:
    ...
    * properly handle defaults & onchanges around x2many fields.
    ...
    of :class:`~harpiya.fields.Many2one` fields, one can assign a recordset::
    ...
    For :class:`~harpiya.fields.Many2many` fields, the field itself is a
    :class:`~harpiya.tests.common.M2MProxy` and can be altered by adding or
    removing records::
    ...
    Finally :class:`~harpiya.fields.One2many` are reified as :class:`~O2MProxy`.

    Because the :class:`~harpiya.fields.One2many` only exists through its parent,
...
class O2MProxy(X2MProxy):
    ...
    def new(self):
        ...
        :class:`~harpiya.fields.One2many` record, properly initialised.
    ...
    def edit(self, index):
        ...
        :class:`~harpiya.fields.One2many` record.
